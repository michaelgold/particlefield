    ...
    <group ref={groupRef} position={[0, 0, 0]}>
      <Html
        ...
        style={{
          width: '400px',
          padding: '30px',
          background: 'linear-gradient(135deg, rgba(79, 209, 255, 0.95), rgba(255, 0, 110, 0.95))',
          borderRadius: '20px',
          color: 'white',
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <p style={{ margin: 0, fontSize: '14px', lineHeight: '1.6', opacity: 0.9 }}>
            This HTML content is rendered in 3D space using @react-three/drei.
            It's fully interactive and works perfectly!
          </p>
          ...
          <div style={{
            ...
            Using @react-three/drei Html component
          </div>
        </div>
      </Html>
    </group>
...
export default function ParticleFieldDrei() {
  return (
