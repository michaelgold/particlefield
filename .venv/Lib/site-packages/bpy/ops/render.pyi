...
:func:`cycles_performance_preset_add`
...
def cycles_integrator_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False) -> None:
...
def cycles_performance_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False) -> None:
...
def cycles_sampling_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False) -> None:
...
def cycles_viewport_sampling_preset_add(*args, name: str = '', remove_name: bool = False, remove_active: bool = False) -> None:
