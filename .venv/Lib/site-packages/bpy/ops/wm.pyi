...
def xr_navigation_teleport(*args, teleport_axes: typing.Tuple[bool, bool, bool] = (True, True, True), interpolation: float = 1.0, offset: float = 0.25, selectable_only: bool = True, distance: float = 80.0, gravity: float = 0.1, raycast_scale: float = 0.02, destination_scale: float = 0.05, sample_count: int = 48, from_viewer: bool = False, axis: mathutils.Vector = (0.0, 0.0, -1.0), hit_color: typing.Tuple[float, float, float, float] = (0.35, 0.35, 1.0, 1.0), miss_color: typing.Tuple[float, float, float, float] = (1.0, 0.35, 0.35, 1.0), fallback_color: typing.Tuple[float, float, float, float] = (0.35, 0.35, 1.0, 1.0)) -> None:
