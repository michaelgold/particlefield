...
def denoise_animation(*args, input_filepath: str = '', output_filepath: str = '') -> None:
...
def merge_images(*args, input_filepath1: str = '', input_filepath2: str = '', output_filepath: str = '') -> None:
