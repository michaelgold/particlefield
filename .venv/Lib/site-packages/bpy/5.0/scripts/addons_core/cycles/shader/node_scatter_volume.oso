...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_scatter_volume.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_scatter_volume.osl:17
#   closure color scatter_closure = scatter(phase, Anisotropy, IOR, Backscatter, Alpha, Diameter);
	functioncall	$const1 103 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_scatter_volume.osl"} %line{17} %argrw{"r"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_scatter_volume.osl:19
#   Volume = (Color * max(Density, 0.0)) * scatter_closure;
	max		$tmp61 Density $const11 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_scatter_volume.osl"} %line{19} %argrw{"wrr"}
