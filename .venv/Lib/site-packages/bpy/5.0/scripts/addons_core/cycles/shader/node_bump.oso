...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_bump.oso
surface node_bump
...
code NormalIn
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:12
#                   normal NormalIn = N,
	assign		NormalIn N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{12} %argrw{"wr"}
code NormalOut
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:19
#                   output normal NormalOut = N)
	assign		NormalOut N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{19} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:21
#   point Ptmp = P;
	assign		Ptmp P 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{21} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:22
#   normal Normal = NormalIn;
	assign		Normal NormalIn 	%line{22} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:24
#   if (use_object_space) {
	if		use_object_space 10 10 	%line{24} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:25
...
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Ptmp $const3 $const1 Ptmp 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:26
#     Normal = normalize(transform("object", Normal));
	functioncall	$const2 9 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{26} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:261
# normal transform (string to, normal p) { return transform("common",to,p); }
	transformn	$tmp1 $const3 $const1 Normal 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{261} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:26
#     Normal = normalize(transform("object", Normal));
	normalize	Normal $tmp1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{26} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:30
#   vector dPdx = Dx(Ptmp);
	Dx		dPdx Ptmp 	%line{30} %argrw{"wr"} %argderivs{1}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:31
#   vector dPdy = Dy(Ptmp);
	Dy		dPdy Ptmp 	%line{31} %argrw{"wr"} %argderivs{1}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:33
#   vector Rx = cross(dPdy, Normal);
	cross		Rx dPdy Normal 	%line{33} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:34
#   vector Ry = cross(Normal, dPdx);
	cross		Ry Normal dPdx 	%line{34} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:37
#   float det = dot(dPdx, Rx);
	dot		det dPdx Rx 	%line{37} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:38
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:40
#   float absdet = fabs(det);
	fabs		absdet det 	%line{40} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:42
#   float strength = max(Strength, 0.0);
	max		strength Strength $const4 	%line{42} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:43
#   float dist = Distance;
	assign		dist Distance 	%line{43} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:45
#   if (invert)
	if		invert 25 25 	%line{45} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:46
#     dist *= -1.0;
	mul		dist dist $const5 	%line{46} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:49
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:50
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:52
#   if (use_object_space) {
	if		use_object_space 40 40 	%line{52} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_bump.osl:53
