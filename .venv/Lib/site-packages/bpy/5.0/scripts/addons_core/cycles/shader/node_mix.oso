...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_mix.oso
shader node_mix
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:282
#   float t = clamp(Fac, 0.0, 1.0);
	functioncall	$const3 3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{282} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1 Fac $const2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		t $tmp1 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:284
#   if (mix_type == "mix")
	eq		$tmp2 mix_type $const4 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{284} %argrw{"wrr"}
	if		$tmp2 7 7 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:285
#     Color = node_mix_blend(t, Color1, Color2);
	functioncall	$const5 7 	%line{285} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:10
#   return mix(col1, col2, t);
	mix		Color Color1 Color2 t 	%line{10} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:286
#   if (mix_type == "add")
	eq		$tmp3 mix_type $const6 	%line{286} %argrw{"wrr"}
	if		$tmp3 12 12 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:287
#     Color = node_mix_add(t, Color1, Color2);
	functioncall	$const7 12 	%line{287} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:15
#   return mix(col1, col1 + col2, t);
	add		$tmp4 Color1 Color2 	%line{15} %argrw{"wrr"}
	mix		Color Color1 $tmp4 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:288
#   if (mix_type == "multiply")
	eq		$tmp5 mix_type $const8 	%line{288} %argrw{"wrr"}
	if		$tmp5 17 17 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:289
#     Color = node_mix_mul(t, Color1, Color2);
	functioncall	$const9 17 	%line{289} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:20
#   return mix(col1, col1 * col2, t);
	mul		$tmp6 Color1 Color2 	%line{20} %argrw{"wrr"}
	mix		Color Color1 $tmp6 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:290
#   if (mix_type == "screen")
	eq		$tmp7 mix_type $const10 	%line{290} %argrw{"wrr"}
	if		$tmp7 28 28 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:291
#     Color = node_mix_screen(t, Color1, Color2);
	functioncall	$const11 28 	%line{291} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:25
#   float tm = 1.0 - t;
	sub		___413_tm $const2 t 	%line{25} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:27
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:292
#   if (mix_type == "overlay")
	eq		$tmp17 mix_type $const13 	%line{292} %argrw{"wrr"}
	if		$tmp17 94 94 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:293
#     Color = node_mix_overlay(t, Color1, Color2);
	functioncall	$const14 94 	%line{293} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:32
#   float tm = 1.0 - t;
	sub		___414_tm $const2 t 	%line{32} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:34
#   color outcol = col1;
	assign		___414_outcol Color1 	%line{34} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:36
#   if (outcol[0] < 0.5)
	compref		$tmp18 ___414_outcol $const15 	%line{36} %argrw{"wrr"}
	lt		$tmp19 $tmp18 $const16 	%argrw{"wrr"}
	if		$tmp19 43 53 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:37
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:39
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:41
#   if (outcol[1] < 0.5)
	compref		$tmp35 ___414_outcol $const18 	%line{41} %argrw{"wrr"}
	lt		$tmp36 $tmp35 $const16 	%argrw{"wrr"}
	if		$tmp36 63 73 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:42
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:44
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:46
#   if (outcol[2] < 0.5)
	compref		$tmp52 ___414_outcol $const19 	%line{46} %argrw{"wrr"}
	lt		$tmp53 $tmp52 $const16 	%argrw{"wrr"}
	if		$tmp53 83 93 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:47
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:49
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:51
#   return outcol;
	assign		Color ___414_outcol 	%line{51} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:294
#   if (mix_type == "subtract")
	eq		$tmp69 mix_type $const20 	%line{294} %argrw{"wrr"}
	if		$tmp69 99 99 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:295
#     Color = node_mix_sub(t, Color1, Color2);
	functioncall	$const21 99 	%line{295} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:56
#   return mix(col1, col1 - col2, t);
	sub		$tmp70 Color1 Color2 	%line{56} %argrw{"wrr"}
	mix		Color Color1 $tmp70 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:296
#   if (mix_type == "divide")
	eq		$tmp71 mix_type $const22 	%line{296} %argrw{"wrr"}
	if		$tmp71 138 138 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:297
#     Color = node_mix_div(t, Color1, Color2);
	functioncall	$const23 138 	%line{297} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:61
#   float tm = 1.0 - t;
	sub		___416_tm $const2 t 	%line{61} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:63
#   color outcol = col1;
	assign		___416_outcol Color1 	%line{63} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:65
#   if (col2[0] != 0.0)
	compref		$tmp72 Color2 $const15 	%line{65} %argrw{"wrr"}
	neq		$tmp73 $tmp72 $const1 	%argrw{"wrr"}
	if		$tmp73 115 115 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:66
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:67
#   if (col2[1] != 0.0)
	compref		$tmp81 Color2 $const18 	%line{67} %argrw{"wrr"}
	neq		$tmp82 $tmp81 $const1 	%argrw{"wrr"}
	if		$tmp82 126 126 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:68
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:69
#   if (col2[2] != 0.0)
	compref		$tmp90 Color2 $const19 	%line{69} %argrw{"wrr"}
	neq		$tmp91 $tmp90 $const1 	%argrw{"wrr"}
	if		$tmp91 137 137 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:70
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:122
#       outcol[2] = 1.0;
	compassign	___421_outcol $const19 $const2 	%line{122} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:124
#       outcol[2] = tmp;
	compassign	___421_outcol $const19 ___424_tmp 	%line{124} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:127
#   return outcol;
	assign		Color ___421_outcol 	%line{127} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:308
#   if (mix_type == "burn")
	eq		$tmp135 mix_type $const34 	%line{308} %argrw{"wrr"}
	if		$tmp135 271 271 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:309
#     Color = node_mix_burn(t, Color1, Color2);
	functioncall	$const35 271 	%line{309} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:132
#   float tmp, tm = 1.0 - t;
	sub		___425_tm $const2 t 	%line{132} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:134
#   color outcol = col1;
	assign		___425_outcol Color1 	%line{134} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:136
#   tmp = tm + t * col2[0];
	compref		$tmp136 Color2 $const15 	%line{136} %argrw{"wrr"}
	mul		$tmp137 t $tmp136 	%argrw{"wrr"}
	add		___425_tmp ___425_tm $tmp137 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:137
#   if (tmp <= 0.0)
	le		$tmp138 ___425_tmp $const1 	%line{137} %argrw{"wrr"}
	if		$tmp138 225 236 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:138
#     outcol[0] = 0.0;
	compassign	___425_outcol $const15 $const1 	%line{138} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:139
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:140
#     outcol[0] = 0.0;
	compassign	___425_outcol $const15 $const1 	%line{140} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:141
#   else if (tmp > 1.0)
	gt		$tmp143 ___425_tmp $const2 	%line{141} %argrw{"wrr"}
	if		$tmp143 235 236 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:142
#     outcol[0] = 1.0;
	compassign	___425_outcol $const15 $const2 	%line{142} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:144
#     outcol[0] = tmp;
	compassign	___425_outcol $const15 ___425_tmp 	%line{144} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:146
#   tmp = tm + t * col2[1];
	compref		$tmp144 Color2 $const18 	%line{146} %argrw{"wrr"}
	mul		$tmp145 t $tmp144 	%argrw{"wrr"}
	add		___425_tmp ___425_tm $tmp145 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:147
#   if (tmp <= 0.0)
	le		$tmp146 ___425_tmp $const1 	%line{147} %argrw{"wrr"}
	if		$tmp146 242 253 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:148
#     outcol[1] = 0.0;
	compassign	___425_outcol $const18 $const1 	%line{148} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:149
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:150
#     outcol[1] = 0.0;
	compassign	___425_outcol $const18 $const1 	%line{150} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:151
#   else if (tmp > 1.0)
	gt		$tmp151 ___425_tmp $const2 	%line{151} %argrw{"wrr"}
	if		$tmp151 252 253 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:152
#     outcol[1] = 1.0;
	compassign	___425_outcol $const18 $const2 	%line{152} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:154
#     outcol[1] = tmp;
	compassign	___425_outcol $const18 ___425_tmp 	%line{154} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:156
#   tmp = tm + t * col2[2];
	compref		$tmp152 Color2 $const19 	%line{156} %argrw{"wrr"}
	mul		$tmp153 t $tmp152 	%argrw{"wrr"}
	add		___425_tmp ___425_tm $tmp153 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:157
#   if (tmp <= 0.0)
	le		$tmp154 ___425_tmp $const1 	%line{157} %argrw{"wrr"}
	if		$tmp154 259 270 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:158
#     outcol[2] = 0.0;
	compassign	___425_outcol $const19 $const1 	%line{158} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:159
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:160
#     outcol[2] = 0.0;
	compassign	___425_outcol $const19 $const1 	%line{160} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:161
#   else if (tmp > 1.0)
	gt		$tmp159 ___425_tmp $const2 	%line{161} %argrw{"wrr"}
	if		$tmp159 269 270 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:162
#     outcol[2] = 1.0;
	compassign	___425_outcol $const19 $const2 	%line{162} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:164
#     outcol[2] = tmp;
	compassign	___425_outcol $const19 ___425_tmp 	%line{164} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:166
#   return outcol;
	assign		Color ___425_outcol 	%line{166} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:310
#   if (mix_type == "hue")
	eq		$tmp160 mix_type $const36 	%line{310} %argrw{"wrr"}
	if		$tmp160 414 414 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:311
#     Color = node_mix_hue(t, Color1, Color2);
	functioncall	$const37 414 	%line{311} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:171
#   color outcol = col1;
	assign		___426_outcol Color1 	%line{171} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:172
...
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp161 Color2 $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:174
#   if (hsv2[1] != 0.0) {
	compref		$tmp186 ___426_hsv2 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{174} %argrw{"wrr"}
	neq		$tmp187 $tmp186 $const1 	%argrw{"wrr"}
	if		$tmp187 413 413 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:175
#     color hsv = rgb_to_hsv(outcol);
	functioncall	$const38 370 	%line{175} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp188 ___426_outcol $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:176
#     hsv[0] = hsv2[0];
	compref		$tmp213 ___426_hsv2 $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{176} %argrw{"wrr"}
	compassign	___427_hsv $const15 $tmp213 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:177
#     color tmp = hsv_to_rgb(hsv);
	functioncall	$const41 412 	%line{177} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___427_hsv $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:179
#     outcol = mix(outcol, tmp, t);
	mix		___426_outcol ___426_outcol ___427_tmp t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{179} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:182
#   return outcol;
	assign		Color ___426_outcol 	%line{182} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:312
#   if (mix_type == "saturation")
	eq		$tmp227 mix_type $const43 	%line{312} %argrw{"wrr"}
	if		$tmp227 561 561 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:313
#     Color = node_mix_sat(t, Color1, Color2);
	functioncall	$const44 561 	%line{313} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:187
#   float tm = 1.0 - t;
	sub		___428_tm $const2 t 	%line{187} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:189
#   color outcol = col1;
	assign		___428_outcol Color1 	%line{189} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:191
#   color hsv = rgb_to_hsv(outcol);
	functioncall	$const38 465 	%line{191} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp228 ___428_outcol $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:193
#   if (hsv[1] != 0.0) {
	compref		$tmp253 ___428_hsv $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{193} %argrw{"wrr"}
	neq		$tmp254 $tmp253 $const1 	%argrw{"wrr"}
	if		$tmp254 560 560 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:194
#     color hsv2 = rgb_to_hsv(col2);
	functioncall	$const38 514 	%line{194} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp255 Color2 $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:196
#     hsv[1] = tm * hsv[1] + t * hsv2[1];
	compref		$tmp280 ___428_hsv $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{196} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:197
#     outcol = hsv_to_rgb(hsv);
	functioncall	$const41 560 	%line{197} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___428_hsv $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:200
#   return outcol;
	assign		Color ___428_outcol 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{200} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:314
#   if (mix_type == "value")
	eq		$tmp298 mix_type $const45 	%line{314} %argrw{"wrr"}
	if		$tmp298 703 703 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:315
#     Color = node_mix_val(t, Color1, Color2);
	functioncall	$const46 703 	%line{315} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:205
#   float tm = 1.0 - t;
	sub		___430_tm $const2 t 	%line{205} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:207
#   color hsv = rgb_to_hsv(col1);
	functioncall	$const38 611 	%line{207} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp299 Color1 $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:208
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const38 657 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{208} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp324 Color2 $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:210
#   hsv[2] = tm * hsv[2] + t * hsv2[2];
	compref		$tmp349 ___430_hsv $const19 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{210} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:212
#   return hsv_to_rgb(hsv);
	functioncall	$const41 703 	%line{212} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___430_hsv $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:316
#   if (mix_type == "color")
	eq		$tmp367 mix_type $const47 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{316} %argrw{"wrr"}
	if		$tmp367 848 848 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:317
#     Color = node_mix_color(t, Color1, Color2);
	functioncall	$const48 848 	%line{317} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:217
#   color outcol = col1;
	assign		___431_outcol Color1 	%line{217} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:218
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const38 753 	%line{218} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp368 Color2 $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:220
#   if (hsv2[1] != 0.0) {
	compref		$tmp393 ___431_hsv2 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{220} %argrw{"wrr"}
	neq		$tmp394 $tmp393 $const1 	%argrw{"wrr"}
	if		$tmp394 847 847 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:221
#     color hsv = rgb_to_hsv(outcol);
	functioncall	$const38 802 	%line{221} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp395 ___431_outcol $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:222
#     hsv[0] = hsv2[0];
	compref		$tmp420 ___431_hsv2 $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{222} %argrw{"wrr"}
	compassign	___432_hsv $const15 $tmp420 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:223
#     hsv[1] = hsv2[1];
	compref		$tmp421 ___431_hsv2 $const18 	%line{223} %argrw{"wrr"}
	compassign	___432_hsv $const18 $tmp421 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:224
#     color tmp = hsv_to_rgb(hsv);
	functioncall	$const41 846 	%line{224} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___432_hsv $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:226
#     outcol = mix(outcol, tmp, t);
	mix		___431_outcol ___431_outcol ___432_tmp t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{226} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:229
#   return outcol;
	assign		Color ___431_outcol 	%line{229} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:318
#   if (mix_type == "soft_light")
	eq		$tmp435 mix_type $const49 	%line{318} %argrw{"wrr"}
	if		$tmp435 865 865 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:319
#     Color = node_mix_soft(t, Color1, Color2);
	functioncall	$const50 865 	%line{319} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:234
#   float tm = 1.0 - t;
	sub		___433_tm $const2 t 	%line{234} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:236
#   color one = color(1.0);
	assign		___433_one $const12 	%line{236} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:237
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:239
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:320
#   if (mix_type == "linear_light")
	eq		$tmp446 mix_type $const51 	%line{320} %argrw{"wrr"}
	if		$tmp446 921 921 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:321
#     Color = node_mix_linear(t, Color1, Color2);
	functioncall	$const52 921 	%line{321} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:244
#   color outcol = col1;
	assign		___434_outcol Color1 	%line{244} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:246
#   if (col2[0] > 0.5)
	compref		$tmp447 Color2 $const15 	%line{246} %argrw{"wrr"}
	gt		$tmp448 $tmp447 $const16 	%argrw{"wrr"}
	if		$tmp448 879 886 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:247
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:249
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:251
#   if (col2[1] > 0.5)
	compref		$tmp461 Color2 $const18 	%line{251} %argrw{"wrr"}
	gt		$tmp462 $tmp461 $const16 	%argrw{"wrr"}
	if		$tmp462 896 903 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:252
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:254
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:256
#   if (col2[2] > 0.5)
	compref		$tmp475 Color2 $const19 	%line{256} %argrw{"wrr"}
	gt		$tmp476 $tmp475 $const16 	%argrw{"wrr"}
	if		$tmp476 913 920 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:257
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:259
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:261
#   return outcol;
	assign		Color ___434_outcol 	%line{261} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:323
#   if (use_clamp)
	if		use_clamp 940 940 	%line{323} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:324
#     Color = node_mix_clamp(Color);
	functioncall	$const53 940 	%line{324} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:266
#   color outcol = col;
	assign		___435_outcol Color 	%line{266} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:268
#   outcol[0] = clamp(col[0], 0.0, 1.0);
	compref		$tmp490 Color $const15 	%line{268} %argrw{"wrr"}
	functioncall	$const3 928 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp491 $tmp490 $const2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp489 $tmp491 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:268
#   outcol[0] = clamp(col[0], 0.0, 1.0);
	compassign	___435_outcol $const15 $tmp489 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{268} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:269
#   outcol[1] = clamp(col[1], 0.0, 1.0);
	compref		$tmp493 Color $const18 	%line{269} %argrw{"wrr"}
	functioncall	$const3 933 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp494 $tmp493 $const2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp492 $tmp494 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:269
#   outcol[1] = clamp(col[1], 0.0, 1.0);
	compassign	___435_outcol $const18 $tmp492 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{269} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:270
#   outcol[2] = clamp(col[2], 0.0, 1.0);
	compref		$tmp496 Color $const19 	%line{270} %argrw{"wrr"}
	functioncall	$const3 938 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp497 $tmp496 $const2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp495 $tmp497 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:270
#   outcol[2] = clamp(col[2], 0.0, 1.0);
	compassign	___435_outcol $const19 $tmp495 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl"} %line{270} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix.osl:272
#   return outcol;
