...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_point_info.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_point_info.osl:11
#   getattribute("geom:point_position", Position);
	getattribute	$tmp1 $const1 Position 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_point_info.osl"} %line{11} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_point_info.osl:12
#   getattribute("geom:point_radius", Radius);
	getattribute	$tmp2 $const2 Radius 	%line{12} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_point_info.osl:13
