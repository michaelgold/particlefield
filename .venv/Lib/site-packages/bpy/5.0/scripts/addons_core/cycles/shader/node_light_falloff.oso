...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_light_falloff.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:13
#   float ray_length = 0.0;
	assign		ray_length $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl"} %line{13} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:14
#   float strength = Strength;
	assign		strength Strength 	%line{14} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:15
#   getattribute("path:ray_length", ray_length);
	getattribute	$tmp1 $const2 ray_length 	%line{15} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:17
#   if (ray_length == FLT_MAX) {
	eq		$tmp2 ray_length $const3 	%line{17} %argrw{"wrr"}
	if		$tmp2 8 18 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:20
#     Quadratic = strength;
	assign		Quadratic strength 	%line{20} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:21
#     Linear = strength;
	assign		Linear strength 	%line{21} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:22
#     Constant = strength;
	assign		Constant strength 	%line{22} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:25
#     if (Smooth > 0.0) {
	gt		$tmp3 Smooth $const1 	%line{25} %argrw{"wrr"}
	if		$tmp3 14 14 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:26
#       float squared = ray_length * ray_length;
	mul		___370_squared ray_length ray_length 	%line{26} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:27
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:30
#     Quadratic = strength;
	assign		Quadratic strength 	%line{30} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:31
#     Linear = (strength * ray_length);
	mul		Linear strength ray_length 	%line{31} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_light_falloff.osl:32
