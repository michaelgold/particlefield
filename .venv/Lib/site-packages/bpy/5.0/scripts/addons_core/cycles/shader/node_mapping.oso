...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_mapping.oso
shader node_mapping
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:29
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:30
#   mat[1][2] = cy * sx;
	mul		$tmp21 ___369_cy ___369_sx 	%line{30} %argrw{"wrr"}
	mxcompassign	___369_mat $const4 $const5 $tmp21 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:32
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:33
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:34
#   mat[2][2] = cy * cx;
	mul		$tmp30 ___369_cy ___369_cx 	%line{34} %argrw{"wrr"}
	mxcompassign	___369_mat $const5 $const5 $tmp30 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:35
#   return mat;
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:48
#   else if (mapping_type == "texture") {
	eq		$tmp32 mapping_type $const7 	%line{48} %argrw{"wrr"}
	if		$tmp32 124 247 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:49
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:9
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:10
#                (b[1] != 0.0) ? a[1] / b[1] : 0.0,
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:11
#                (b[2] != 0.0) ? a[2] / b[2] : 0.0);
...
#                (b[2] != 0.0) ? a[2] / b[2] : 0.0);
	return	%line{11}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:52
#   else if (mapping_type == "vector") {
	eq		$tmp79 mapping_type $const10 	%line{52} %argrw{"wrr"}
	if		$tmp79 173 247 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:53
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:55
#   else if (mapping_type == "normal") {
	eq		$tmp109 mapping_type $const11 	%line{55} %argrw{"wrr"}
	if		$tmp109 246 247 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:56
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mapping.osl:59
