...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_rgb_ramp.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_ramp.osl:16
#   Color = rgb_ramp_lookup(ramp_color, Fac, interpolate, 0);
	functioncall	$const2 61 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_ramp.osl"} %line{16} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:9
#   float f = at;
	assign		___345_f Fac 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{9} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:10
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp17 Fac $const4 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp16 $tmp17 $const3 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:27
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp18 ___345_table_size $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{27} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_ramp.osl:17
#   Alpha = rgb_ramp_lookup(ramp_alpha, Fac, interpolate, 0);
	functioncall	$const2 122 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_ramp.osl"} %line{17} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:50
#   float f = at;
	assign		___352_f Fac 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{50} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:51
#   int table_size = arraylength(ramp);
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp47 Fac $const4 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp46 $tmp47 $const3 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:68
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp48 ___352_table_size $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{68} %argrw{"wrr"}
