...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_volume_coefficients.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_volume_coefficients.osl:18
#   closure color scatter_closure = scatter(phase, Anisotropy, IOR, Backscatter, Alpha, Diameter);
	functioncall	$const1 103 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_volume_coefficients.osl"} %line{18} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_scatter.h:54
#   closure color scatter = 0;
	assign		___372_scatter $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_scatter.h"} %line{54} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_scatter.h:55
...
# closure color mix (closure color x, closure color y, float a) { return x*(1-a) + y*a; }
	sub		$tmp58 $const64 ___376_param.mixture 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{164} %argrw{"wrr"}
...
#     scatter = henyey_greenstein(Anisotropy);
	closure		___372_scatter $const61 Anisotropy 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_scatter.h"} %line{71} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_scatter.h:73
#   return scatter;
	assign		scatter_closure ___372_scatter 	%line{73} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_volume_coefficients.osl:21
#   Volume = color(ScatterCoefficients) * scatter_closure +
	assign		$tmp61 ScatterCoefficients 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_volume_coefficients.osl"} %line{21} %argrw{"wr"}
	mul		$tmp62 scatter_closure $tmp61 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_volume_coefficients.osl:22
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_volume_coefficients.osl:25
