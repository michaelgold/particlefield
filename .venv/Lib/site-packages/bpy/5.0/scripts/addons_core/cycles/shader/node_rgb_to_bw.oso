...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_rgb_to_bw.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_to_bw.osl:9
#   Val = Color[0] * 0.2126 + Color[1] * 0.7152 + Color[2] * 0.0722;
	compref		$tmp1 Color $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_to_bw.osl"} %line{9} %argrw{"wrr"}
