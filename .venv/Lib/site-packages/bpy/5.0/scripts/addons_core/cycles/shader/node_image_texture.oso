...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_image_texture.oso
...
code Vector
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:89
#                           point Vector = P,
	assign		Vector P 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{89} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:103
#   point p = Vector;
	assign		p Vector 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{103} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:105
#   if (use_mapping)
	if		use_mapping 4 4 	%line{105} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:106
#     p = transform(mapping, p);
	transform	p mapping p 	%line{106} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:108
#   if (projection == "flat") {
	eq		$tmp1 projection $const1 	%line{108} %argrw{"wrr"}
	if		$tmp1 77 731 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:110
#                                  p[0],
	compref		$tmp2 p $const2 	%line{110} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:111
#                                  p[1],
	compref		$tmp3 p $const3 	%line{111} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:109
#     Color = image_texture_lookup(filename,
	functioncall	$const4 77 	%line{109} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:60
#   if (is_tiled) {
	if		is_tiled 14 15 	%line{60} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:61
#     float v_i = floor(v);
	floor		___420_v_i $tmp3 	%line{61} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:62
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:65
#     flip_v = 1.0 - v;
	sub		___419_flip_v $const5 $tmp3 	%line{65} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:67
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:70
#   if (ignore_alpha) {
	if		ignore_alpha 18 34 	%line{70} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:71
#     Alpha = 1.0;
	assign		Alpha $const5 	%line{71} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:73
#   else if (unassociate_alpha) {
	if		unassociate_alpha 34 34 	%line{73} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:74
#     rgb = color_unpremultiply(rgb, Alpha);
	functioncall	$const9 30 	%line{74} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp6 Alpha $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp10 is_float $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
	if		$tmp10 34 34 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:77
#       rgb = min(rgb, 1.0);
	assign		$tmp11 $const5 	%line{77} %argrw{"wr"}
	min		___419_rgb ___419_rgb $tmp11 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:80
#   if (compress_as_srgb) {
	if		compress_as_srgb 76 76 	%line{80} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:81
#     rgb = color_srgb_to_scene_linear(rgb);
	functioncall	$const11 76 	%line{81} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp13 ___419_rgb $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		Color ___419_rgb 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:121
#   else if (projection == "box") {
	eq		$tmp30 projection $const18 	%line{121} %argrw{"wrr"}
	if		$tmp30 526 731 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:123
#     vector Nob = transform("world", "object", N);
	transformn	___426_Nob $const19 $const20 N 	%line{123} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:126
#     vector signed_Nob = Nob;
	assign		___426_signed_Nob ___426_Nob 	%line{126} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:127
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:128
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:140
#     vector weight = vector(0.0, 0.0, 0.0);
	assign		___426_weight $const21 	%line{140} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:141
#     float blend = projection_blend;
	assign		___426_blend projection_blend 	%line{141} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:142
#     float limit = 0.5 * (1.0 + blend);
	add		$tmp42 $const5 ___426_blend 	%line{142} %argrw{"wrr"}
	mul		___426_limit $const22 $tmp42 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:145
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:146
#       weight[0] = 1.0;
	compassign	___426_weight $const2 $const5 	%line{146} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:148
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:149
#       weight[1] = 1.0;
	compassign	___426_weight $const3 $const5 	%line{149} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:151
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:152
#       weight[2] = 1.0;
	compassign	___426_weight $const17 $const5 	%line{152} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:154
#     else if (blend > 0.0) {
	gt		$tmp85 ___426_blend $const10 	%line{154} %argrw{"wrr"}
	if		$tmp85 259 260 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:156
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:157
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:158
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp104 $tmp103 $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp98 $tmp104 $const10 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:158
#         weight[0] = clamp((weight[0] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
	compassign	___426_weight $const2 $tmp98 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{158} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:159
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:161
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:162
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:163
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp125 $tmp124 $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp119 $tmp125 $const10 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:163
#         weight[1] = clamp((weight[1] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
	compassign	___426_weight $const3 $tmp119 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{163} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:164
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:166
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:167
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:168
#         weight[0] = clamp((weight[0] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp146 $tmp145 $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp140 $tmp146 $const10 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:168
#         weight[0] = clamp((weight[0] - 0.5 * (1.0 - blend)) / blend, 0.0, 1.0);
	compassign	___426_weight $const2 $tmp140 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{168} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:169
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:173
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:174
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:175
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:180
#       weight[0] = 1.0;
	compassign	___426_weight $const2 $const5 	%line{180} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:183
#     Color = color(0.0, 0.0, 0.0);
	assign		Color $const25 	%line{183} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:184
#     Alpha = 0.0;
	assign		Alpha $const10 	%line{184} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:188
#     if (weight[0] > 0.0) {
	compref		$tmp173 ___426_weight $const2 	%line{188} %argrw{"wrr"}
	gt		$tmp174 $tmp173 $const10 	%argrw{"wrr"}
	if		$tmp174 350 350 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:189
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:190
#       Color += weight[0] * image_texture_lookup(filename,
	compref		$tmp180 ___426_weight $const2 	%line{190} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:191
#                                                 UV[0],
	compref		$tmp182 ___436_UV $const2 	%line{191} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:192
#                                                 UV[1],
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp186 ___426_tmp_alpha $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp190 is_float $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp193 ___419_rgb $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		$tmp181 ___419_rgb 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:190
#       Color += weight[0] * image_texture_lookup(filename,
	mul		$tmp210 $tmp180 $tmp181 	%line{190} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:200
#                                                 extension);
	add		Color Color $tmp210 	%line{200} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:201
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:203
#     if (weight[1] > 0.0) {
	compref		$tmp213 ___426_weight $const3 	%line{203} %argrw{"wrr"}
	gt		$tmp214 $tmp213 $const10 	%argrw{"wrr"}
	if		$tmp214 438 438 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:204
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:205
#       Color += weight[1] * image_texture_lookup(filename,
	compref		$tmp220 ___426_weight $const3 	%line{205} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:206
#                                                 UV[0],
	compref		$tmp222 ___437_UV $const2 	%line{206} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:207
#                                                 UV[1],
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp226 ___426_tmp_alpha $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp230 is_float $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp233 ___419_rgb $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		$tmp221 ___419_rgb 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:205
#       Color += weight[1] * image_texture_lookup(filename,
	mul		$tmp250 $tmp220 $tmp221 	%line{205} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:215
#                                                 extension);
	add		Color Color $tmp250 	%line{215} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:216
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:218
#     if (weight[2] > 0.0) {
	compref		$tmp253 ___426_weight $const17 	%line{218} %argrw{"wrr"}
	gt		$tmp254 $tmp253 $const10 	%argrw{"wrr"}
	if		$tmp254 526 526 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:219
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:220
#       Color += weight[2] * image_texture_lookup(filename,
	compref		$tmp260 ___426_weight $const17 	%line{220} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:221
#                                                 UV[0],
	compref		$tmp262 ___438_UV $const2 	%line{221} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:222
#                                                 UV[1],
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp266 ___426_tmp_alpha $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp270 is_float $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp273 ___419_rgb $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:84
#   return rgb;
	assign		$tmp261 ___419_rgb 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:220
#       Color += weight[2] * image_texture_lookup(filename,
	mul		$tmp290 $tmp260 $tmp261 	%line{220} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:230
#                                                 extension);
	add		Color Color $tmp290 	%line{230} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:231
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:234
#   else if (projection == "sphere") {
	eq		$tmp293 projection $const26 	%line{234} %argrw{"wrr"}
	if		$tmp293 630 731 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:235
#     point projected = map_to_sphere(texco_remap_square(p));
	functioncall	$const27 531 	%line{235} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:10
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:29
#   float len = length(dir);
	length		___414_len $tmp294 	%line{29} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:31
#   if (len > 0.0) {
	gt		$tmp297 ___414_len $const10 	%line{31} %argrw{"wrr"}
	if		$tmp297 556 558 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:32
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:33
#       u = 0.0; /* Otherwise domain error. */
	assign		___414_u $const10 	%line{33} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:36
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:38
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:41
#     v = u = 0.0; /* To avoid un-initialized variables. */
	assign		___414_u $const10 	%line{41} %argrw{"wr"}
	assign		___414_v ___414_u 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:43
#   return point(u, v, 0.0);
	point		___439_projected ___414_u ___414_v $const10 	%line{43} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:237
#                                  projected[0],
	compref		$tmp313 ___439_projected $const2 	%line{237} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:238
#                                  projected[1],
	compref		$tmp314 ___439_projected $const3 	%line{238} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:236
#     Color = image_texture_lookup(filename,
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp317 Alpha $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp321 is_float $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp324 ___419_rgb $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
...
#   return rgb;
	assign		Color ___419_rgb 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{84} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:248
#   else if (projection == "tube") {
	eq		$tmp341 projection $const31 	%line{248} %argrw{"wrr"}
	if		$tmp341 731 731 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:249
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:16
#   v = (dir[2] + 1.0) * 0.5;
	compref		$tmp345 $tmp342 $const17 	%line{16} %argrw{"wrr"}
	add		$tmp346 $tmp345 $const5 	%argrw{"wrr"}
	mul		___411_v $tmp346 $const22 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:17
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:18
#   if (len > 0.0) {
	gt		$tmp354 ___411_len $const10 	%line{18} %argrw{"wrr"}
	if		$tmp354 657 659 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:19
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:22
#     v = u = 0.0; /* To avoid un-initialized variables. */
	assign		___411_u $const10 	%line{22} %argrw{"wr"}
	assign		___411_v ___411_u 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:24
#   return point(u, v, 0.0);
	point		___440_projected ___411_u ___411_v $const10 	%line{24} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:251
#                                  projected[0],
	compref		$tmp362 ___440_projected $const2 	%line{251} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:252
#                                  projected[1],
	compref		$tmp363 ___440_projected $const3 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:250
#     Color = image_texture_lookup(filename,
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:43
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp366 Alpha $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl:76
#     if (!is_float)
	eq		$tmp370 is_float $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_image_texture.osl"} %line{76} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp373 ___419_rgb $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
