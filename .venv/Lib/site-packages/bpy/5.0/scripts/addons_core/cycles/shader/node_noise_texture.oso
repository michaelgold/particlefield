...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_noise_texture.oso
...
local	float	___461_precision_correction	%read{27,893} %write{25,891}
local	float	___461_p	%read{28,894} %write{27,893}
local	float	___462_precision_correction.x	%read{948,2510} %write{939,2501} %mystruct{___462_precision_correction} %mystructfield{0}
local	float	___462_precision_correction.y	%read{949,2511} %write{940,2502} %mystruct{___462_precision_correction} %mystructfield{1}
local	float	___462_p.x	%read{950,2512} %write{948,2510} %mystruct{___462_p} %mystructfield{0}
local	float	___462_p.y	%read{950,2512} %write{949,2511} %mystruct{___462_p} %mystructfield{1}
local	point	___463_precision_correction	%read{2562,3907} %write{2560,3905}
local	point	___463_p	%read{2563,3908} %write{2562,3907}
local	float	___464_precision_correction.x	%read{3990,6464} %write{3975,6449} %mystruct{___464_precision_correction} %mystructfield{0}
local	float	___464_precision_correction.y	%read{3991,6465} %write{3976,6450} %mystruct{___464_precision_correction} %mystructfield{1}
local	float	___464_precision_correction.z	%read{3992,6466} %write{3977,6451} %mystruct{___464_precision_correction} %mystructfield{2}
local	float	___464_precision_correction.w	%read{3993,6467} %write{3978,6452} %mystruct{___464_precision_correction} %mystructfield{3}
local	float	___464_p.x	%read{3994,6468} %write{3990,6464} %mystruct{___464_p} %mystructfield{0}
local	float	___464_p.y	%read{3994,6468} %write{3991,6465} %mystruct{___464_p} %mystructfield{1}
local	float	___464_p.z	%read{3994,6468} %write{3992,6466} %mystruct{___464_p} %mystructfield{2}
local	float	___464_p.w	%read{3995,6469} %write{3993,6467} %mystruct{___464_p} %mystructfield{3}
local	float	___465_p	%read{88,698} %write{81,667}
local	float	___465_fscale	%read{88,698} %write{82,693}
local	float	___465_amp	%read{88,715} %write{83,693}
local	float	___465_maxamp	%read{88,723} %write{84,693}
local	float	___465_sum	%read{88,725} %write{85,693}
local	int	___466_i	%read{88,693} %write{87,693}
local	float	___467_t	%read{88,693} %write{88,693}
local	float	___465_rmd	%read{110,719} %write{109,695}
local	float	___468_t	%read{122,708} %write{121,707}
local	float	___468_sum2	%read{128,719} %write{123,709}
local	float	___470_p.x	%read{1087,2164} %write{1079,2107} %mystruct{___470_p} %mystructfield{0}
local	float	___470_p.y	%read{1087,2165} %write{1080,2108} %mystruct{___470_p} %mystructfield{1}
local	float	___470_fscale	%read{1087,2162} %write{1081,2155}
local	float	___470_amp	%read{1087,2198} %write{1082,2155}
local	float	___470_maxamp	%read{1087,2206} %write{1083,2155}
local	float	___470_sum	%read{1087,2208} %write{1084,2155}
local	int	___471_i	%read{1087,2155} %write{1086,2155}
local	float	___472_t	%read{1087,2155} %write{1087,2155}
local	float	___470_rmd	%read{1130,2202} %write{1129,2157}
local	float	___473_t	%read{1163,2191} %write{1162,2190}
local	float	___473_sum2	%read{1169,2202} %write{1164,2192}
local	point	___475_p	%read{2716,3616} %write{2709,3573}
local	float	___475_fscale	%read{2716,3616} %write{2710,3611}
local	float	___475_amp	%read{2716,3645} %write{2711,3611}
local	float	___475_maxamp	%read{2716,3653} %write{2712,3611}
local	float	___475_sum	%read{2716,3655} %write{2713,3611}
local	int	___476_i	%read{2716,3611} %write{2715,3611}
local	float	___477_t	%read{2716,3611} %write{2716,3611}
local	float	___475_rmd	%read{2750,3649} %write{2749,3613}
local	float	___478_t	%read{2774,3638} %write{2773,3637}
local	float	___478_sum2	%read{2780,3649} %write{2775,3639}
local	float	___480_p.x	%read{4333,5945} %write{4323,5861} %mystruct{___480_p} %mystructfield{0}
local	float	___480_p.y	%read{4333,5946} %write{4324,5862} %mystruct{___480_p} %mystructfield{1}
local	float	___480_p.z	%read{4333,5947} %write{4325,5863} %mystruct{___480_p} %mystructfield{2}
local	float	___480_p.w	%read{4333,5948} %write{4326,5864} %mystruct{___480_p} %mystructfield{3}
local	float	___480_fscale	%read{4333,5943} %write{4327,5934}
local	float	___480_amp	%read{4333,6000} %write{4328,5934}
local	float	___480_maxamp	%read{4333,6008} %write{4329,5934}
local	float	___480_sum	%read{4333,6010} %write{4330,5934}
local	int	___481_i	%read{4333,5934} %write{4332,5934}
local	float	___482_t	%read{4333,5934} %write{4333,5934}
local	float	___480_rmd	%read{4399,6004} %write{4398,5936}
local	float	___483_t	%read{4455,5993} %write{4454,5992}
local	float	___483_sum2	%read{4461,6004} %write{4456,5994}
local	float	___485_p	%read{40,656} %write{35,644}
local	float	___485_value	%read{40,662} %write{36,661}
local	float	___485_pwr	%read{40,649} %write{37,644}
local	int	___486_i	%read{40,644} %write{39,644}
local	float	___485_rmd	%read{61,649} %write{60,646}
local	float	___489_p.x	%read{1001,2093} %write{995,2068} %mystruct{___489_p} %mystructfield{0}
local	float	___489_p.y	%read{1001,2094} %write{996,2068} %mystruct{___489_p} %mystructfield{1}
local	float	___489_value	%read{1001,2102} %write{997,2101}
local	float	___489_pwr	%read{1001,2073} %write{998,2068}
local	int	___490_i	%read{1001,2068} %write{1000,2068}
local	float	___489_rmd	%read{1043,2073} %write{1042,2070}
local	point	___493_p	%read{2644,3562} %write{2639,3538}
local	float	___493_value	%read{2644,3568} %write{2640,3567}
local	float	___493_pwr	%read{2644,3543} %write{2641,3538}
local	int	___494_i	%read{2644,3538} %write{2643,3538}
local	float	___493_rmd	%read{2677,3543} %write{2676,3540}
local	float	___497_p.x	%read{4203,5842} %write{4195,5803} %mystruct{___497_p} %mystructfield{0}
local	float	___497_p.y	%read{4203,5843} %write{4196,5803} %mystruct{___497_p} %mystructfield{1}
local	float	___497_p.z	%read{4203,5844} %write{4197,5803} %mystruct{___497_p} %mystructfield{2}
local	float	___497_p.w	%read{4203,5845} %write{4198,5803} %mystruct{___497_p} %mystructfield{3}
local	float	___497_value	%read{4203,5856} %write{4199,5855}
local	float	___497_pwr	%read{4203,5808} %write{4200,5803}
local	int	___498_i	%read{4203,5803} %write{4202,5803}
local	float	___497_rmd	%read{4268,5808} %write{4267,5805}
local	float	___501_p	%read{264,892} %write{261,881}
local	float	___501_pwr	%read{276,896} %write{262,881}
local	float	___501_value	%read{276,900} %write{272,899}
local	int	___502_i	%read{276,881} %write{275,881}
local	float	___503_increment	%read{276,881} %write{276,881}
local	float	___501_rmd	%read{298,898} %write{297,883}
local	float	___504_increment	%read{312,898} %write{311,897}
local	float	___505_p.x	%read{1382,2507} %write{1378,2483} %mystruct{___505_p} %mystructfield{0}
local	float	___505_p.y	%read{1386,2508} %write{1379,2483} %mystruct{___505_p} %mystructfield{1}
local	float	___505_pwr	%read{1415,2514} %write{1380,2483}
local	float	___505_value	%read{1415,2518} %write{1406,2517}
local	int	___506_i	%read{1415,2483} %write{1414,2483}
local	float	___507_increment	%read{1415,2483} %write{1415,2483}
local	float	___505_rmd	%read{1458,2516} %write{1457,2485}
local	float	___508_increment	%read{1488,2516} %write{1487,2515}
local	point	___509_p	%read{2964,3906} %write{2961,3883}
local	float	___509_pwr	%read{2988,3910} %write{2962,3883}
local	float	___509_value	%read{2988,3914} %write{2984,3913}
local	int	___510_i	%read{2988,3883} %write{2987,3883}
local	float	___511_increment	%read{2988,3883} %write{2988,3883}
local	float	___509_rmd	%read{3022,3912} %write{3021,3885}
local	float	___512_increment	%read{3048,3912} %write{3047,3911}
local	float	___513_p.x	%read{4764,6459} %write{4758,6421} %mystruct{___513_p} %mystructfield{0}
local	float	___513_p.y	%read{4768,6460} %write{4759,6421} %mystruct{___513_p} %mystructfield{1}
local	float	___513_p.z	%read{4772,6461} %write{4760,6421} %mystruct{___513_p} %mystructfield{2}
local	float	___513_p.w	%read{4776,6462} %write{4761,6421} %mystruct{___513_p} %mystructfield{3}
local	float	___513_pwr	%read{4820,6471} %write{4762,6421}
local	float	___513_value	%read{4820,6475} %write{4807,6474}
local	int	___514_i	%read{4820,6421} %write{4819,6421}
local	float	___515_increment	%read{4820,6421} %write{4820,6421}
local	float	___513_rmd	%read{4886,6473} %write{4885,6423}
local	float	___516_increment	%read{4935,6473} %write{4934,6472}
local	float	___517_p	%read{151,785} %write{145,766}
local	float	___517_pwr	%read{151,789} %write{146,766}
local	float	___517_value	%read{151,793} %write{147,792}
local	float	___517_weight	%read{151,790} %write{148,778}
local	int	___518_i	%read{151,766} %write{150,766}
local	float	___519_signal	%read{151,766} %write{151,766}
local	float	___517_rmd	%read{183,790} %write{182,768}
local	float	___521_signal	%read{205,791} %write{203,789}
local	float	___523_p.x	%read{1193,2303} %write{1186,2271} %mystruct{___523_p} %mystructfield{0}
local	float	___523_p.y	%read{1193,2304} %write{1187,2271} %mystruct{___523_p} %mystructfield{1}
local	float	___523_pwr	%read{1193,2310} %write{1188,2271}
local	float	___523_value	%read{1193,2314} %write{1189,2313}
local	float	___523_weight	%read{1193,2311} %write{1190,2283}
local	int	___524_i	%read{1193,2271} %write{1192,2271}
local	float	___525_signal	%read{1193,2271} %write{1193,2271}
local	float	___523_rmd	%read{1246,2311} %write{1245,2273}
local	float	___527_signal	%read{1284,2312} %write{1282,2310}
local	point	___529_p	%read{2803,3739} %write{2797,3708}
local	float	___529_pwr	%read{2803,3743} %write{2798,3708}
local	float	___529_value	%read{2803,3747} %write{2799,3746}
local	float	___529_weight	%read{2803,3744} %write{2800,3720}
local	int	___530_i	%read{2803,3708} %write{2802,3708}
local	float	___531_signal	%read{2803,3708} %write{2803,3708}
local	float	___529_rmd	%read{2847,3744} %write{2846,3710}
local	float	___533_signal	%read{2881,3745} %write{2879,3743}
local	float	___535_p.x	%read{4487,6144} %write{4478,6098} %mystruct{___535_p} %mystructfield{0}
local	float	___535_p.y	%read{4487,6145} %write{4479,6098} %mystruct{___535_p} %mystructfield{1}
local	float	___535_p.z	%read{4487,6146} %write{4480,6098} %mystruct{___535_p} %mystructfield{2}
local	float	___535_p.w	%read{4487,6147} %write{4481,6098} %mystruct{___535_p} %mystructfield{3}
local	float	___535_pwr	%read{4487,6156} %write{4482,6098}
local	float	___535_value	%read{4487,6160} %write{4483,6159}
local	float	___535_weight	%read{4487,6157} %write{4484,6110}
local	int	___536_i	%read{4487,6098} %write{4486,6098}
local	float	___537_signal	%read{4487,6098} %write{4487,6098}
local	float	___535_rmd	%read{4563,6157} %write{4562,6100}
local	float	___539_signal	%read{4620,6158} %write{4618,6156}
local	float	___541_p	%read{215,841} %write{212,841}
local	float	___541_pwr	%read{230,841} %write{213,841}
local	float	___541_signal	%read{225,841} %write{224,841}
local	float	___541_value	%read{230,842} %write{226,841}
local	float	___541_weight	%read{230,841} %write{227,841}
local	int	___542_i	%read{230,841} %write{229,841}
local	float	___544_p.x	%read{1295,2400} %write{1291,2400} %mystruct{___544_p} %mystructfield{0}
local	float	___544_p.y	%read{1299,2400} %write{1292,2400} %mystruct{___544_p} %mystructfield{1}
local	float	___544_pwr	%read{1326,2400} %write{1293,2400}
local	float	___544_signal	%read{1321,2400} %write{1320,2400}
local	float	___544_value	%read{1326,2401} %write{1322,2400}
local	float	___544_weight	%read{1326,2400} %write{1323,2400}
local	int	___545_i	%read{1326,2400} %write{1325,2400}
local	point	___547_p	%read{2891,3819} %write{2888,3819}
local	float	___547_pwr	%read{2918,3819} %write{2889,3819}
local	float	___547_signal	%read{2913,3819} %write{2912,3819}
local	float	___547_value	%read{2918,3820} %write{2914,3819}
local	float	___547_weight	%read{2918,3819} %write{2915,3819}
local	int	___548_i	%read{2918,3819} %write{2917,3819}
local	float	___550_p.x	%read{4633,6290} %write{4627,6290} %mystruct{___550_p} %mystructfield{0}
local	float	___550_p.y	%read{4637,6290} %write{4628,6290} %mystruct{___550_p} %mystructfield{1}
local	float	___550_p.z	%read{4641,6290} %write{4629,6290} %mystruct{___550_p} %mystructfield{2}
local	float	___550_p.w	%read{4645,6290} %write{4630,6290} %mystruct{___550_p} %mystructfield{3}
local	float	___550_pwr	%read{4683,6290} %write{4631,6290}
local	float	___550_signal	%read{4678,6290} %write{4677,6290}
local	float	___550_value	%read{4683,6291} %write{4679,6290}
local	float	___550_weight	%read{4683,6290} %write{4680,6290}
local	int	___551_i	%read{4683,6290} %write{4682,6290}
local	float	___608_p	%read{19,616} %write{12,30}
local	float	___608_value	%read{905,906} %write{76,317}
local	float	___610_p.x	%read{924,2017} %write{912,989} %mystruct{___610_p} %mystructfield{0}
local	float	___610_p.y	%read{925,2018} %write{913,990} %mystruct{___610_p} %mystructfield{1}
local	float	___610_value	%read{2523,2524} %write{1074,1493}
local	point	___612_p	%read{2542,3498} %write{2528,2634}
local	float	___612_value	%read{3919,3920} %write{2704,3053}
local	float	___614_p.x	%read{3948,5725} %write{3928,4187} %mystruct{___614_p} %mystructfield{0}
local	float	___614_p.y	%read{3949,5726} %write{3929,4188} %mystruct{___614_p} %mystructfield{1}
local	float	___614_p.z	%read{3950,5727} %write{3930,4189} %mystruct{___614_p} %mystructfield{2}
local	float	___614_p.w	%read{3951,5728} %write{3931,4190} %mystruct{___614_p} %mystructfield{3}
local	float	___614_value	%read{6480,6481} %write{4318,4940}
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:255
#   vector3 p = Vector;
	assign		p Vector 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{255} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:256
#   if (use_mapping)
	if		use_mapping 3 3 	%line{256} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:257
#     p = transform(mapping, p);
	transform	p mapping p 	%line{257} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:259
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:260
#   float roughness = max(Roughness, 0.0);
	max		roughness Roughness $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{260} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:262
#   p *= Scale;
	mul		p p Scale 	%line{262} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:263
#   float w = W * Scale;
	mul		w W Scale 	%line{263} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:265
#   if (dimensions == "1D") {
	eq		$tmp2 dimensions $const4 	%line{265} %argrw{"wrr"}
	if		$tmp2 907 6483 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:266
#     Fac = noise_texture(
	functioncall	$const5 907 	%line{266} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:95
#   float p = co;
	assign		___608_p w 	%line{95} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:96
#   if (distortion != 0.0) {
	neq		$tmp3 Distortion $const1 	%line{96} %argrw{"wrr"}
	if		$tmp3 31 31 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:97
#     p += safe_snoise(p + random_float_offset(0.0)) * distortion;
	functioncall	$const6 19 	%line{97} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:53
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:97
#     p += safe_snoise(p + random_float_offset(0.0)) * distortion;
	add		$tmp8 ___608_p $tmp5 	%line{97} %argrw{"wrr"}
...
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp10 $tmp8 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{61} %argrw{"wr"}
	ge		$tmp11 $tmp10 $const11 	%argrw{"wrr"}
	assign		$tmp12 $tmp11 	%argrw{"wr"}
	assign		$tmp9 $tmp12 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp9 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp13 $tmp8 $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp13 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp4 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:97
#     p += safe_snoise(p + random_float_offset(0.0)) * distortion;
	mul		$tmp14 $tmp4 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{97} %argrw{"wrr"}
	add		___608_p ___608_p $tmp14 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:100
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
...
# NOISE_MULTI_FRACTAL(float)
	assign		___485_p ___608_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{251} %argrw{"wr"}
	assign		___485_value $const17 	%argrw{"wr"}
	assign		___485_pwr $const17 	%argrw{"wr"}
	for		$tmp18 40 43 57 59 	%argrw{"r"}
	assign		___486_i $const18 	%argrw{"wr"}
	assign		$tmp16 detail 	%argrw{"wr"}
	le		$tmp17 ___486_i $tmp16 	%argrw{"wrr"}
	neq		$tmp18 $tmp17 $const18 	%argrw{"wrr"}
	functioncall	$const9 52 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp21 ___485_p 	%line{61} %argrw{"wr"}
	ge		$tmp22 $tmp21 $const11 	%argrw{"wrr"}
	assign		$tmp23 $tmp22 	%argrw{"wr"}
	assign		$tmp20 $tmp23 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp20 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp24 ___485_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp24 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp19 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	mul		$tmp25 ___485_pwr $tmp19 	%line{251} %argrw{"wrr"}
	add		$tmp26 $tmp25 $const17 	%argrw{"wrr"}
	mul		___485_value ___485_value $tmp26 	%argrw{"wrr"}
	mul		___485_pwr ___485_pwr roughness 	%argrw{"wrr"}
	mul		___485_p ___485_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp27 ___486_i 	%argrw{"wr"}
	add		___486_i ___486_i $const19 	%argrw{"wrr"}
	floor		$tmp28 detail 	%argrw{"wr"}
	sub		___485_rmd detail $tmp28 	%argrw{"wrr"}
	neq		$tmp29 ___485_rmd $const1 	%argrw{"wrr"}
	if		$tmp29 76 76 	%argrw{"r"}
	mul		$tmp30 ___485_rmd ___485_pwr 	%argrw{"wrr"}
	functioncall	$const9 73 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp33 ___485_p 	%line{61} %argrw{"wr"}
	ge		$tmp34 $tmp33 $const11 	%argrw{"wrr"}
	assign		$tmp35 $tmp34 	%argrw{"wr"}
	assign		$tmp32 $tmp35 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp32 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp36 ___485_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp36 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp31 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	mul		$tmp37 $tmp30 $tmp31 	%line{251} %argrw{"wrr"}
	add		$tmp38 $tmp37 $const17 	%argrw{"wrr"}
	mul		___485_value ___485_value $tmp38 	%argrw{"wrr"}
	assign		___608_value ___485_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
	eq		$tmp39 type $const20 	%argrw{"wrr"}
	if		$tmp39 142 319 	%argrw{"r"}
	functioncall	$const21 141 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	assign		___465_p ___608_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{244} %argrw{"wr"}
	assign		___465_fscale $const17 	%argrw{"wr"}
	assign		___465_amp $const17 	%argrw{"wr"}
	assign		___465_maxamp $const1 	%argrw{"wr"}
	assign		___465_sum $const1 	%argrw{"wr"}
	for		$tmp42 88 91 106 108 	%argrw{"r"}
	assign		___466_i $const18 	%argrw{"wr"}
	assign		$tmp40 detail 	%argrw{"wr"}
	le		$tmp41 ___466_i $tmp40 	%argrw{"wrr"}
	neq		$tmp42 $tmp41 $const18 	%argrw{"wrr"}
	mul		$tmp43 ___465_fscale ___465_p 	%argrw{"wrr"}
...
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	...
	mul		___461_precision_correction $const10 $tmp44 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp48 $tmp43 $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp48 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		___467_t $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	mul		$tmp49 ___467_t ___465_amp 	%line{244} %argrw{"wrr"}
	add		___465_sum ___465_sum $tmp49 	%argrw{"wrr"}
	add		___465_maxamp ___465_maxamp ___465_amp 	%argrw{"wrr"}
	mul		___465_amp ___465_amp roughness 	%argrw{"wrr"}
	mul		___465_fscale ___465_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp50 ___466_i 	%argrw{"wr"}
	add		___466_i ___466_i $const19 	%argrw{"wrr"}
	floor		$tmp51 detail 	%argrw{"wr"}
	sub		___465_rmd detail $tmp51 	%argrw{"wrr"}
	neq		$tmp52 ___465_rmd $const1 	%argrw{"wrr"}
	if		$tmp52 135 141 	%argrw{"r"}
	mul		$tmp53 ___465_fscale ___465_p 	%argrw{"wrr"}
...
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	...
	mul		___461_precision_correction $const10 $tmp54 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp58 $tmp53 $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp58 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		___468_t $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	mul		$tmp59 ___468_t ___465_amp 	%line{244} %argrw{"wrr"}
	add		___468_sum2 ___465_sum $tmp59 	%argrw{"wrr"}
	if		use_normalize 133 134 	%argrw{"r"}
	mul		$tmp60 $const10 ___465_sum 	%argrw{"wrr"}
	div		$tmp61 $tmp60 ___465_maxamp 	%argrw{"wrr"}
	add		$tmp62 $tmp61 $const10 	%argrw{"wrr"}
	mul		$tmp63 $const10 ___468_sum2 	%argrw{"wrr"}
	add		$tmp64 ___465_maxamp ___465_amp 	%argrw{"wrr"}
	div		$tmp65 $tmp63 $tmp64 	%argrw{"wrr"}
	add		$tmp66 $tmp65 $const10 	%argrw{"wrr"}
	mix		___608_value $tmp62 $tmp66 ___465_rmd 	%argrw{"wrrr"}
	mix		___608_value ___465_sum ___468_sum2 ___465_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 139 140 	%argrw{"r"}
	mul		$tmp67 $const10 ___465_sum 	%argrw{"wrr"}
	div		$tmp68 $tmp67 ___465_maxamp 	%argrw{"wrr"}
	add		___608_value $tmp68 $const10 	%argrw{"wrr"}
	assign		___608_value ___465_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# NOISE_HYBRID_MULTI_FRACTAL(float)
	assign		___517_p ___608_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{265} %argrw{"wr"}
	assign		___517_pwr $const17 	%argrw{"wr"}
	assign		___517_value $const1 	%argrw{"wr"}
	assign		___517_weight $const17 	%argrw{"wr"}
	for		$tmp75 151 159 179 181 	%argrw{"r"}
	assign		___518_i $const18 	%argrw{"wr"}
	gt		$tmp70 ___517_weight $const24 	%argrw{"wrr"}
	neq		$tmp71 $tmp70 $const18 	%argrw{"wrr"}
	if		$tmp71 158 158 	%argrw{"r"}
	assign		$tmp72 detail 	%argrw{"wr"}
	le		$tmp73 ___518_i $tmp72 	%argrw{"wrr"}
	neq		$tmp74 $tmp73 $const18 	%argrw{"wrr"}
	assign		$tmp71 $tmp74 	%argrw{"wr"}
	neq		$tmp75 $tmp71 $const18 	%argrw{"wrr"}
	gt		$tmp76 ___517_weight $const17 	%argrw{"wrr"}
	if		$tmp76 162 162 	%argrw{"r"}
	assign		___517_weight $const17 	%argrw{"wr"}
	functioncall	$const9 171 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp79 ___517_p 	%line{61} %argrw{"wr"}
	ge		$tmp80 $tmp79 $const11 	%argrw{"wrr"}
	assign		$tmp81 $tmp80 	%argrw{"wr"}
	assign		$tmp78 $tmp81 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp78 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp82 ___517_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp82 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp77 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	add		$tmp83 $tmp77 Offset 	%line{265} %argrw{"wrr"}
	mul		___519_signal $tmp83 ___517_pwr 	%argrw{"wrr"}
	mul		___517_pwr ___517_pwr roughness 	%argrw{"wrr"}
	mul		$tmp84 ___517_weight ___519_signal 	%argrw{"wrr"}
	add		___517_value ___517_value $tmp84 	%argrw{"wrr"}
	mul		$tmp85 Gain ___519_signal 	%argrw{"wrr"}
	mul		___517_weight ___517_weight $tmp85 	%argrw{"wrr"}
	mul		___517_p ___517_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp86 ___518_i 	%argrw{"wr"}
	add		___518_i ___518_i $const19 	%argrw{"wrr"}
	floor		$tmp87 detail 	%argrw{"wr"}
	sub		___517_rmd detail $tmp87 	%argrw{"wrr"}
	neq		$tmp88 ___517_rmd $const1 	%argrw{"wrr"}
	neq		$tmp89 $tmp88 $const18 	%argrw{"wrr"}
	if		$tmp89 189 189 	%argrw{"r"}
	gt		$tmp90 ___517_weight $const24 	%argrw{"wrr"}
	neq		$tmp91 $tmp90 $const18 	%argrw{"wrr"}
	assign		$tmp89 $tmp91 	%argrw{"wr"}
	if		$tmp89 207 207 	%argrw{"r"}
	gt		$tmp92 ___517_weight $const17 	%argrw{"wrr"}
	if		$tmp92 193 193 	%argrw{"r"}
	assign		___517_weight $const17 	%argrw{"wr"}
	functioncall	$const9 202 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp95 ___517_p 	%line{61} %argrw{"wr"}
	ge		$tmp96 $tmp95 $const11 	%argrw{"wrr"}
	assign		$tmp97 $tmp96 	%argrw{"wr"}
	assign		$tmp94 $tmp97 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp94 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp98 ___517_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp98 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp93 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	add		$tmp99 $tmp93 Offset 	%line{265} %argrw{"wrr"}
	mul		___521_signal $tmp99 ___517_pwr 	%argrw{"wrr"}
	mul		$tmp100 ___517_rmd ___517_weight 	%argrw{"wrr"}
	mul		$tmp101 $tmp100 ___521_signal 	%argrw{"wrr"}
	add		___517_value ___517_value $tmp101 	%argrw{"wrr"}
	assign		___608_value ___517_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# NOISE_RIDGED_MULTI_FRACTAL(float)
	assign		___541_p ___608_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{272} %argrw{"wr"}
	assign		___541_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 223 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp106 ___541_p 	%line{61} %argrw{"wr"}
	ge		$tmp107 $tmp106 $const11 	%argrw{"wrr"}
	assign		$tmp108 $tmp107 	%argrw{"wr"}
	assign		$tmp105 $tmp108 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp105 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp109 ___541_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp109 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp104 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	fabs		$tmp103 $tmp104 	%line{272} %argrw{"wr"}
	sub		___541_signal Offset $tmp103 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_signal 	%argrw{"wrr"}
	assign		___541_value ___541_signal 	%argrw{"wr"}
	assign		___541_weight $const17 	%argrw{"wr"}
	for		$tmp112 230 233 254 256 	%argrw{"r"}
	assign		___542_i $const19 	%argrw{"wr"}
	assign		$tmp110 detail 	%argrw{"wr"}
	le		$tmp111 ___542_i $tmp110 	%argrw{"wrr"}
	neq		$tmp112 $tmp111 $const18 	%argrw{"wrr"}
	mul		___541_p ___541_p Lacunarity 	%argrw{"wrr"}
	mul		$tmp113 ___541_signal Gain 	%argrw{"wrr"}
	functioncall	$const3 238 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp114 $tmp113 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___541_weight $tmp114 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	functioncall	$const9 247 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{272} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp118 ___541_p 	%line{61} %argrw{"wr"}
	ge		$tmp119 $tmp118 $const11 	%argrw{"wrr"}
	assign		$tmp120 $tmp119 	%argrw{"wr"}
	assign		$tmp117 $tmp120 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp117 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp121 ___541_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp121 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp116 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	fabs		$tmp115 $tmp116 	%line{272} %argrw{"wr"}
	sub		___541_signal Offset $tmp115 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_signal 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_weight 	%argrw{"wrr"}
	mul		$tmp122 ___541_signal ___541_pwr 	%argrw{"wrr"}
	add		___541_value ___541_value $tmp122 	%argrw{"wrr"}
	mul		___541_pwr ___541_pwr roughness 	%argrw{"wrr"}
	assign		$tmp123 ___542_i 	%argrw{"wr"}
	add		___542_i ___542_i $const19 	%argrw{"wrr"}
	assign		___608_value ___541_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# NOISE_HETERO_TERRAIN(float)
	assign		___501_p ___608_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{258} %argrw{"wr"}
	assign		___501_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 272 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp127 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp128 $tmp127 $const11 	%argrw{"wrr"}
	assign		$tmp129 $tmp128 	%argrw{"wr"}
	assign		$tmp126 $tmp129 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp126 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp130 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp130 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp125 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		___501_value Offset $tmp125 	%line{258} %argrw{"wrr"}
	mul		___501_p ___501_p Lacunarity 	%argrw{"wrr"}
	for		$tmp133 276 279 294 296 	%argrw{"r"}
	assign		___502_i $const19 	%argrw{"wr"}
	assign		$tmp131 detail 	%argrw{"wr"}
	le		$tmp132 ___502_i $tmp131 	%argrw{"wrr"}
	neq		$tmp133 $tmp132 $const18 	%argrw{"wrr"}
	functioncall	$const9 288 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp136 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp137 $tmp136 $const11 	%argrw{"wrr"}
	assign		$tmp138 $tmp137 	%argrw{"wr"}
	assign		$tmp135 $tmp138 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp135 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp139 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp139 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp134 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		$tmp140 $tmp134 Offset 	%line{258} %argrw{"wrr"}
	mul		$tmp141 $tmp140 ___501_pwr 	%argrw{"wrr"}
	mul		___503_increment $tmp141 ___501_value 	%argrw{"wrr"}
	add		___501_value ___501_value ___503_increment 	%argrw{"wrr"}
	mul		___501_pwr ___501_pwr roughness 	%argrw{"wrr"}
	mul		___501_p ___501_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp142 ___502_i 	%argrw{"wr"}
	add		___502_i ___502_i $const19 	%argrw{"wrr"}
	floor		$tmp143 detail 	%argrw{"wr"}
	sub		___501_rmd detail $tmp143 	%argrw{"wrr"}
	neq		$tmp144 ___501_rmd $const1 	%argrw{"wrr"}
	if		$tmp144 314 314 	%argrw{"r"}
	functioncall	$const9 309 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp147 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp148 $tmp147 $const11 	%argrw{"wrr"}
	assign		$tmp149 $tmp148 	%argrw{"wr"}
	assign		$tmp146 $tmp149 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp146 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp150 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp150 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp145 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		$tmp151 $tmp145 Offset 	%line{258} %argrw{"wrr"}
	mul		$tmp152 $tmp151 ___501_pwr 	%argrw{"wrr"}
	mul		___504_increment $tmp152 ___501_value 	%argrw{"wrr"}
	mul		$tmp153 ___501_rmd ___504_increment 	%argrw{"wrr"}
	add		___501_value ___501_value $tmp153 	%argrw{"wrr"}
	assign		___608_value ___501_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:102
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:102
#                 noise_select(p + random_float_offset(1.0),
	add		$tmp158 ___608_p $tmp155 	%line{102} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	assign		___485_p $tmp158 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{251} %argrw{"wr"}
	assign		___485_value $const17 	%argrw{"wr"}
	assign		___485_pwr $const17 	%argrw{"wr"}
	for		$tmp162 333 336 350 352 	%argrw{"r"}
	assign		___486_i $const18 	%argrw{"wr"}
	assign		$tmp160 detail 	%argrw{"wr"}
	le		$tmp161 ___486_i $tmp160 	%argrw{"wrr"}
	neq		$tmp162 $tmp161 $const18 	%argrw{"wrr"}
	functioncall	$const9 345 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp165 ___485_p 	%line{61} %argrw{"wr"}
	ge		$tmp166 $tmp165 $const11 	%argrw{"wrr"}
	assign		$tmp167 $tmp166 	%argrw{"wr"}
	assign		$tmp164 $tmp167 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp164 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp168 ___485_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp168 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp163 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	mul		$tmp169 ___485_pwr $tmp163 	%line{251} %argrw{"wrr"}
	add		$tmp170 $tmp169 $const17 	%argrw{"wrr"}
	mul		___485_value ___485_value $tmp170 	%argrw{"wrr"}
	mul		___485_pwr ___485_pwr roughness 	%argrw{"wrr"}
	mul		___485_p ___485_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp171 ___486_i 	%argrw{"wr"}
	add		___486_i ___486_i $const19 	%argrw{"wrr"}
	floor		$tmp172 detail 	%argrw{"wr"}
	sub		___485_rmd detail $tmp172 	%argrw{"wrr"}
	neq		$tmp173 ___485_rmd $const1 	%argrw{"wrr"}
	if		$tmp173 369 369 	%argrw{"r"}
	mul		$tmp174 ___485_rmd ___485_pwr 	%argrw{"wrr"}
	functioncall	$const9 366 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp177 ___485_p 	%line{61} %argrw{"wr"}
	ge		$tmp178 $tmp177 $const11 	%argrw{"wrr"}
	assign		$tmp179 $tmp178 	%argrw{"wr"}
	assign		$tmp176 $tmp179 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp176 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp180 ___485_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp180 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp175 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	mul		$tmp181 $tmp174 $tmp175 	%line{251} %argrw{"wrr"}
	add		$tmp182 $tmp181 $const17 	%argrw{"wrr"}
	mul		___485_value ___485_value $tmp182 	%argrw{"wrr"}
	assign		$tmp154 ___485_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	assign		___465_p $tmp158 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{244} %argrw{"wr"}
	assign		___465_fscale $const17 	%argrw{"wr"}
	assign		___465_amp $const17 	%argrw{"wr"}
	assign		___465_maxamp $const1 	%argrw{"wr"}
	assign		___465_sum $const1 	%argrw{"wr"}
	...
	le		$tmp185 ___466_i $tmp184 	%argrw{"wrr"}
	neq		$tmp186 $tmp185 $const18 	%argrw{"wrr"}
	mul		$tmp187 ___465_fscale ___465_p 	%argrw{"wrr"}
...
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	...
	mul		___461_precision_correction $const10 $tmp188 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp192 $tmp187 $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp192 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		___467_t $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	mul		$tmp193 ___467_t ___465_amp 	%line{244} %argrw{"wrr"}
	add		___465_sum ___465_sum $tmp193 	%argrw{"wrr"}
	add		___465_maxamp ___465_maxamp ___465_amp 	%argrw{"wrr"}
	mul		___465_amp ___465_amp roughness 	%argrw{"wrr"}
	mul		___465_fscale ___465_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp194 ___466_i 	%argrw{"wr"}
	add		___466_i ___466_i $const19 	%argrw{"wrr"}
	floor		$tmp195 detail 	%argrw{"wr"}
	sub		___465_rmd detail $tmp195 	%argrw{"wrr"}
	neq		$tmp196 ___465_rmd $const1 	%argrw{"wrr"}
	if		$tmp196 428 434 	%argrw{"r"}
	mul		$tmp197 ___465_fscale ___465_p 	%argrw{"wrr"}
...
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	...
	mul		___461_precision_correction $const10 $tmp198 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp202 $tmp197 $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp202 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		___468_t $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	mul		$tmp203 ___468_t ___465_amp 	%line{244} %argrw{"wrr"}
	add		___468_sum2 ___465_sum $tmp203 	%argrw{"wrr"}
	if		use_normalize 426 427 	%argrw{"r"}
	mul		$tmp204 $const10 ___465_sum 	%argrw{"wrr"}
	div		$tmp205 $tmp204 ___465_maxamp 	%argrw{"wrr"}
	add		$tmp206 $tmp205 $const10 	%argrw{"wrr"}
	mul		$tmp207 $const10 ___468_sum2 	%argrw{"wrr"}
	add		$tmp208 ___465_maxamp ___465_amp 	%argrw{"wrr"}
	div		$tmp209 $tmp207 $tmp208 	%argrw{"wrr"}
	add		$tmp210 $tmp209 $const10 	%argrw{"wrr"}
	mix		$tmp154 $tmp206 $tmp210 ___465_rmd 	%argrw{"wrrr"}
	mix		$tmp154 ___465_sum ___468_sum2 ___465_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 432 433 	%argrw{"r"}
	mul		$tmp211 $const10 ___465_sum 	%argrw{"wrr"}
	div		$tmp212 $tmp211 ___465_maxamp 	%argrw{"wrr"}
	add		$tmp154 $tmp212 $const10 	%argrw{"wrr"}
	assign		$tmp154 ___465_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	assign		___517_p $tmp158 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{265} %argrw{"wr"}
	assign		___517_pwr $const17 	%argrw{"wr"}
	assign		___517_value $const1 	%argrw{"wr"}
	assign		___517_weight $const17 	%argrw{"wr"}
	for		$tmp219 444 452 472 474 	%argrw{"r"}
	assign		___518_i $const18 	%argrw{"wr"}
	gt		$tmp214 ___517_weight $const24 	%argrw{"wrr"}
	neq		$tmp215 $tmp214 $const18 	%argrw{"wrr"}
	if		$tmp215 451 451 	%argrw{"r"}
	assign		$tmp216 detail 	%argrw{"wr"}
	le		$tmp217 ___518_i $tmp216 	%argrw{"wrr"}
	neq		$tmp218 $tmp217 $const18 	%argrw{"wrr"}
	assign		$tmp215 $tmp218 	%argrw{"wr"}
	neq		$tmp219 $tmp215 $const18 	%argrw{"wrr"}
	gt		$tmp220 ___517_weight $const17 	%argrw{"wrr"}
	if		$tmp220 455 455 	%argrw{"r"}
	assign		___517_weight $const17 	%argrw{"wr"}
	functioncall	$const9 464 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp223 ___517_p 	%line{61} %argrw{"wr"}
	ge		$tmp224 $tmp223 $const11 	%argrw{"wrr"}
	assign		$tmp225 $tmp224 	%argrw{"wr"}
	assign		$tmp222 $tmp225 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp222 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp226 ___517_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp226 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp221 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	add		$tmp227 $tmp221 Offset 	%line{265} %argrw{"wrr"}
	mul		___519_signal $tmp227 ___517_pwr 	%argrw{"wrr"}
	mul		___517_pwr ___517_pwr roughness 	%argrw{"wrr"}
	mul		$tmp228 ___517_weight ___519_signal 	%argrw{"wrr"}
	add		___517_value ___517_value $tmp228 	%argrw{"wrr"}
	mul		$tmp229 Gain ___519_signal 	%argrw{"wrr"}
	mul		___517_weight ___517_weight $tmp229 	%argrw{"wrr"}
	mul		___517_p ___517_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp230 ___518_i 	%argrw{"wr"}
	add		___518_i ___518_i $const19 	%argrw{"wrr"}
	floor		$tmp231 detail 	%argrw{"wr"}
	sub		___517_rmd detail $tmp231 	%argrw{"wrr"}
	neq		$tmp232 ___517_rmd $const1 	%argrw{"wrr"}
	neq		$tmp233 $tmp232 $const18 	%argrw{"wrr"}
	if		$tmp233 482 482 	%argrw{"r"}
	gt		$tmp234 ___517_weight $const24 	%argrw{"wrr"}
	neq		$tmp235 $tmp234 $const18 	%argrw{"wrr"}
	assign		$tmp233 $tmp235 	%argrw{"wr"}
	if		$tmp233 500 500 	%argrw{"r"}
	gt		$tmp236 ___517_weight $const17 	%argrw{"wrr"}
	if		$tmp236 486 486 	%argrw{"r"}
	assign		___517_weight $const17 	%argrw{"wr"}
	functioncall	$const9 495 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp239 ___517_p 	%line{61} %argrw{"wr"}
	ge		$tmp240 $tmp239 $const11 	%argrw{"wrr"}
	assign		$tmp241 $tmp240 	%argrw{"wr"}
	assign		$tmp238 $tmp241 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp238 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp242 ___517_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp242 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp237 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	add		$tmp243 $tmp237 Offset 	%line{265} %argrw{"wrr"}
	mul		___521_signal $tmp243 ___517_pwr 	%argrw{"wrr"}
	mul		$tmp244 ___517_rmd ___517_weight 	%argrw{"wrr"}
	mul		$tmp245 $tmp244 ___521_signal 	%argrw{"wrr"}
	add		___517_value ___517_value $tmp245 	%argrw{"wrr"}
	assign		$tmp154 ___517_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	assign		___541_p $tmp158 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{272} %argrw{"wr"}
	assign		___541_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 516 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp250 ___541_p 	%line{61} %argrw{"wr"}
	ge		$tmp251 $tmp250 $const11 	%argrw{"wrr"}
	assign		$tmp252 $tmp251 	%argrw{"wr"}
	assign		$tmp249 $tmp252 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp249 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp253 ___541_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp253 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp248 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	fabs		$tmp247 $tmp248 	%line{272} %argrw{"wr"}
	sub		___541_signal Offset $tmp247 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_signal 	%argrw{"wrr"}
	assign		___541_value ___541_signal 	%argrw{"wr"}
	assign		___541_weight $const17 	%argrw{"wr"}
	...
	le		$tmp255 ___542_i $tmp254 	%argrw{"wrr"}
	neq		$tmp256 $tmp255 $const18 	%argrw{"wrr"}
	mul		___541_p ___541_p Lacunarity 	%argrw{"wrr"}
	mul		$tmp257 ___541_signal Gain 	%argrw{"wrr"}
	functioncall	$const3 531 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp258 $tmp257 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___541_weight $tmp258 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	functioncall	$const9 540 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{272} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp262 ___541_p 	%line{61} %argrw{"wr"}
	ge		$tmp263 $tmp262 $const11 	%argrw{"wrr"}
	assign		$tmp264 $tmp263 	%argrw{"wr"}
	assign		$tmp261 $tmp264 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp261 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp265 ___541_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp265 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp260 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	fabs		$tmp259 $tmp260 	%line{272} %argrw{"wr"}
	sub		___541_signal Offset $tmp259 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_signal 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_weight 	%argrw{"wrr"}
	mul		$tmp266 ___541_signal ___541_pwr 	%argrw{"wrr"}
	add		___541_value ___541_value $tmp266 	%argrw{"wrr"}
	mul		___541_pwr ___541_pwr roughness 	%argrw{"wrr"}
	assign		$tmp267 ___542_i 	%argrw{"wr"}
	add		___542_i ___542_i $const19 	%argrw{"wrr"}
	assign		$tmp154 ___541_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	assign		___501_p $tmp158 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{258} %argrw{"wr"}
	assign		___501_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 565 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp271 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp272 $tmp271 $const11 	%argrw{"wrr"}
	assign		$tmp273 $tmp272 	%argrw{"wr"}
	assign		$tmp270 $tmp273 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp270 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp274 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp274 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp269 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		___501_value Offset $tmp269 	%line{258} %argrw{"wrr"}
	mul		___501_p ___501_p Lacunarity 	%argrw{"wrr"}
	for		$tmp277 569 572 587 589 	%argrw{"r"}
	assign		___502_i $const19 	%argrw{"wr"}
	assign		$tmp275 detail 	%argrw{"wr"}
	le		$tmp276 ___502_i $tmp275 	%argrw{"wrr"}
	neq		$tmp277 $tmp276 $const18 	%argrw{"wrr"}
	functioncall	$const9 581 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp280 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp281 $tmp280 $const11 	%argrw{"wrr"}
	assign		$tmp282 $tmp281 	%argrw{"wr"}
	assign		$tmp279 $tmp282 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp279 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp283 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp283 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp278 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		$tmp284 $tmp278 Offset 	%line{258} %argrw{"wrr"}
	mul		$tmp285 $tmp284 ___501_pwr 	%argrw{"wrr"}
	mul		___503_increment $tmp285 ___501_value 	%argrw{"wrr"}
	add		___501_value ___501_value ___503_increment 	%argrw{"wrr"}
	mul		___501_pwr ___501_pwr roughness 	%argrw{"wrr"}
	mul		___501_p ___501_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp286 ___502_i 	%argrw{"wr"}
	add		___502_i ___502_i $const19 	%argrw{"wrr"}
	floor		$tmp287 detail 	%argrw{"wr"}
	sub		___501_rmd detail $tmp287 	%argrw{"wrr"}
	neq		$tmp288 ___501_rmd $const1 	%argrw{"wrr"}
	if		$tmp288 607 607 	%argrw{"r"}
	functioncall	$const9 602 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp291 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp292 $tmp291 $const11 	%argrw{"wrr"}
	assign		$tmp293 $tmp292 	%argrw{"wr"}
	assign		$tmp290 $tmp293 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp290 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp294 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp294 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp289 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		$tmp295 $tmp289 Offset 	%line{258} %argrw{"wrr"}
	mul		$tmp296 $tmp295 ___501_pwr 	%argrw{"wrr"}
	mul		___504_increment $tmp296 ___501_value 	%argrw{"wrr"}
	mul		$tmp297 ___501_rmd ___504_increment 	%argrw{"wrr"}
	add		___501_value ___501_value $tmp297 	%argrw{"wrr"}
	assign		$tmp154 ___501_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:110
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:110
#                 noise_select(p + random_float_offset(2.0),
	add		$tmp302 ___608_p $tmp299 	%line{110} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	assign		___485_p $tmp302 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{251} %argrw{"wr"}
	assign		___485_value $const17 	%argrw{"wr"}
	assign		___485_pwr $const17 	%argrw{"wr"}
	for		$tmp306 626 629 643 645 	%argrw{"r"}
	assign		___486_i $const18 	%argrw{"wr"}
	assign		$tmp304 detail 	%argrw{"wr"}
	le		$tmp305 ___486_i $tmp304 	%argrw{"wrr"}
	neq		$tmp306 $tmp305 $const18 	%argrw{"wrr"}
	functioncall	$const9 638 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp309 ___485_p 	%line{61} %argrw{"wr"}
	ge		$tmp310 $tmp309 $const11 	%argrw{"wrr"}
	assign		$tmp311 $tmp310 	%argrw{"wr"}
	assign		$tmp308 $tmp311 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp308 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp312 ___485_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp312 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp307 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	mul		$tmp313 ___485_pwr $tmp307 	%line{251} %argrw{"wrr"}
	add		$tmp314 $tmp313 $const17 	%argrw{"wrr"}
	mul		___485_value ___485_value $tmp314 	%argrw{"wrr"}
	mul		___485_pwr ___485_pwr roughness 	%argrw{"wrr"}
	mul		___485_p ___485_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp315 ___486_i 	%argrw{"wr"}
	add		___486_i ___486_i $const19 	%argrw{"wrr"}
	floor		$tmp316 detail 	%argrw{"wr"}
	sub		___485_rmd detail $tmp316 	%argrw{"wrr"}
	neq		$tmp317 ___485_rmd $const1 	%argrw{"wrr"}
	if		$tmp317 662 662 	%argrw{"r"}
	mul		$tmp318 ___485_rmd ___485_pwr 	%argrw{"wrr"}
	functioncall	$const9 659 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp321 ___485_p 	%line{61} %argrw{"wr"}
	ge		$tmp322 $tmp321 $const11 	%argrw{"wrr"}
	assign		$tmp323 $tmp322 	%argrw{"wr"}
	assign		$tmp320 $tmp323 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp320 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp324 ___485_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp324 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp319 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:251
# NOISE_MULTI_FRACTAL(float)
	mul		$tmp325 $tmp318 $tmp319 	%line{251} %argrw{"wrr"}
	add		$tmp326 $tmp325 $const17 	%argrw{"wrr"}
	mul		___485_value ___485_value $tmp326 	%argrw{"wrr"}
	assign		$tmp298 ___485_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	assign		___465_p $tmp302 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{244} %argrw{"wr"}
	assign		___465_fscale $const17 	%argrw{"wr"}
	assign		___465_amp $const17 	%argrw{"wr"}
	assign		___465_maxamp $const1 	%argrw{"wr"}
	assign		___465_sum $const1 	%argrw{"wr"}
	...
	le		$tmp329 ___466_i $tmp328 	%argrw{"wrr"}
	neq		$tmp330 $tmp329 $const18 	%argrw{"wrr"}
	mul		$tmp331 ___465_fscale ___465_p 	%argrw{"wrr"}
...
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	...
	mul		___461_precision_correction $const10 $tmp332 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp336 $tmp331 $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp336 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		___467_t $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	mul		$tmp337 ___467_t ___465_amp 	%line{244} %argrw{"wrr"}
	add		___465_sum ___465_sum $tmp337 	%argrw{"wrr"}
	add		___465_maxamp ___465_maxamp ___465_amp 	%argrw{"wrr"}
	mul		___465_amp ___465_amp roughness 	%argrw{"wrr"}
	mul		___465_fscale ___465_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp338 ___466_i 	%argrw{"wr"}
	add		___466_i ___466_i $const19 	%argrw{"wrr"}
	floor		$tmp339 detail 	%argrw{"wr"}
	sub		___465_rmd detail $tmp339 	%argrw{"wrr"}
	neq		$tmp340 ___465_rmd $const1 	%argrw{"wrr"}
	if		$tmp340 721 727 	%argrw{"r"}
	mul		$tmp341 ___465_fscale ___465_p 	%argrw{"wrr"}
...
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	...
	mul		___461_precision_correction $const10 $tmp342 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp346 $tmp341 $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp346 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		___468_t $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:244
# NOISE_FBM(float)
	mul		$tmp347 ___468_t ___465_amp 	%line{244} %argrw{"wrr"}
	add		___468_sum2 ___465_sum $tmp347 	%argrw{"wrr"}
	if		use_normalize 719 720 	%argrw{"r"}
	mul		$tmp348 $const10 ___465_sum 	%argrw{"wrr"}
	div		$tmp349 $tmp348 ___465_maxamp 	%argrw{"wrr"}
	add		$tmp350 $tmp349 $const10 	%argrw{"wrr"}
	mul		$tmp351 $const10 ___468_sum2 	%argrw{"wrr"}
	add		$tmp352 ___465_maxamp ___465_amp 	%argrw{"wrr"}
	div		$tmp353 $tmp351 $tmp352 	%argrw{"wrr"}
	add		$tmp354 $tmp353 $const10 	%argrw{"wrr"}
	mix		$tmp298 $tmp350 $tmp354 ___465_rmd 	%argrw{"wrrr"}
	mix		$tmp298 ___465_sum ___468_sum2 ___465_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 725 726 	%argrw{"r"}
	mul		$tmp355 $const10 ___465_sum 	%argrw{"wrr"}
	div		$tmp356 $tmp355 ___465_maxamp 	%argrw{"wrr"}
	add		$tmp298 $tmp356 $const10 	%argrw{"wrr"}
	assign		$tmp298 ___465_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	assign		___517_p $tmp302 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{265} %argrw{"wr"}
	assign		___517_pwr $const17 	%argrw{"wr"}
	assign		___517_value $const1 	%argrw{"wr"}
	assign		___517_weight $const17 	%argrw{"wr"}
	for		$tmp363 737 745 765 767 	%argrw{"r"}
	assign		___518_i $const18 	%argrw{"wr"}
	gt		$tmp358 ___517_weight $const24 	%argrw{"wrr"}
	neq		$tmp359 $tmp358 $const18 	%argrw{"wrr"}
	if		$tmp359 744 744 	%argrw{"r"}
	assign		$tmp360 detail 	%argrw{"wr"}
	le		$tmp361 ___518_i $tmp360 	%argrw{"wrr"}
	neq		$tmp362 $tmp361 $const18 	%argrw{"wrr"}
	assign		$tmp359 $tmp362 	%argrw{"wr"}
	neq		$tmp363 $tmp359 $const18 	%argrw{"wrr"}
	gt		$tmp364 ___517_weight $const17 	%argrw{"wrr"}
	if		$tmp364 748 748 	%argrw{"r"}
	assign		___517_weight $const17 	%argrw{"wr"}
	functioncall	$const9 757 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp367 ___517_p 	%line{61} %argrw{"wr"}
	ge		$tmp368 $tmp367 $const11 	%argrw{"wrr"}
	assign		$tmp369 $tmp368 	%argrw{"wr"}
	assign		$tmp366 $tmp369 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp366 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp370 ___517_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp370 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp365 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	add		$tmp371 $tmp365 Offset 	%line{265} %argrw{"wrr"}
	mul		___519_signal $tmp371 ___517_pwr 	%argrw{"wrr"}
	mul		___517_pwr ___517_pwr roughness 	%argrw{"wrr"}
	mul		$tmp372 ___517_weight ___519_signal 	%argrw{"wrr"}
	add		___517_value ___517_value $tmp372 	%argrw{"wrr"}
	mul		$tmp373 Gain ___519_signal 	%argrw{"wrr"}
	mul		___517_weight ___517_weight $tmp373 	%argrw{"wrr"}
	mul		___517_p ___517_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp374 ___518_i 	%argrw{"wr"}
	add		___518_i ___518_i $const19 	%argrw{"wrr"}
	floor		$tmp375 detail 	%argrw{"wr"}
	sub		___517_rmd detail $tmp375 	%argrw{"wrr"}
	neq		$tmp376 ___517_rmd $const1 	%argrw{"wrr"}
	neq		$tmp377 $tmp376 $const18 	%argrw{"wrr"}
	if		$tmp377 775 775 	%argrw{"r"}
	gt		$tmp378 ___517_weight $const24 	%argrw{"wrr"}
	neq		$tmp379 $tmp378 $const18 	%argrw{"wrr"}
	assign		$tmp377 $tmp379 	%argrw{"wr"}
	if		$tmp377 793 793 	%argrw{"r"}
	gt		$tmp380 ___517_weight $const17 	%argrw{"wrr"}
	if		$tmp380 779 779 	%argrw{"r"}
	assign		___517_weight $const17 	%argrw{"wr"}
	functioncall	$const9 788 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp383 ___517_p 	%line{61} %argrw{"wr"}
	ge		$tmp384 $tmp383 $const11 	%argrw{"wrr"}
	assign		$tmp385 $tmp384 	%argrw{"wr"}
	assign		$tmp382 $tmp385 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp382 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp386 ___517_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp386 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp381 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:265
# NOISE_HYBRID_MULTI_FRACTAL(float)
	add		$tmp387 $tmp381 Offset 	%line{265} %argrw{"wrr"}
	mul		___521_signal $tmp387 ___517_pwr 	%argrw{"wrr"}
	mul		$tmp388 ___517_rmd ___517_weight 	%argrw{"wrr"}
	mul		$tmp389 $tmp388 ___521_signal 	%argrw{"wrr"}
	add		___517_value ___517_value $tmp389 	%argrw{"wrr"}
	assign		$tmp298 ___517_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	assign		___541_p $tmp302 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{272} %argrw{"wr"}
	assign		___541_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 809 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp394 ___541_p 	%line{61} %argrw{"wr"}
	ge		$tmp395 $tmp394 $const11 	%argrw{"wrr"}
	assign		$tmp396 $tmp395 	%argrw{"wr"}
	assign		$tmp393 $tmp396 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp393 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp397 ___541_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp397 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp392 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	fabs		$tmp391 $tmp392 	%line{272} %argrw{"wr"}
	sub		___541_signal Offset $tmp391 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_signal 	%argrw{"wrr"}
	assign		___541_value ___541_signal 	%argrw{"wr"}
	assign		___541_weight $const17 	%argrw{"wr"}
	...
	le		$tmp399 ___542_i $tmp398 	%argrw{"wrr"}
	neq		$tmp400 $tmp399 $const18 	%argrw{"wrr"}
	mul		___541_p ___541_p Lacunarity 	%argrw{"wrr"}
	mul		$tmp401 ___541_signal Gain 	%argrw{"wrr"}
	functioncall	$const3 824 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp402 $tmp401 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___541_weight $tmp402 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	functioncall	$const9 833 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{272} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp406 ___541_p 	%line{61} %argrw{"wr"}
	ge		$tmp407 $tmp406 $const11 	%argrw{"wrr"}
	assign		$tmp408 $tmp407 	%argrw{"wr"}
	assign		$tmp405 $tmp408 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp405 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp409 ___541_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp409 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp404 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:272
# NOISE_RIDGED_MULTI_FRACTAL(float)
	fabs		$tmp403 $tmp404 	%line{272} %argrw{"wr"}
	sub		___541_signal Offset $tmp403 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_signal 	%argrw{"wrr"}
	mul		___541_signal ___541_signal ___541_weight 	%argrw{"wrr"}
	mul		$tmp410 ___541_signal ___541_pwr 	%argrw{"wrr"}
	add		___541_value ___541_value $tmp410 	%argrw{"wrr"}
	mul		___541_pwr ___541_pwr roughness 	%argrw{"wrr"}
	assign		$tmp411 ___542_i 	%argrw{"wr"}
	add		___542_i ___542_i $const19 	%argrw{"wrr"}
	assign		$tmp298 ___541_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	assign		___501_p $tmp302 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{258} %argrw{"wr"}
	assign		___501_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 858 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp415 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp416 $tmp415 $const11 	%argrw{"wrr"}
	assign		$tmp417 $tmp416 	%argrw{"wr"}
	assign		$tmp414 $tmp417 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp414 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp418 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp418 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp413 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		___501_value Offset $tmp413 	%line{258} %argrw{"wrr"}
	mul		___501_p ___501_p Lacunarity 	%argrw{"wrr"}
	for		$tmp421 862 865 880 882 	%argrw{"r"}
	assign		___502_i $const19 	%argrw{"wr"}
	assign		$tmp419 detail 	%argrw{"wr"}
	le		$tmp420 ___502_i $tmp419 	%argrw{"wrr"}
	neq		$tmp421 $tmp420 $const18 	%argrw{"wrr"}
	functioncall	$const9 874 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp424 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp425 $tmp424 $const11 	%argrw{"wrr"}
	assign		$tmp426 $tmp425 	%argrw{"wr"}
	assign		$tmp423 $tmp426 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp423 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp427 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp427 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp422 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		$tmp428 $tmp422 Offset 	%line{258} %argrw{"wrr"}
	mul		$tmp429 $tmp428 ___501_pwr 	%argrw{"wrr"}
	mul		___503_increment $tmp429 ___501_value 	%argrw{"wrr"}
	add		___501_value ___501_value ___503_increment 	%argrw{"wrr"}
	mul		___501_pwr ___501_pwr roughness 	%argrw{"wrr"}
	mul		___501_p ___501_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp430 ___502_i 	%argrw{"wr"}
	add		___502_i ___502_i $const19 	%argrw{"wrr"}
	floor		$tmp431 detail 	%argrw{"wr"}
	sub		___501_rmd detail $tmp431 	%argrw{"wrr"}
	neq		$tmp432 ___501_rmd $const1 	%argrw{"wrr"}
	if		$tmp432 900 900 	%argrw{"r"}
	functioncall	$const9 895 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:61
#   float precision_correction = 0.5 * float(fabs(co) >= 1000000.0);
	fabs		$tmp435 ___501_p 	%line{61} %argrw{"wr"}
	ge		$tmp436 $tmp435 $const11 	%argrw{"wrr"}
	assign		$tmp437 $tmp436 	%argrw{"wr"}
	assign		$tmp434 $tmp437 	%argrw{"wr"}
	mul		___461_precision_correction $const10 $tmp434 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:64
#   float p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp438 ___501_p $const12 	%line{64} %argrw{"wrr"}
	add		___461_p $tmp438 ___461_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:66
#   return noise("snoise", p);
	noise		$tmp433 $const13 ___461_p 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:258
# NOISE_HETERO_TERRAIN(float)
	add		$tmp439 $tmp433 Offset 	%line{258} %argrw{"wrr"}
	mul		$tmp440 $tmp439 ___501_pwr 	%argrw{"wrr"}
	mul		___504_increment $tmp440 ___501_value 	%argrw{"wrr"}
	mul		$tmp441 ___501_rmd ___504_increment 	%argrw{"wrr"}
	add		___501_value ___501_value $tmp441 	%argrw{"wrr"}
	assign		$tmp298 ___501_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:79
# NOISE_SELECT(float)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{79}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:101
#   Color = color(value,
	color		Color ___608_value $tmp154 $tmp298 	%line{101} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:118
#   return value;
	assign		Fac ___608_value 	%line{118} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:269
#   else if (dimensions == "2D") {
	eq		$tmp442 dimensions $const31 	%line{269} %argrw{"wrr"}
	if		$tmp442 2525 6483 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:270
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:132
#   vector2 p = co;
	assign		___610_p.x $tmp443.x 	%line{132} %argrw{"wr"}
	assign		___610_p.y $tmp443.y 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:133
#   if (distortion != 0.0) {
	neq		$tmp444 Distortion $const1 	%line{133} %argrw{"wrr"}
	if		$tmp444 991 991 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:134
#     p += vector2(safe_snoise(p + random_vector2_offset(0.0)) * distortion,
	functioncall	$const32 923 	%line{134} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:58
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:59
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 926 	%line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		$tmp447.x ___610_p.x $tmp448.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		$tmp447.y ___610_p.y $tmp448.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:134
#     p += vector2(safe_snoise(p + random_vector2_offset(0.0)) * distortion,
	functioncall	$const9 951 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{134} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp454 $tmp447.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{71} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 941 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp460.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp453.x $tmp460.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp453.y $tmp460.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 947 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp462.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp462.y $const12 	%argrw{"wr"}
	functioncall	$const35 947 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp461.x $tmp447.x $tmp462.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp461.y $tmp447.y $tmp462.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 950 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp461.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp461.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp446 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:134
#     p += vector2(safe_snoise(p + random_vector2_offset(0.0)) * distortion,
	mul		$tmp445.x $tmp446 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{134} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:135
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		$tmp464.x ___610_p.x $tmp465.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		$tmp464.y ___610_p.y $tmp465.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:135
#                  safe_snoise(p + random_vector2_offset(1.0)) * distortion);
	functioncall	$const9 987 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{135} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp471 $tmp464.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{71} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 977 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp477.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp470.x $tmp477.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp470.y $tmp477.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 983 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp479.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 986 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp478.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp478.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp463 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:135
#                  safe_snoise(p + random_vector2_offset(1.0)) * distortion);
	mul		$tmp445.y $tmp463 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{135} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 991 	%line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___610_p.x ___610_p.x $tmp445.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___610_p.y ___610_p.y $tmp445.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:138
#   float value = noise_select(p, detail, roughness, lacunarity, offset, gain, type, use_normalize);
	functioncall	$const14 1495 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{138} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
...
# NOISE_MULTI_FRACTAL(vector2)
	assign		___489_p.x ___610_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{252} %argrw{"wr"}
	assign		___489_p.y ___610_p.y 	%argrw{"wr"}
	assign		___489_value $const17 	%argrw{"wr"}
	assign		___489_pwr $const17 	%argrw{"wr"}
	for		$tmp483 1001 1004 1039 1041 	%argrw{"r"}
	assign		___490_i $const18 	%argrw{"wr"}
	assign		$tmp481 detail 	%argrw{"wr"}
	le		$tmp482 ___490_i $tmp481 	%argrw{"wrr"}
	neq		$tmp483 $tmp482 $const18 	%argrw{"wrr"}
	functioncall	$const9 1029 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp486 ___489_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp487 $tmp486 $const11 	%argrw{"wrr"}
	assign		$tmp488 $tmp487 	%argrw{"wr"}
	assign		$tmp485.x $tmp488 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp489 ___489_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp490 $tmp489 $const11 	%argrw{"wrr"}
	assign		$tmp491 $tmp490 	%argrw{"wr"}
	assign		$tmp485.y $tmp491 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1019 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp492.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp485.x $tmp492.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp485.y $tmp492.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1025 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp494.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp494.y $const12 	%argrw{"wr"}
	functioncall	$const35 1025 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp493.x ___489_p.x $tmp494.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp493.y ___489_p.y $tmp494.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1028 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp493.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp493.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp484 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	mul		$tmp495 ___489_pwr $tmp484 	%line{252} %argrw{"wrr"}
	add		$tmp496 $tmp495 $const17 	%argrw{"wrr"}
	mul		___489_value ___489_value $tmp496 	%argrw{"wrr"}
	mul		___489_pwr ___489_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1039 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp497.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___489_p.x ___489_p.x $tmp497.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___489_p.y ___489_p.y $tmp497.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	assign		$tmp498 ___490_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{252} %argrw{"wr"}
	add		___490_i ___490_i $const19 	%argrw{"wrr"}
	floor		$tmp499 detail 	%argrw{"wr"}
	sub		___489_rmd detail $tmp499 	%argrw{"wrr"}
	neq		$tmp500 ___489_rmd $const1 	%argrw{"wrr"}
	if		$tmp500 1074 1074 	%argrw{"r"}
	mul		$tmp501 ___489_rmd ___489_pwr 	%argrw{"wrr"}
	functioncall	$const9 1071 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp504 ___489_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp505 $tmp504 $const11 	%argrw{"wrr"}
	assign		$tmp506 $tmp505 	%argrw{"wr"}
	assign		$tmp503.x $tmp506 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp507 ___489_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp508 $tmp507 $const11 	%argrw{"wrr"}
	assign		$tmp509 $tmp508 	%argrw{"wr"}
	assign		$tmp503.y $tmp509 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1061 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp510.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp503.x $tmp510.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp503.y $tmp510.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1067 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp512.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp512.y $const12 	%argrw{"wr"}
	functioncall	$const35 1067 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp511.x ___489_p.x $tmp512.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp511.y ___489_p.y $tmp512.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1070 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp511.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp511.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp502 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	mul		$tmp513 $tmp501 $tmp502 	%line{252} %argrw{"wrr"}
	add		$tmp514 $tmp513 $const17 	%argrw{"wrr"}
	mul		___489_value ___489_value $tmp514 	%argrw{"wrr"}
	assign		___610_value ___489_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
	eq		$tmp515 type $const20 	%argrw{"wrr"}
	if		$tmp515 1183 1495 	%argrw{"r"}
	functioncall	$const21 1182 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	assign		___470_p.x ___610_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"wr"}
	assign		___470_p.y ___610_p.y 	%argrw{"wr"}
	assign		___470_fscale $const17 	%argrw{"wr"}
	assign		___470_amp $const17 	%argrw{"wr"}
	assign		___470_maxamp $const1 	%argrw{"wr"}
	assign		___470_sum $const1 	%argrw{"wr"}
	for		$tmp518 1087 1090 1126 1128 	%argrw{"r"}
	assign		___471_i $const18 	%argrw{"wr"}
	assign		$tmp516 detail 	%argrw{"wr"}
	le		$tmp517 ___471_i $tmp516 	%argrw{"wrr"}
	neq		$tmp518 $tmp517 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1096 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp520.x ___470_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp520.y ___470_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1096 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp519.x ___470_p.x $tmp520.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp519.y ___470_p.y $tmp520.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	functioncall	$const9 1121 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1111 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp528.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp521.x $tmp528.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp521.y $tmp528.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1117 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp530.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1120 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp529.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp529.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		___472_t $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	mul		$tmp531 ___472_t ___470_amp 	%line{245} %argrw{"wrr"}
	add		___470_sum ___470_sum $tmp531 	%argrw{"wrr"}
	add		___470_maxamp ___470_maxamp ___470_amp 	%argrw{"wrr"}
	mul		___470_amp ___470_amp roughness 	%argrw{"wrr"}
	mul		___470_fscale ___470_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp532 ___471_i 	%argrw{"wr"}
	add		___471_i ___471_i $const19 	%argrw{"wrr"}
	floor		$tmp533 detail 	%argrw{"wr"}
	sub		___470_rmd detail $tmp533 	%argrw{"wrr"}
	neq		$tmp534 ___470_rmd $const1 	%argrw{"wrr"}
	if		$tmp534 1176 1182 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1138 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp536.x ___470_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp536.y ___470_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1138 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp535.x ___470_p.x $tmp536.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp535.y ___470_p.y $tmp536.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	functioncall	$const9 1163 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1153 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp544.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp537.x $tmp544.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp537.y $tmp544.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1159 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp546.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1162 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp545.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp545.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		___473_t $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	mul		$tmp547 ___473_t ___470_amp 	%line{245} %argrw{"wrr"}
	add		___473_sum2 ___470_sum $tmp547 	%argrw{"wrr"}
	if		use_normalize 1174 1175 	%argrw{"r"}
	mul		$tmp548 $const10 ___470_sum 	%argrw{"wrr"}
	div		$tmp549 $tmp548 ___470_maxamp 	%argrw{"wrr"}
	add		$tmp550 $tmp549 $const10 	%argrw{"wrr"}
	mul		$tmp551 $const10 ___473_sum2 	%argrw{"wrr"}
	add		$tmp552 ___470_maxamp ___470_amp 	%argrw{"wrr"}
	div		$tmp553 $tmp551 $tmp552 	%argrw{"wrr"}
	add		$tmp554 $tmp553 $const10 	%argrw{"wrr"}
	mix		___610_value $tmp550 $tmp554 ___470_rmd 	%argrw{"wrrr"}
	mix		___610_value ___470_sum ___473_sum2 ___470_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 1180 1181 	%argrw{"r"}
	mul		$tmp555 $const10 ___470_sum 	%argrw{"wrr"}
	div		$tmp556 $tmp555 ___470_maxamp 	%argrw{"wrr"}
	add		___610_value $tmp556 $const10 	%argrw{"wrr"}
	assign		___610_value ___470_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	assign		___523_p.x ___610_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{266} %argrw{"wr"}
	assign		___523_p.y ___610_p.y 	%argrw{"wr"}
	assign		___523_pwr $const17 	%argrw{"wr"}
	assign		___523_value $const1 	%argrw{"wr"}
	assign		___523_weight $const17 	%argrw{"wr"}
	for		$tmp563 1193 1201 1242 1244 	%argrw{"r"}
	assign		___524_i $const18 	%argrw{"wr"}
	gt		$tmp558 ___523_weight $const24 	%argrw{"wrr"}
	neq		$tmp559 $tmp558 $const18 	%argrw{"wrr"}
	if		$tmp559 1200 1200 	%argrw{"r"}
	assign		$tmp560 detail 	%argrw{"wr"}
	le		$tmp561 ___524_i $tmp560 	%argrw{"wrr"}
	neq		$tmp562 $tmp561 $const18 	%argrw{"wrr"}
	assign		$tmp559 $tmp562 	%argrw{"wr"}
	neq		$tmp563 $tmp559 $const18 	%argrw{"wrr"}
	gt		$tmp564 ___523_weight $const17 	%argrw{"wrr"}
	if		$tmp564 1204 1204 	%argrw{"r"}
	assign		___523_weight $const17 	%argrw{"wr"}
	functioncall	$const9 1229 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp567 ___523_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp568 $tmp567 $const11 	%argrw{"wrr"}
	assign		$tmp569 $tmp568 	%argrw{"wr"}
	assign		$tmp566.x $tmp569 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp570 ___523_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp571 $tmp570 $const11 	%argrw{"wrr"}
	assign		$tmp572 $tmp571 	%argrw{"wr"}
	assign		$tmp566.y $tmp572 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1219 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp573.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp566.x $tmp573.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp566.y $tmp573.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1225 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp575.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp575.y $const12 	%argrw{"wr"}
	functioncall	$const35 1225 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp574.x ___523_p.x $tmp575.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp574.y ___523_p.y $tmp575.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1228 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp574.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp574.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp565 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	add		$tmp576 $tmp565 Offset 	%line{266} %argrw{"wrr"}
	mul		___525_signal $tmp576 ___523_pwr 	%argrw{"wrr"}
	mul		___523_pwr ___523_pwr roughness 	%argrw{"wrr"}
	mul		$tmp577 ___523_weight ___525_signal 	%argrw{"wrr"}
	add		___523_value ___523_value $tmp577 	%argrw{"wrr"}
	mul		$tmp578 Gain ___525_signal 	%argrw{"wrr"}
	mul		___523_weight ___523_weight $tmp578 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1242 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp579.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___523_p.x ___523_p.x $tmp579.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___523_p.y ___523_p.y $tmp579.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	assign		$tmp580 ___524_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{266} %argrw{"wr"}
	add		___524_i ___524_i $const19 	%argrw{"wrr"}
	floor		$tmp581 detail 	%argrw{"wr"}
	sub		___523_rmd detail $tmp581 	%argrw{"wrr"}
	neq		$tmp582 ___523_rmd $const1 	%argrw{"wrr"}
	neq		$tmp583 $tmp582 $const18 	%argrw{"wrr"}
	if		$tmp583 1252 1252 	%argrw{"r"}
	gt		$tmp584 ___523_weight $const24 	%argrw{"wrr"}
	neq		$tmp585 $tmp584 $const18 	%argrw{"wrr"}
	assign		$tmp583 $tmp585 	%argrw{"wr"}
	if		$tmp583 1286 1286 	%argrw{"r"}
	gt		$tmp586 ___523_weight $const17 	%argrw{"wrr"}
	if		$tmp586 1256 1256 	%argrw{"r"}
	assign		___523_weight $const17 	%argrw{"wr"}
	functioncall	$const9 1281 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp589 ___523_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp590 $tmp589 $const11 	%argrw{"wrr"}
	assign		$tmp591 $tmp590 	%argrw{"wr"}
	assign		$tmp588.x $tmp591 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp592 ___523_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp593 $tmp592 $const11 	%argrw{"wrr"}
	assign		$tmp594 $tmp593 	%argrw{"wr"}
	assign		$tmp588.y $tmp594 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1271 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp595.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp588.x $tmp595.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp588.y $tmp595.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1277 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp597.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp597.y $const12 	%argrw{"wr"}
	functioncall	$const35 1277 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp596.x ___523_p.x $tmp597.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp596.y ___523_p.y $tmp597.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1280 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp596.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp596.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp587 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	add		$tmp598 $tmp587 Offset 	%line{266} %argrw{"wrr"}
	mul		___527_signal $tmp598 ___523_pwr 	%argrw{"wrr"}
	mul		$tmp599 ___523_rmd ___523_weight 	%argrw{"wrr"}
	mul		$tmp600 $tmp599 ___527_signal 	%argrw{"wrr"}
	add		___523_value ___523_value $tmp600 	%argrw{"wrr"}
	assign		___610_value ___523_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	assign		___544_p.x ___610_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"wr"}
	assign		___544_p.y ___610_p.y 	%argrw{"wr"}
	assign		___544_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 1319 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp605 ___544_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp606 $tmp605 $const11 	%argrw{"wrr"}
	assign		$tmp607 $tmp606 	%argrw{"wr"}
	assign		$tmp604.x $tmp607 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp608 ___544_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp609 $tmp608 $const11 	%argrw{"wrr"}
	assign		$tmp610 $tmp609 	%argrw{"wr"}
	assign		$tmp604.y $tmp610 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1309 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp611.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp604.x $tmp611.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp604.y $tmp611.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1315 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp613.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp613.y $const12 	%argrw{"wr"}
	functioncall	$const35 1315 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp612.x ___544_p.x $tmp613.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp612.y ___544_p.y $tmp613.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1318 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp612.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp612.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp603 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	fabs		$tmp602 $tmp603 	%line{273} %argrw{"wr"}
	sub		___544_signal Offset $tmp602 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_signal 	%argrw{"wrr"}
	assign		___544_value ___544_signal 	%argrw{"wr"}
	assign		___544_weight $const17 	%argrw{"wr"}
	for		$tmp616 1326 1329 1371 1373 	%argrw{"r"}
	assign		___545_i $const19 	%argrw{"wr"}
	assign		$tmp614 detail 	%argrw{"wr"}
	le		$tmp615 ___545_i $tmp614 	%argrw{"wrr"}
	neq		$tmp616 $tmp615 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1335 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp617.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___544_p.x ___544_p.x $tmp617.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___544_p.y ___544_p.y $tmp617.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	mul		$tmp618 ___544_signal Gain 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"wrr"}
	functioncall	$const3 1339 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp619 $tmp618 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___544_weight $tmp619 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	functioncall	$const9 1364 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp623 ___544_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp624 $tmp623 $const11 	%argrw{"wrr"}
	assign		$tmp625 $tmp624 	%argrw{"wr"}
	assign		$tmp622.x $tmp625 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp626 ___544_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp627 $tmp626 $const11 	%argrw{"wrr"}
	assign		$tmp628 $tmp627 	%argrw{"wr"}
	assign		$tmp622.y $tmp628 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1354 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp629.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp622.x $tmp629.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp622.y $tmp629.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1360 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp631.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp631.y $const12 	%argrw{"wr"}
	functioncall	$const35 1360 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp630.x ___544_p.x $tmp631.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp630.y ___544_p.y $tmp631.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1363 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp630.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp630.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp621 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	fabs		$tmp620 $tmp621 	%line{273} %argrw{"wr"}
	sub		___544_signal Offset $tmp620 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_signal 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_weight 	%argrw{"wrr"}
	mul		$tmp632 ___544_signal ___544_pwr 	%argrw{"wrr"}
	add		___544_value ___544_value $tmp632 	%argrw{"wrr"}
	mul		___544_pwr ___544_pwr roughness 	%argrw{"wrr"}
	assign		$tmp633 ___545_i 	%argrw{"wr"}
	add		___545_i ___545_i $const19 	%argrw{"wrr"}
	assign		___610_value ___544_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# NOISE_HETERO_TERRAIN(vector2)
	assign		___505_p.x ___610_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"wr"}
	assign		___505_p.y ___610_p.y 	%argrw{"wr"}
	assign		___505_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 1406 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp637 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp638 $tmp637 $const11 	%argrw{"wrr"}
	assign		$tmp639 $tmp638 	%argrw{"wr"}
	assign		$tmp636.x $tmp639 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp640 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp641 $tmp640 $const11 	%argrw{"wrr"}
	assign		$tmp642 $tmp641 	%argrw{"wr"}
	assign		$tmp636.y $tmp642 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1396 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp643.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp636.x $tmp643.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp636.y $tmp643.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1402 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp645.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp645.y $const12 	%argrw{"wr"}
	functioncall	$const35 1402 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp644.x ___505_p.x $tmp645.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp644.y ___505_p.y $tmp645.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1405 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp644.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp644.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp635 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		___505_value Offset $tmp635 	%line{259} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1413 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp646.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___505_p.x ___505_p.x $tmp646.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___505_p.y ___505_p.y $tmp646.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	for		$tmp649 1415 1418 1454 1456 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"r"}
	assign		___506_i $const19 	%argrw{"wr"}
	assign		$tmp647 detail 	%argrw{"wr"}
	le		$tmp648 ___506_i $tmp647 	%argrw{"wrr"}
	neq		$tmp649 $tmp648 $const18 	%argrw{"wrr"}
	functioncall	$const9 1443 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp652 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp653 $tmp652 $const11 	%argrw{"wrr"}
	assign		$tmp654 $tmp653 	%argrw{"wr"}
	assign		$tmp651.x $tmp654 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp655 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp656 $tmp655 $const11 	%argrw{"wrr"}
	assign		$tmp657 $tmp656 	%argrw{"wr"}
	assign		$tmp651.y $tmp657 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1433 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp658.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp651.x $tmp658.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp651.y $tmp658.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1439 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp660.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp660.y $const12 	%argrw{"wr"}
	functioncall	$const35 1439 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp659.x ___505_p.x $tmp660.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp659.y ___505_p.y $tmp660.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1442 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp659.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp659.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp650 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		$tmp661 $tmp650 Offset 	%line{259} %argrw{"wrr"}
	mul		$tmp662 $tmp661 ___505_pwr 	%argrw{"wrr"}
	mul		___507_increment $tmp662 ___505_value 	%argrw{"wrr"}
	add		___505_value ___505_value ___507_increment 	%argrw{"wrr"}
	mul		___505_pwr ___505_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1454 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp663.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___505_p.x ___505_p.x $tmp663.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___505_p.y ___505_p.y $tmp663.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	assign		$tmp664 ___506_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"wr"}
	add		___506_i ___506_i $const19 	%argrw{"wrr"}
	floor		$tmp665 detail 	%argrw{"wr"}
	sub		___505_rmd detail $tmp665 	%argrw{"wrr"}
	neq		$tmp666 ___505_rmd $const1 	%argrw{"wrr"}
	if		$tmp666 1490 1490 	%argrw{"r"}
	functioncall	$const9 1485 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp669 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp670 $tmp669 $const11 	%argrw{"wrr"}
	assign		$tmp671 $tmp670 	%argrw{"wr"}
	assign		$tmp668.x $tmp671 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp672 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp673 $tmp672 $const11 	%argrw{"wrr"}
	assign		$tmp674 $tmp673 	%argrw{"wr"}
	assign		$tmp668.y $tmp674 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1475 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp675.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp668.x $tmp675.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp668.y $tmp675.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1481 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp677.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp677.y $const12 	%argrw{"wr"}
	functioncall	$const35 1481 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp676.x ___505_p.x $tmp677.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp676.y ___505_p.y $tmp677.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1484 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp676.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp676.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp667 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		$tmp678 $tmp667 Offset 	%line{259} %argrw{"wrr"}
	mul		$tmp679 $tmp678 ___505_pwr 	%argrw{"wrr"}
	mul		___508_increment $tmp679 ___505_value 	%argrw{"wrr"}
	mul		$tmp680 ___505_rmd ___508_increment 	%argrw{"wrr"}
	add		___505_value ___505_value $tmp680 	%argrw{"wrr"}
	assign		___610_value ___505_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
	error		$const29 	%argrw{"r"}
	assign		___610_value $const1 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:140
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		$tmp682.x ___610_p.x $tmp683.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		$tmp682.y ___610_p.y $tmp683.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:140
#                 noise_select(p + random_vector2_offset(2.0),
	functioncall	$const14 2009 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{140} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	assign		___489_p.x $tmp682.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{252} %argrw{"wr"}
	assign		___489_p.y $tmp682.y 	%argrw{"wr"}
	assign		___489_value $const17 	%argrw{"wr"}
	assign		___489_pwr $const17 	%argrw{"wr"}
	for		$tmp691 1515 1518 1553 1555 	%argrw{"r"}
	assign		___490_i $const18 	%argrw{"wr"}
	assign		$tmp689 detail 	%argrw{"wr"}
	le		$tmp690 ___490_i $tmp689 	%argrw{"wrr"}
	neq		$tmp691 $tmp690 $const18 	%argrw{"wrr"}
	functioncall	$const9 1543 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp694 ___489_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp695 $tmp694 $const11 	%argrw{"wrr"}
	assign		$tmp696 $tmp695 	%argrw{"wr"}
	assign		$tmp693.x $tmp696 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp697 ___489_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp698 $tmp697 $const11 	%argrw{"wrr"}
	assign		$tmp699 $tmp698 	%argrw{"wr"}
	assign		$tmp693.y $tmp699 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1533 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp700.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp693.x $tmp700.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp693.y $tmp700.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1539 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp702.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp702.y $const12 	%argrw{"wr"}
	functioncall	$const35 1539 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp701.x ___489_p.x $tmp702.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp701.y ___489_p.y $tmp702.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1542 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp701.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp701.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp692 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	mul		$tmp703 ___489_pwr $tmp692 	%line{252} %argrw{"wrr"}
	add		$tmp704 $tmp703 $const17 	%argrw{"wrr"}
	mul		___489_value ___489_value $tmp704 	%argrw{"wrr"}
	mul		___489_pwr ___489_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1553 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp705.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___489_p.x ___489_p.x $tmp705.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___489_p.y ___489_p.y $tmp705.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	assign		$tmp706 ___490_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{252} %argrw{"wr"}
	add		___490_i ___490_i $const19 	%argrw{"wrr"}
	floor		$tmp707 detail 	%argrw{"wr"}
	sub		___489_rmd detail $tmp707 	%argrw{"wrr"}
	neq		$tmp708 ___489_rmd $const1 	%argrw{"wrr"}
	if		$tmp708 1588 1588 	%argrw{"r"}
	mul		$tmp709 ___489_rmd ___489_pwr 	%argrw{"wrr"}
	functioncall	$const9 1585 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp712 ___489_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp713 $tmp712 $const11 	%argrw{"wrr"}
	assign		$tmp714 $tmp713 	%argrw{"wr"}
	assign		$tmp711.x $tmp714 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp715 ___489_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp716 $tmp715 $const11 	%argrw{"wrr"}
	assign		$tmp717 $tmp716 	%argrw{"wr"}
	assign		$tmp711.y $tmp717 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1575 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp718.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp711.x $tmp718.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp711.y $tmp718.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1581 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp720.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp720.y $const12 	%argrw{"wr"}
	functioncall	$const35 1581 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp719.x ___489_p.x $tmp720.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp719.y ___489_p.y $tmp720.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1584 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp719.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp719.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp710 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	mul		$tmp721 $tmp709 $tmp710 	%line{252} %argrw{"wrr"}
	add		$tmp722 $tmp721 $const17 	%argrw{"wrr"}
	mul		___489_value ___489_value $tmp722 	%argrw{"wrr"}
	assign		$tmp681 ___489_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	assign		___470_p.x $tmp682.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"wr"}
	assign		___470_p.y $tmp682.y 	%argrw{"wr"}
	assign		___470_fscale $const17 	%argrw{"wr"}
	assign		___470_amp $const17 	%argrw{"wr"}
	assign		___470_maxamp $const1 	%argrw{"wr"}
	assign		___470_sum $const1 	%argrw{"wr"}
	...
	le		$tmp725 ___471_i $tmp724 	%argrw{"wrr"}
	neq		$tmp726 $tmp725 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1610 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp728.x ___470_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp728.y ___470_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1610 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp727.x ___470_p.x $tmp728.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp727.y ___470_p.y $tmp728.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	functioncall	$const9 1635 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1625 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp736.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp729.x $tmp736.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp729.y $tmp736.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1631 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp738.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1634 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp737.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp737.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		___472_t $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	mul		$tmp739 ___472_t ___470_amp 	%line{245} %argrw{"wrr"}
	add		___470_sum ___470_sum $tmp739 	%argrw{"wrr"}
	add		___470_maxamp ___470_maxamp ___470_amp 	%argrw{"wrr"}
	mul		___470_amp ___470_amp roughness 	%argrw{"wrr"}
	mul		___470_fscale ___470_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp740 ___471_i 	%argrw{"wr"}
	add		___471_i ___471_i $const19 	%argrw{"wrr"}
	floor		$tmp741 detail 	%argrw{"wr"}
	sub		___470_rmd detail $tmp741 	%argrw{"wrr"}
	neq		$tmp742 ___470_rmd $const1 	%argrw{"wrr"}
	if		$tmp742 1690 1696 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1652 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp744.x ___470_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp744.y ___470_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1652 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp743.x ___470_p.x $tmp744.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp743.y ___470_p.y $tmp744.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	functioncall	$const9 1677 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1667 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp752.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp745.x $tmp752.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp745.y $tmp752.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1673 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp754.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1676 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp753.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp753.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		___473_t $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	mul		$tmp755 ___473_t ___470_amp 	%line{245} %argrw{"wrr"}
	add		___473_sum2 ___470_sum $tmp755 	%argrw{"wrr"}
	if		use_normalize 1688 1689 	%argrw{"r"}
	mul		$tmp756 $const10 ___470_sum 	%argrw{"wrr"}
	div		$tmp757 $tmp756 ___470_maxamp 	%argrw{"wrr"}
	add		$tmp758 $tmp757 $const10 	%argrw{"wrr"}
	mul		$tmp759 $const10 ___473_sum2 	%argrw{"wrr"}
	add		$tmp760 ___470_maxamp ___470_amp 	%argrw{"wrr"}
	div		$tmp761 $tmp759 $tmp760 	%argrw{"wrr"}
	add		$tmp762 $tmp761 $const10 	%argrw{"wrr"}
	mix		$tmp681 $tmp758 $tmp762 ___470_rmd 	%argrw{"wrrr"}
	mix		$tmp681 ___470_sum ___473_sum2 ___470_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 1694 1695 	%argrw{"r"}
	mul		$tmp763 $const10 ___470_sum 	%argrw{"wrr"}
	div		$tmp764 $tmp763 ___470_maxamp 	%argrw{"wrr"}
	add		$tmp681 $tmp764 $const10 	%argrw{"wrr"}
	assign		$tmp681 ___470_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	assign		___523_p.x $tmp682.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{266} %argrw{"wr"}
	assign		___523_p.y $tmp682.y 	%argrw{"wr"}
	assign		___523_pwr $const17 	%argrw{"wr"}
	assign		___523_value $const1 	%argrw{"wr"}
	assign		___523_weight $const17 	%argrw{"wr"}
	for		$tmp771 1707 1715 1756 1758 	%argrw{"r"}
	assign		___524_i $const18 	%argrw{"wr"}
	gt		$tmp766 ___523_weight $const24 	%argrw{"wrr"}
	neq		$tmp767 $tmp766 $const18 	%argrw{"wrr"}
	if		$tmp767 1714 1714 	%argrw{"r"}
	assign		$tmp768 detail 	%argrw{"wr"}
	le		$tmp769 ___524_i $tmp768 	%argrw{"wrr"}
	neq		$tmp770 $tmp769 $const18 	%argrw{"wrr"}
	assign		$tmp767 $tmp770 	%argrw{"wr"}
	neq		$tmp771 $tmp767 $const18 	%argrw{"wrr"}
	gt		$tmp772 ___523_weight $const17 	%argrw{"wrr"}
	if		$tmp772 1718 1718 	%argrw{"r"}
	assign		___523_weight $const17 	%argrw{"wr"}
	functioncall	$const9 1743 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp775 ___523_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp776 $tmp775 $const11 	%argrw{"wrr"}
	assign		$tmp777 $tmp776 	%argrw{"wr"}
	assign		$tmp774.x $tmp777 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp778 ___523_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp779 $tmp778 $const11 	%argrw{"wrr"}
	assign		$tmp780 $tmp779 	%argrw{"wr"}
	assign		$tmp774.y $tmp780 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1733 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp781.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp774.x $tmp781.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp774.y $tmp781.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1739 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp783.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp783.y $const12 	%argrw{"wr"}
	functioncall	$const35 1739 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp782.x ___523_p.x $tmp783.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp782.y ___523_p.y $tmp783.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1742 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp782.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp782.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp773 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	add		$tmp784 $tmp773 Offset 	%line{266} %argrw{"wrr"}
	mul		___525_signal $tmp784 ___523_pwr 	%argrw{"wrr"}
	mul		___523_pwr ___523_pwr roughness 	%argrw{"wrr"}
	mul		$tmp785 ___523_weight ___525_signal 	%argrw{"wrr"}
	add		___523_value ___523_value $tmp785 	%argrw{"wrr"}
	mul		$tmp786 Gain ___525_signal 	%argrw{"wrr"}
	mul		___523_weight ___523_weight $tmp786 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1756 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp787.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___523_p.x ___523_p.x $tmp787.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___523_p.y ___523_p.y $tmp787.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	assign		$tmp788 ___524_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{266} %argrw{"wr"}
	add		___524_i ___524_i $const19 	%argrw{"wrr"}
	floor		$tmp789 detail 	%argrw{"wr"}
	sub		___523_rmd detail $tmp789 	%argrw{"wrr"}
	neq		$tmp790 ___523_rmd $const1 	%argrw{"wrr"}
	neq		$tmp791 $tmp790 $const18 	%argrw{"wrr"}
	if		$tmp791 1766 1766 	%argrw{"r"}
	gt		$tmp792 ___523_weight $const24 	%argrw{"wrr"}
	neq		$tmp793 $tmp792 $const18 	%argrw{"wrr"}
	assign		$tmp791 $tmp793 	%argrw{"wr"}
	if		$tmp791 1800 1800 	%argrw{"r"}
	gt		$tmp794 ___523_weight $const17 	%argrw{"wrr"}
	if		$tmp794 1770 1770 	%argrw{"r"}
	assign		___523_weight $const17 	%argrw{"wr"}
	functioncall	$const9 1795 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp797 ___523_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp798 $tmp797 $const11 	%argrw{"wrr"}
	assign		$tmp799 $tmp798 	%argrw{"wr"}
	assign		$tmp796.x $tmp799 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp800 ___523_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp801 $tmp800 $const11 	%argrw{"wrr"}
	assign		$tmp802 $tmp801 	%argrw{"wr"}
	assign		$tmp796.y $tmp802 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1785 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp803.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp796.x $tmp803.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp796.y $tmp803.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1791 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp805.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp805.y $const12 	%argrw{"wr"}
	functioncall	$const35 1791 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp804.x ___523_p.x $tmp805.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp804.y ___523_p.y $tmp805.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1794 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp804.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp804.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp795 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	add		$tmp806 $tmp795 Offset 	%line{266} %argrw{"wrr"}
	mul		___527_signal $tmp806 ___523_pwr 	%argrw{"wrr"}
	mul		$tmp807 ___523_rmd ___523_weight 	%argrw{"wrr"}
	mul		$tmp808 $tmp807 ___527_signal 	%argrw{"wrr"}
	add		___523_value ___523_value $tmp808 	%argrw{"wrr"}
	assign		$tmp681 ___523_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	assign		___544_p.x $tmp682.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"wr"}
	assign		___544_p.y $tmp682.y 	%argrw{"wr"}
	assign		___544_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 1833 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp813 ___544_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp814 $tmp813 $const11 	%argrw{"wrr"}
	assign		$tmp815 $tmp814 	%argrw{"wr"}
	assign		$tmp812.x $tmp815 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp816 ___544_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp817 $tmp816 $const11 	%argrw{"wrr"}
	assign		$tmp818 $tmp817 	%argrw{"wr"}
	assign		$tmp812.y $tmp818 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1823 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp819.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp812.x $tmp819.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp812.y $tmp819.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1829 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp821.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp821.y $const12 	%argrw{"wr"}
	functioncall	$const35 1829 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp820.x ___544_p.x $tmp821.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp820.y ___544_p.y $tmp821.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1832 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp820.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp820.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp811 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	fabs		$tmp810 $tmp811 	%line{273} %argrw{"wr"}
	sub		___544_signal Offset $tmp810 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_signal 	%argrw{"wrr"}
	assign		___544_value ___544_signal 	%argrw{"wr"}
	assign		___544_weight $const17 	%argrw{"wr"}
	...
	le		$tmp823 ___545_i $tmp822 	%argrw{"wrr"}
	neq		$tmp824 $tmp823 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1849 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp825.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___544_p.x ___544_p.x $tmp825.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___544_p.y ___544_p.y $tmp825.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	mul		$tmp826 ___544_signal Gain 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"wrr"}
	functioncall	$const3 1853 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp827 $tmp826 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___544_weight $tmp827 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	functioncall	$const9 1878 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp831 ___544_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp832 $tmp831 $const11 	%argrw{"wrr"}
	assign		$tmp833 $tmp832 	%argrw{"wr"}
	assign		$tmp830.x $tmp833 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp834 ___544_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp835 $tmp834 $const11 	%argrw{"wrr"}
	assign		$tmp836 $tmp835 	%argrw{"wr"}
	assign		$tmp830.y $tmp836 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1868 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp837.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp830.x $tmp837.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp830.y $tmp837.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1874 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp839.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp839.y $const12 	%argrw{"wr"}
	functioncall	$const35 1874 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp838.x ___544_p.x $tmp839.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp838.y ___544_p.y $tmp839.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1877 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp838.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp838.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp829 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	fabs		$tmp828 $tmp829 	%line{273} %argrw{"wr"}
	sub		___544_signal Offset $tmp828 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_signal 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_weight 	%argrw{"wrr"}
	mul		$tmp840 ___544_signal ___544_pwr 	%argrw{"wrr"}
	add		___544_value ___544_value $tmp840 	%argrw{"wrr"}
	mul		___544_pwr ___544_pwr roughness 	%argrw{"wrr"}
	assign		$tmp841 ___545_i 	%argrw{"wr"}
	add		___545_i ___545_i $const19 	%argrw{"wrr"}
	assign		$tmp681 ___544_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	assign		___505_p.x $tmp682.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"wr"}
	assign		___505_p.y $tmp682.y 	%argrw{"wr"}
	assign		___505_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 1920 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp845 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp846 $tmp845 $const11 	%argrw{"wrr"}
	assign		$tmp847 $tmp846 	%argrw{"wr"}
	assign		$tmp844.x $tmp847 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp848 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp849 $tmp848 $const11 	%argrw{"wrr"}
	assign		$tmp850 $tmp849 	%argrw{"wr"}
	assign		$tmp844.y $tmp850 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1910 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp851.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp844.x $tmp851.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp844.y $tmp851.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1916 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp853.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp853.y $const12 	%argrw{"wr"}
	functioncall	$const35 1916 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp852.x ___505_p.x $tmp853.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp852.y ___505_p.y $tmp853.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1919 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp852.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp852.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp843 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		___505_value Offset $tmp843 	%line{259} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1927 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp854.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___505_p.x ___505_p.x $tmp854.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___505_p.y ___505_p.y $tmp854.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	for		$tmp857 1929 1932 1968 1970 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"r"}
	assign		___506_i $const19 	%argrw{"wr"}
	assign		$tmp855 detail 	%argrw{"wr"}
	le		$tmp856 ___506_i $tmp855 	%argrw{"wrr"}
	neq		$tmp857 $tmp856 $const18 	%argrw{"wrr"}
	functioncall	$const9 1957 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp860 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp861 $tmp860 $const11 	%argrw{"wrr"}
	assign		$tmp862 $tmp861 	%argrw{"wr"}
	assign		$tmp859.x $tmp862 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp863 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp864 $tmp863 $const11 	%argrw{"wrr"}
	assign		$tmp865 $tmp864 	%argrw{"wr"}
	assign		$tmp859.y $tmp865 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1947 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp866.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp859.x $tmp866.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp859.y $tmp866.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1953 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp868.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp868.y $const12 	%argrw{"wr"}
	functioncall	$const35 1953 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp867.x ___505_p.x $tmp868.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp867.y ___505_p.y $tmp868.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1956 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp867.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp867.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp858 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		$tmp869 $tmp858 Offset 	%line{259} %argrw{"wrr"}
	mul		$tmp870 $tmp869 ___505_pwr 	%argrw{"wrr"}
	mul		___507_increment $tmp870 ___505_value 	%argrw{"wrr"}
	add		___505_value ___505_value ___507_increment 	%argrw{"wrr"}
	mul		___505_pwr ___505_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1968 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp871.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___505_p.x ___505_p.x $tmp871.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___505_p.y ___505_p.y $tmp871.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	assign		$tmp872 ___506_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"wr"}
	add		___506_i ___506_i $const19 	%argrw{"wrr"}
	floor		$tmp873 detail 	%argrw{"wr"}
	sub		___505_rmd detail $tmp873 	%argrw{"wrr"}
	neq		$tmp874 ___505_rmd $const1 	%argrw{"wrr"}
	if		$tmp874 2004 2004 	%argrw{"r"}
	functioncall	$const9 1999 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp877 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp878 $tmp877 $const11 	%argrw{"wrr"}
	assign		$tmp879 $tmp878 	%argrw{"wr"}
	assign		$tmp876.x $tmp879 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp880 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp881 $tmp880 $const11 	%argrw{"wrr"}
	assign		$tmp882 $tmp881 	%argrw{"wr"}
	assign		$tmp876.y $tmp882 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 1989 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp883.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp876.x $tmp883.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp876.y $tmp883.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 1995 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp885.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp885.y $const12 	%argrw{"wr"}
	functioncall	$const35 1995 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp884.x ___505_p.x $tmp885.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp884.y ___505_p.y $tmp885.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 1998 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp884.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp884.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp875 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		$tmp886 $tmp875 Offset 	%line{259} %argrw{"wrr"}
	mul		$tmp887 $tmp886 ___505_pwr 	%argrw{"wrr"}
	mul		___508_increment $tmp887 ___505_value 	%argrw{"wrr"}
	mul		$tmp888 ___505_rmd ___508_increment 	%argrw{"wrr"}
	add		___505_value ___505_value $tmp888 	%argrw{"wrr"}
	assign		$tmp681 ___505_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:148
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		$tmp890.x ___610_p.x $tmp891.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		$tmp890.y ___610_p.y $tmp891.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:148
#                 noise_select(p + random_vector2_offset(3.0),
	functioncall	$const14 2523 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{148} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	assign		___489_p.x $tmp890.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{252} %argrw{"wr"}
	assign		___489_p.y $tmp890.y 	%argrw{"wr"}
	assign		___489_value $const17 	%argrw{"wr"}
	assign		___489_pwr $const17 	%argrw{"wr"}
	for		$tmp899 2029 2032 2067 2069 	%argrw{"r"}
	assign		___490_i $const18 	%argrw{"wr"}
	assign		$tmp897 detail 	%argrw{"wr"}
	le		$tmp898 ___490_i $tmp897 	%argrw{"wrr"}
	neq		$tmp899 $tmp898 $const18 	%argrw{"wrr"}
	functioncall	$const9 2057 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp902 ___489_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp903 $tmp902 $const11 	%argrw{"wrr"}
	assign		$tmp904 $tmp903 	%argrw{"wr"}
	assign		$tmp901.x $tmp904 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp905 ___489_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp906 $tmp905 $const11 	%argrw{"wrr"}
	assign		$tmp907 $tmp906 	%argrw{"wr"}
	assign		$tmp901.y $tmp907 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2047 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp908.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp901.x $tmp908.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp901.y $tmp908.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2053 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp910.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp910.y $const12 	%argrw{"wr"}
	functioncall	$const35 2053 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp909.x ___489_p.x $tmp910.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp909.y ___489_p.y $tmp910.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2056 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp909.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp909.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp900 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	mul		$tmp911 ___489_pwr $tmp900 	%line{252} %argrw{"wrr"}
	add		$tmp912 $tmp911 $const17 	%argrw{"wrr"}
	mul		___489_value ___489_value $tmp912 	%argrw{"wrr"}
	mul		___489_pwr ___489_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2067 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp913.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___489_p.x ___489_p.x $tmp913.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___489_p.y ___489_p.y $tmp913.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	assign		$tmp914 ___490_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{252} %argrw{"wr"}
	add		___490_i ___490_i $const19 	%argrw{"wrr"}
	floor		$tmp915 detail 	%argrw{"wr"}
	sub		___489_rmd detail $tmp915 	%argrw{"wrr"}
	neq		$tmp916 ___489_rmd $const1 	%argrw{"wrr"}
	if		$tmp916 2102 2102 	%argrw{"r"}
	mul		$tmp917 ___489_rmd ___489_pwr 	%argrw{"wrr"}
	functioncall	$const9 2099 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp920 ___489_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp921 $tmp920 $const11 	%argrw{"wrr"}
	assign		$tmp922 $tmp921 	%argrw{"wr"}
	assign		$tmp919.x $tmp922 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp923 ___489_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp924 $tmp923 $const11 	%argrw{"wrr"}
	assign		$tmp925 $tmp924 	%argrw{"wr"}
	assign		$tmp919.y $tmp925 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2089 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp926.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp919.x $tmp926.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp919.y $tmp926.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2095 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp928.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp928.y $const12 	%argrw{"wr"}
	functioncall	$const35 2095 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp927.x ___489_p.x $tmp928.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp927.y ___489_p.y $tmp928.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2098 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp927.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp927.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp918 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:252
# NOISE_MULTI_FRACTAL(vector2)
	mul		$tmp929 $tmp917 $tmp918 	%line{252} %argrw{"wrr"}
	add		$tmp930 $tmp929 $const17 	%argrw{"wrr"}
	mul		___489_value ___489_value $tmp930 	%argrw{"wrr"}
	assign		$tmp889 ___489_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	assign		___470_p.x $tmp890.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"wr"}
	assign		___470_p.y $tmp890.y 	%argrw{"wr"}
	assign		___470_fscale $const17 	%argrw{"wr"}
	assign		___470_amp $const17 	%argrw{"wr"}
	assign		___470_maxamp $const1 	%argrw{"wr"}
	assign		___470_sum $const1 	%argrw{"wr"}
	...
	le		$tmp933 ___471_i $tmp932 	%argrw{"wrr"}
	neq		$tmp934 $tmp933 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2124 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp936.x ___470_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp936.y ___470_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2124 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp935.x ___470_p.x $tmp936.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp935.y ___470_p.y $tmp936.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	functioncall	$const9 2149 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2139 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp944.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp937.x $tmp944.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp937.y $tmp944.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2145 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp946.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2148 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp945.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp945.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		___472_t $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	mul		$tmp947 ___472_t ___470_amp 	%line{245} %argrw{"wrr"}
	add		___470_sum ___470_sum $tmp947 	%argrw{"wrr"}
	add		___470_maxamp ___470_maxamp ___470_amp 	%argrw{"wrr"}
	mul		___470_amp ___470_amp roughness 	%argrw{"wrr"}
	mul		___470_fscale ___470_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp948 ___471_i 	%argrw{"wr"}
	add		___471_i ___471_i $const19 	%argrw{"wrr"}
	floor		$tmp949 detail 	%argrw{"wr"}
	sub		___470_rmd detail $tmp949 	%argrw{"wrr"}
	neq		$tmp950 ___470_rmd $const1 	%argrw{"wrr"}
	if		$tmp950 2204 2210 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2166 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp952.x ___470_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp952.y ___470_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2166 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp951.x ___470_p.x $tmp952.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp951.y ___470_p.y $tmp952.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	functioncall	$const9 2191 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{245} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2181 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp960.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp953.x $tmp960.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp953.y $tmp960.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2187 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp962.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2190 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp961.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp961.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		___473_t $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:245
# NOISE_FBM(vector2)
	mul		$tmp963 ___473_t ___470_amp 	%line{245} %argrw{"wrr"}
	add		___473_sum2 ___470_sum $tmp963 	%argrw{"wrr"}
	if		use_normalize 2202 2203 	%argrw{"r"}
	mul		$tmp964 $const10 ___470_sum 	%argrw{"wrr"}
	div		$tmp965 $tmp964 ___470_maxamp 	%argrw{"wrr"}
	add		$tmp966 $tmp965 $const10 	%argrw{"wrr"}
	mul		$tmp967 $const10 ___473_sum2 	%argrw{"wrr"}
	add		$tmp968 ___470_maxamp ___470_amp 	%argrw{"wrr"}
	div		$tmp969 $tmp967 $tmp968 	%argrw{"wrr"}
	add		$tmp970 $tmp969 $const10 	%argrw{"wrr"}
	mix		$tmp889 $tmp966 $tmp970 ___470_rmd 	%argrw{"wrrr"}
	mix		$tmp889 ___470_sum ___473_sum2 ___470_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 2208 2209 	%argrw{"r"}
	mul		$tmp971 $const10 ___470_sum 	%argrw{"wrr"}
	div		$tmp972 $tmp971 ___470_maxamp 	%argrw{"wrr"}
	add		$tmp889 $tmp972 $const10 	%argrw{"wrr"}
	assign		$tmp889 ___470_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	assign		___523_p.x $tmp890.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{266} %argrw{"wr"}
	assign		___523_p.y $tmp890.y 	%argrw{"wr"}
	assign		___523_pwr $const17 	%argrw{"wr"}
	assign		___523_value $const1 	%argrw{"wr"}
	assign		___523_weight $const17 	%argrw{"wr"}
	for		$tmp979 2221 2229 2270 2272 	%argrw{"r"}
	assign		___524_i $const18 	%argrw{"wr"}
	gt		$tmp974 ___523_weight $const24 	%argrw{"wrr"}
	neq		$tmp975 $tmp974 $const18 	%argrw{"wrr"}
	if		$tmp975 2228 2228 	%argrw{"r"}
	assign		$tmp976 detail 	%argrw{"wr"}
	le		$tmp977 ___524_i $tmp976 	%argrw{"wrr"}
	neq		$tmp978 $tmp977 $const18 	%argrw{"wrr"}
	assign		$tmp975 $tmp978 	%argrw{"wr"}
	neq		$tmp979 $tmp975 $const18 	%argrw{"wrr"}
	gt		$tmp980 ___523_weight $const17 	%argrw{"wrr"}
	if		$tmp980 2232 2232 	%argrw{"r"}
	assign		___523_weight $const17 	%argrw{"wr"}
	functioncall	$const9 2257 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp983 ___523_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp984 $tmp983 $const11 	%argrw{"wrr"}
	assign		$tmp985 $tmp984 	%argrw{"wr"}
	assign		$tmp982.x $tmp985 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp986 ___523_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp987 $tmp986 $const11 	%argrw{"wrr"}
	assign		$tmp988 $tmp987 	%argrw{"wr"}
	assign		$tmp982.y $tmp988 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2247 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp989.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp982.x $tmp989.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp982.y $tmp989.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2253 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp991.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp991.y $const12 	%argrw{"wr"}
	functioncall	$const35 2253 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp990.x ___523_p.x $tmp991.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp990.y ___523_p.y $tmp991.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2256 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp990.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp990.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp981 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	add		$tmp992 $tmp981 Offset 	%line{266} %argrw{"wrr"}
	mul		___525_signal $tmp992 ___523_pwr 	%argrw{"wrr"}
	mul		___523_pwr ___523_pwr roughness 	%argrw{"wrr"}
	mul		$tmp993 ___523_weight ___525_signal 	%argrw{"wrr"}
	add		___523_value ___523_value $tmp993 	%argrw{"wrr"}
	mul		$tmp994 Gain ___525_signal 	%argrw{"wrr"}
	mul		___523_weight ___523_weight $tmp994 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2270 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp995.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___523_p.x ___523_p.x $tmp995.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___523_p.y ___523_p.y $tmp995.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	assign		$tmp996 ___524_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{266} %argrw{"wr"}
	add		___524_i ___524_i $const19 	%argrw{"wrr"}
	floor		$tmp997 detail 	%argrw{"wr"}
	sub		___523_rmd detail $tmp997 	%argrw{"wrr"}
	neq		$tmp998 ___523_rmd $const1 	%argrw{"wrr"}
	neq		$tmp999 $tmp998 $const18 	%argrw{"wrr"}
	if		$tmp999 2280 2280 	%argrw{"r"}
	gt		$tmp1000 ___523_weight $const24 	%argrw{"wrr"}
	neq		$tmp1001 $tmp1000 $const18 	%argrw{"wrr"}
	assign		$tmp999 $tmp1001 	%argrw{"wr"}
	if		$tmp999 2314 2314 	%argrw{"r"}
	gt		$tmp1002 ___523_weight $const17 	%argrw{"wrr"}
	if		$tmp1002 2284 2284 	%argrw{"r"}
	assign		___523_weight $const17 	%argrw{"wr"}
	functioncall	$const9 2309 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp1005 ___523_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp1006 $tmp1005 $const11 	%argrw{"wrr"}
	assign		$tmp1007 $tmp1006 	%argrw{"wr"}
	assign		$tmp1004.x $tmp1007 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp1008 ___523_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp1009 $tmp1008 $const11 	%argrw{"wrr"}
	assign		$tmp1010 $tmp1009 	%argrw{"wr"}
	assign		$tmp1004.y $tmp1010 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2299 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp1011.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp1004.x $tmp1011.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp1004.y $tmp1011.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2305 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp1013.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp1013.y $const12 	%argrw{"wr"}
	functioncall	$const35 2305 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp1012.x ___523_p.x $tmp1013.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp1012.y ___523_p.y $tmp1013.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2308 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp1012.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp1012.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp1003 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:266
# NOISE_HYBRID_MULTI_FRACTAL(vector2)
	add		$tmp1014 $tmp1003 Offset 	%line{266} %argrw{"wrr"}
	mul		___527_signal $tmp1014 ___523_pwr 	%argrw{"wrr"}
	mul		$tmp1015 ___523_rmd ___523_weight 	%argrw{"wrr"}
	mul		$tmp1016 $tmp1015 ___527_signal 	%argrw{"wrr"}
	add		___523_value ___523_value $tmp1016 	%argrw{"wrr"}
	assign		$tmp889 ___523_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	assign		___544_p.x $tmp890.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"wr"}
	assign		___544_p.y $tmp890.y 	%argrw{"wr"}
	assign		___544_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 2347 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp1021 ___544_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp1022 $tmp1021 $const11 	%argrw{"wrr"}
	assign		$tmp1023 $tmp1022 	%argrw{"wr"}
	assign		$tmp1020.x $tmp1023 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp1024 ___544_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp1025 $tmp1024 $const11 	%argrw{"wrr"}
	assign		$tmp1026 $tmp1025 	%argrw{"wr"}
	assign		$tmp1020.y $tmp1026 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2337 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp1027.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp1020.x $tmp1027.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp1020.y $tmp1027.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2343 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp1029.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp1029.y $const12 	%argrw{"wr"}
	functioncall	$const35 2343 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp1028.x ___544_p.x $tmp1029.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp1028.y ___544_p.y $tmp1029.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2346 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp1028.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp1028.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp1019 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	fabs		$tmp1018 $tmp1019 	%line{273} %argrw{"wr"}
	sub		___544_signal Offset $tmp1018 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_signal 	%argrw{"wrr"}
	assign		___544_value ___544_signal 	%argrw{"wr"}
	assign		___544_weight $const17 	%argrw{"wr"}
	...
	le		$tmp1031 ___545_i $tmp1030 	%argrw{"wrr"}
	neq		$tmp1032 $tmp1031 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2363 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp1033.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___544_p.x ___544_p.x $tmp1033.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___544_p.y ___544_p.y $tmp1033.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	mul		$tmp1034 ___544_signal Gain 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"wrr"}
	functioncall	$const3 2367 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1035 $tmp1034 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___544_weight $tmp1035 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	functioncall	$const9 2392 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{273} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp1039 ___544_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp1040 $tmp1039 $const11 	%argrw{"wrr"}
	assign		$tmp1041 $tmp1040 	%argrw{"wr"}
	assign		$tmp1038.x $tmp1041 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp1042 ___544_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp1043 $tmp1042 $const11 	%argrw{"wrr"}
	assign		$tmp1044 $tmp1043 	%argrw{"wr"}
	assign		$tmp1038.y $tmp1044 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2382 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp1045.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp1038.x $tmp1045.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp1038.y $tmp1045.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2388 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp1047.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp1047.y $const12 	%argrw{"wr"}
	functioncall	$const35 2388 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp1046.x ___544_p.x $tmp1047.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp1046.y ___544_p.y $tmp1047.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2391 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp1046.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp1046.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp1037 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:273
# NOISE_RIDGED_MULTI_FRACTAL(vector2)
	fabs		$tmp1036 $tmp1037 	%line{273} %argrw{"wr"}
	sub		___544_signal Offset $tmp1036 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_signal 	%argrw{"wrr"}
	mul		___544_signal ___544_signal ___544_weight 	%argrw{"wrr"}
	mul		$tmp1048 ___544_signal ___544_pwr 	%argrw{"wrr"}
	add		___544_value ___544_value $tmp1048 	%argrw{"wrr"}
	mul		___544_pwr ___544_pwr roughness 	%argrw{"wrr"}
	assign		$tmp1049 ___545_i 	%argrw{"wr"}
	add		___545_i ___545_i $const19 	%argrw{"wrr"}
	assign		$tmp889 ___544_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	assign		___505_p.x $tmp890.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"wr"}
	assign		___505_p.y $tmp890.y 	%argrw{"wr"}
	assign		___505_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 2434 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp1053 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp1054 $tmp1053 $const11 	%argrw{"wrr"}
	assign		$tmp1055 $tmp1054 	%argrw{"wr"}
	assign		$tmp1052.x $tmp1055 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp1056 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp1057 $tmp1056 $const11 	%argrw{"wrr"}
	assign		$tmp1058 $tmp1057 	%argrw{"wr"}
	assign		$tmp1052.y $tmp1058 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2424 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp1059.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp1052.x $tmp1059.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp1052.y $tmp1059.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2430 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp1061.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp1061.y $const12 	%argrw{"wr"}
	functioncall	$const35 2430 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp1060.x ___505_p.x $tmp1061.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp1060.y ___505_p.y $tmp1061.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2433 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp1060.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp1060.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp1051 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		___505_value Offset $tmp1051 	%line{259} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2441 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp1062.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___505_p.x ___505_p.x $tmp1062.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___505_p.y ___505_p.y $tmp1062.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	for		$tmp1065 2443 2446 2482 2484 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"r"}
	assign		___506_i $const19 	%argrw{"wr"}
	assign		$tmp1063 detail 	%argrw{"wr"}
	le		$tmp1064 ___506_i $tmp1063 	%argrw{"wrr"}
	neq		$tmp1065 $tmp1064 $const18 	%argrw{"wrr"}
	functioncall	$const9 2471 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp1068 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp1069 $tmp1068 $const11 	%argrw{"wrr"}
	assign		$tmp1070 $tmp1069 	%argrw{"wr"}
	assign		$tmp1067.x $tmp1070 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp1071 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp1072 $tmp1071 $const11 	%argrw{"wrr"}
	assign		$tmp1073 $tmp1072 	%argrw{"wr"}
	assign		$tmp1067.y $tmp1073 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2461 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp1074.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp1067.x $tmp1074.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp1067.y $tmp1074.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2467 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp1076.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp1076.y $const12 	%argrw{"wr"}
	functioncall	$const35 2467 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp1075.x ___505_p.x $tmp1076.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp1075.y ___505_p.y $tmp1076.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2470 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp1075.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp1075.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp1066 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		$tmp1077 $tmp1066 Offset 	%line{259} %argrw{"wrr"}
	mul		$tmp1078 $tmp1077 ___505_pwr 	%argrw{"wrr"}
	mul		___507_increment $tmp1078 ___505_value 	%argrw{"wrr"}
	add		___505_value ___505_value ___507_increment 	%argrw{"wrr"}
	mul		___505_pwr ___505_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2482 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp1079.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___505_p.x ___505_p.x $tmp1079.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___505_p.y ___505_p.y $tmp1079.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	assign		$tmp1080 ___506_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{259} %argrw{"wr"}
	add		___506_i ___506_i $const19 	%argrw{"wrr"}
	floor		$tmp1081 detail 	%argrw{"wr"}
	sub		___505_rmd detail $tmp1081 	%argrw{"wrr"}
	neq		$tmp1082 ___505_rmd $const1 	%argrw{"wrr"}
	if		$tmp1082 2518 2518 	%argrw{"r"}
	functioncall	$const9 2513 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:71
#   vector2 precision_correction = 0.5 * vector2(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp1085 ___505_p.x 	%line{71} %argrw{"wr"}
	ge		$tmp1086 $tmp1085 $const11 	%argrw{"wrr"}
	assign		$tmp1087 $tmp1086 	%argrw{"wr"}
	assign		$tmp1084.x $tmp1087 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:72
#                                                float(fabs(co.y) >= 1000000.0));
	fabs		$tmp1088 ___505_p.y 	%line{72} %argrw{"wr"}
	ge		$tmp1089 $tmp1088 $const11 	%argrw{"wrr"}
	assign		$tmp1090 $tmp1089 	%argrw{"wr"}
	assign		$tmp1084.y $tmp1090 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 2503 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp1091.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___462_precision_correction.x $tmp1084.x $tmp1091.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___462_precision_correction.y $tmp1084.y $tmp1091.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:76
#   vector2 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 2509 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{76} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:258
#     return fmod(a, vector2(b, b));
	assign		$tmp1093.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{258} %argrw{"wr"}
	assign		$tmp1093.y $const12 	%argrw{"wr"}
	functioncall	$const35 2509 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:252
#     return vector2 (fmod(a.x, b.x),
	fmod		$tmp1092.x ___505_p.x $tmp1093.x 	%line{252} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:253
#                     fmod(a.y, b.y));
	fmod		$tmp1092.y ___505_p.y $tmp1093.y 	%line{253} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 2512 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___462_p.x $tmp1092.x ___462_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___462_p.y $tmp1092.y ___462_precision_correction.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:78
#   return noise("snoise", p.x, p.y);
	noise		$tmp1083 $const13 ___462_p.x ___462_p.y 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{78} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:259
# NOISE_HETERO_TERRAIN(vector2)
	add		$tmp1094 $tmp1083 Offset 	%line{259} %argrw{"wrr"}
	mul		$tmp1095 $tmp1094 ___505_pwr 	%argrw{"wrr"}
	mul		___508_increment $tmp1095 ___505_value 	%argrw{"wrr"}
	mul		$tmp1096 ___505_rmd ___508_increment 	%argrw{"wrr"}
	add		___505_value ___505_value $tmp1096 	%argrw{"wrr"}
	assign		$tmp889 ___505_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:80
# NOISE_SELECT(vector2)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{80}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:139
#   Color = color(value,
	color		Color ___610_value $tmp681 $tmp889 	%line{139} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:156
#   return value;
	assign		Fac ___610_value 	%line{156} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:281
#   else if (dimensions == "3D") {
	eq		$tmp1097 dimensions $const37 	%line{281} %argrw{"wrr"}
	if		$tmp1097 3921 6483 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:282
#     Fac = noise_texture(
	functioncall	$const5 3921 	%line{282} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:170
#   vector3 p = co;
	assign		___612_p p 	%line{170} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:171
#   if (distortion != 0.0) {
	neq		$tmp1098 Distortion $const1 	%line{171} %argrw{"wrr"}
	if		$tmp1098 2635 2635 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:172
#     p += vector3(safe_snoise(p + random_vector3_offset(0.0)) * distortion,
	functioncall	$const38 2542 	%line{172} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:64
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:65
#                  100.0 + noise("hash", seed, 1.0) * 100.0,
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:66
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:172
#     p += vector3(safe_snoise(p + random_vector3_offset(0.0)) * distortion,
	add		$tmp1111 ___612_p $tmp1101 	%line{172} %argrw{"wrr"}
	functioncall	$const9 2564 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1115 $tmp1111 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{83} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1112 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1128 $tmp1111 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1128 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1100 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:172
#     p += vector3(safe_snoise(p + random_vector3_offset(0.0)) * distortion,
	mul		$tmp1129 $tmp1100 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{172} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:173
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:173
#                  safe_snoise(p + random_vector3_offset(1.0)) * distortion,
	add		$tmp1141 ___612_p $tmp1131 	%line{173} %argrw{"wrr"}
	functioncall	$const9 2598 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1145 $tmp1141 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{83} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1142 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1158 $tmp1141 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1158 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1130 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:173
#                  safe_snoise(p + random_vector3_offset(1.0)) * distortion,
	mul		$tmp1159 $tmp1130 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{173} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:174
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:174
#                  safe_snoise(p + random_vector3_offset(2.0)) * distortion);
	add		$tmp1171 ___612_p $tmp1161 	%line{174} %argrw{"wrr"}
	functioncall	$const9 2632 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1175 $tmp1171 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{83} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1172 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1188 $tmp1171 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1188 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1160 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:174
#                  safe_snoise(p + random_vector3_offset(2.0)) * distortion);
	mul		$tmp1189 $tmp1160 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{174} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:172
#     p += vector3(safe_snoise(p + random_vector3_offset(0.0)) * distortion,
	point		$tmp1099 $tmp1129 $tmp1159 $tmp1189 	%line{172} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:174
#                  safe_snoise(p + random_vector3_offset(2.0)) * distortion);
	add		___612_p ___612_p $tmp1099 	%line{174} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:177
#   float value = noise_select(p, detail, roughness, lacunarity, offset, gain, type, use_normalize);
	functioncall	$const14 3055 	%line{177} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
...
# NOISE_MULTI_FRACTAL(vector3)
	assign		___493_p ___612_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{253} %argrw{"wr"}
	assign		___493_value $const17 	%argrw{"wr"}
	assign		___493_pwr $const17 	%argrw{"wr"}
	for		$tmp1193 2644 2647 2673 2675 	%argrw{"r"}
	assign		___494_i $const18 	%argrw{"wr"}
	assign		$tmp1191 detail 	%argrw{"wr"}
	le		$tmp1192 ___494_i $tmp1191 	%argrw{"wrr"}
	neq		$tmp1193 $tmp1192 $const18 	%argrw{"wrr"}
	functioncall	$const9 2668 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1198 ___493_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1203 ___493_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1208 ___493_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1195 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1211 ___493_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1211 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1194 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	mul		$tmp1212 ___493_pwr $tmp1194 	%line{253} %argrw{"wrr"}
	add		$tmp1213 $tmp1212 $const17 	%argrw{"wrr"}
	mul		___493_value ___493_value $tmp1213 	%argrw{"wrr"}
	mul		___493_pwr ___493_pwr roughness 	%argrw{"wrr"}
	mul		___493_p ___493_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1214 ___494_i 	%argrw{"wr"}
	add		___494_i ___494_i $const19 	%argrw{"wrr"}
	floor		$tmp1215 detail 	%argrw{"wr"}
	sub		___493_rmd detail $tmp1215 	%argrw{"wrr"}
	neq		$tmp1216 ___493_rmd $const1 	%argrw{"wrr"}
	if		$tmp1216 2704 2704 	%argrw{"r"}
	mul		$tmp1217 ___493_rmd ___493_pwr 	%argrw{"wrr"}
	functioncall	$const9 2701 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1222 ___493_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1227 ___493_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1232 ___493_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1219 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1235 ___493_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1235 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1218 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	mul		$tmp1236 $tmp1217 $tmp1218 	%line{253} %argrw{"wrr"}
	add		$tmp1237 $tmp1236 $const17 	%argrw{"wrr"}
	mul		___493_value ___493_value $tmp1237 	%argrw{"wrr"}
	assign		___612_value ___493_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
	eq		$tmp1238 type $const20 	%argrw{"wrr"}
	if		$tmp1238 2794 3055 	%argrw{"r"}
	functioncall	$const21 2793 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	assign		___475_p ___612_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{246} %argrw{"wr"}
	assign		___475_fscale $const17 	%argrw{"wr"}
	assign		___475_amp $const17 	%argrw{"wr"}
	assign		___475_maxamp $const1 	%argrw{"wr"}
	assign		___475_sum $const1 	%argrw{"wr"}
	for		$tmp1241 2716 2719 2746 2748 	%argrw{"r"}
	assign		___476_i $const18 	%argrw{"wr"}
	assign		$tmp1239 detail 	%argrw{"wr"}
	le		$tmp1240 ___476_i $tmp1239 	%argrw{"wrr"}
	neq		$tmp1241 $tmp1240 $const18 	%argrw{"wrr"}
	mul		$tmp1242 ___475_fscale ___475_p 	%argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1243 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1259 $tmp1242 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1259 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		___477_t $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	mul		$tmp1260 ___477_t ___475_amp 	%line{246} %argrw{"wrr"}
	add		___475_sum ___475_sum $tmp1260 	%argrw{"wrr"}
	add		___475_maxamp ___475_maxamp ___475_amp 	%argrw{"wrr"}
	mul		___475_amp ___475_amp roughness 	%argrw{"wrr"}
	mul		___475_fscale ___475_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp1261 ___476_i 	%argrw{"wr"}
	add		___476_i ___476_i $const19 	%argrw{"wrr"}
	floor		$tmp1262 detail 	%argrw{"wr"}
	sub		___475_rmd detail $tmp1262 	%argrw{"wrr"}
	neq		$tmp1263 ___475_rmd $const1 	%argrw{"wrr"}
	if		$tmp1263 2787 2793 	%argrw{"r"}
	mul		$tmp1264 ___475_fscale ___475_p 	%argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1265 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1281 $tmp1264 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1281 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		___478_t $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	mul		$tmp1282 ___478_t ___475_amp 	%line{246} %argrw{"wrr"}
	add		___478_sum2 ___475_sum $tmp1282 	%argrw{"wrr"}
	if		use_normalize 2785 2786 	%argrw{"r"}
	mul		$tmp1283 $const10 ___475_sum 	%argrw{"wrr"}
	div		$tmp1284 $tmp1283 ___475_maxamp 	%argrw{"wrr"}
	add		$tmp1285 $tmp1284 $const10 	%argrw{"wrr"}
	mul		$tmp1286 $const10 ___478_sum2 	%argrw{"wrr"}
	add		$tmp1287 ___475_maxamp ___475_amp 	%argrw{"wrr"}
	div		$tmp1288 $tmp1286 $tmp1287 	%argrw{"wrr"}
	add		$tmp1289 $tmp1288 $const10 	%argrw{"wrr"}
	mix		___612_value $tmp1285 $tmp1289 ___475_rmd 	%argrw{"wrrr"}
	mix		___612_value ___475_sum ___478_sum2 ___475_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 2791 2792 	%argrw{"r"}
	mul		$tmp1290 $const10 ___475_sum 	%argrw{"wrr"}
	div		$tmp1291 $tmp1290 ___475_maxamp 	%argrw{"wrr"}
	add		___612_value $tmp1291 $const10 	%argrw{"wrr"}
	assign		___612_value ___475_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# NOISE_HYBRID_MULTI_FRACTAL(vector3)
	assign		___529_p ___612_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{267} %argrw{"wr"}
	assign		___529_pwr $const17 	%argrw{"wr"}
	assign		___529_value $const1 	%argrw{"wr"}
	assign		___529_weight $const17 	%argrw{"wr"}
	for		$tmp1298 2803 2811 2843 2845 	%argrw{"r"}
	assign		___530_i $const18 	%argrw{"wr"}
	gt		$tmp1293 ___529_weight $const24 	%argrw{"wrr"}
	neq		$tmp1294 $tmp1293 $const18 	%argrw{"wrr"}
	if		$tmp1294 2810 2810 	%argrw{"r"}
	assign		$tmp1295 detail 	%argrw{"wr"}
	le		$tmp1296 ___530_i $tmp1295 	%argrw{"wrr"}
	neq		$tmp1297 $tmp1296 $const18 	%argrw{"wrr"}
	assign		$tmp1294 $tmp1297 	%argrw{"wr"}
	neq		$tmp1298 $tmp1294 $const18 	%argrw{"wrr"}
	gt		$tmp1299 ___529_weight $const17 	%argrw{"wrr"}
	if		$tmp1299 2814 2814 	%argrw{"r"}
	assign		___529_weight $const17 	%argrw{"wr"}
	functioncall	$const9 2835 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1304 ___529_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1309 ___529_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1314 ___529_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1301 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1317 ___529_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1317 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1300 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:267
# NOISE_HYBRID_MULTI_FRACTAL(vector3)
	add		$tmp1318 $tmp1300 Offset 	%line{267} %argrw{"wrr"}
	mul		___531_signal $tmp1318 ___529_pwr 	%argrw{"wrr"}
	mul		___529_pwr ___529_pwr roughness 	%argrw{"wrr"}
	mul		$tmp1319 ___529_weight ___531_signal 	%argrw{"wrr"}
	add		___529_value ___529_value $tmp1319 	%argrw{"wrr"}
	mul		$tmp1320 Gain ___531_signal 	%argrw{"wrr"}
	mul		___529_weight ___529_weight $tmp1320 	%argrw{"wrr"}
	mul		___529_p ___529_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1321 ___530_i 	%argrw{"wr"}
	add		___530_i ___530_i $const19 	%argrw{"wrr"}
	floor		$tmp1322 detail 	%argrw{"wr"}
	sub		___529_rmd detail $tmp1322 	%argrw{"wrr"}
	neq		$tmp1323 ___529_rmd $const1 	%argrw{"wrr"}
	neq		$tmp1324 $tmp1323 $const18 	%argrw{"wrr"}
	if		$tmp1324 2853 2853 	%argrw{"r"}
	gt		$tmp1325 ___529_weight $const24 	%argrw{"wrr"}
	neq		$tmp1326 $tmp1325 $const18 	%argrw{"wrr"}
	assign		$tmp1324 $tmp1326 	%argrw{"wr"}
	if		$tmp1324 2883 2883 	%argrw{"r"}
	gt		$tmp1327 ___529_weight $const17 	%argrw{"wrr"}
	if		$tmp1327 2857 2857 	%argrw{"r"}
	assign		___529_weight $const17 	%argrw{"wr"}
	functioncall	$const9 2878 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1332 ___529_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1337 ___529_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1342 ___529_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1329 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1345 ___529_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1345 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1328 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:267
# NOISE_HYBRID_MULTI_FRACTAL(vector3)
	add		$tmp1346 $tmp1328 Offset 	%line{267} %argrw{"wrr"}
	mul		___533_signal $tmp1346 ___529_pwr 	%argrw{"wrr"}
	mul		$tmp1347 ___529_rmd ___529_weight 	%argrw{"wrr"}
	mul		$tmp1348 $tmp1347 ___533_signal 	%argrw{"wrr"}
	add		___529_value ___529_value $tmp1348 	%argrw{"wrr"}
	assign		___612_value ___529_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	assign		___547_p ___612_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{274} %argrw{"wr"}
	assign		___547_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 2911 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1355 ___547_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1360 ___547_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1365 ___547_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1352 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1368 ___547_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1368 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1351 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	fabs		$tmp1350 $tmp1351 	%line{274} %argrw{"wr"}
	sub		___547_signal Offset $tmp1350 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_signal 	%argrw{"wrr"}
	assign		___547_value ___547_signal 	%argrw{"wr"}
	assign		___547_weight $const17 	%argrw{"wr"}
	for		$tmp1371 2918 2921 2954 2956 	%argrw{"r"}
	assign		___548_i $const19 	%argrw{"wr"}
	assign		$tmp1369 detail 	%argrw{"wr"}
	le		$tmp1370 ___548_i $tmp1369 	%argrw{"wrr"}
	neq		$tmp1371 $tmp1370 $const18 	%argrw{"wrr"}
	mul		___547_p ___547_p Lacunarity 	%argrw{"wrr"}
	mul		$tmp1372 ___547_signal Gain 	%argrw{"wrr"}
	functioncall	$const3 2926 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1373 $tmp1372 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___547_weight $tmp1373 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	functioncall	$const9 2947 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{274} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1379 ___547_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1384 ___547_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1389 ___547_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1376 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1392 ___547_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1392 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1375 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	fabs		$tmp1374 $tmp1375 	%line{274} %argrw{"wr"}
	sub		___547_signal Offset $tmp1374 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_signal 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_weight 	%argrw{"wrr"}
	mul		$tmp1393 ___547_signal ___547_pwr 	%argrw{"wrr"}
	add		___547_value ___547_value $tmp1393 	%argrw{"wrr"}
	mul		___547_pwr ___547_pwr roughness 	%argrw{"wrr"}
	assign		$tmp1394 ___548_i 	%argrw{"wr"}
	add		___548_i ___548_i $const19 	%argrw{"wrr"}
	assign		___612_value ___547_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# NOISE_HETERO_TERRAIN(vector3)
	assign		___509_p ___612_p 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{260} %argrw{"wr"}
	assign		___509_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 2984 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1400 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1405 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1410 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1397 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1413 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1413 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1396 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		___509_value Offset $tmp1396 	%line{260} %argrw{"wrr"}
	mul		___509_p ___509_p Lacunarity 	%argrw{"wrr"}
	for		$tmp1416 2988 2991 3018 3020 	%argrw{"r"}
	assign		___510_i $const19 	%argrw{"wr"}
	assign		$tmp1414 detail 	%argrw{"wr"}
	le		$tmp1415 ___510_i $tmp1414 	%argrw{"wrr"}
	neq		$tmp1416 $tmp1415 $const18 	%argrw{"wrr"}
	functioncall	$const9 3012 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1421 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1426 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1431 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1418 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1434 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1434 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1417 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		$tmp1435 $tmp1417 Offset 	%line{260} %argrw{"wrr"}
	mul		$tmp1436 $tmp1435 ___509_pwr 	%argrw{"wrr"}
	mul		___511_increment $tmp1436 ___509_value 	%argrw{"wrr"}
	add		___509_value ___509_value ___511_increment 	%argrw{"wrr"}
	mul		___509_pwr ___509_pwr roughness 	%argrw{"wrr"}
	mul		___509_p ___509_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1437 ___510_i 	%argrw{"wr"}
	add		___510_i ___510_i $const19 	%argrw{"wrr"}
	floor		$tmp1438 detail 	%argrw{"wr"}
	sub		___509_rmd detail $tmp1438 	%argrw{"wrr"}
	neq		$tmp1439 ___509_rmd $const1 	%argrw{"wrr"}
	if		$tmp1439 3050 3050 	%argrw{"r"}
	functioncall	$const9 3045 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1444 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1449 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1454 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1441 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1457 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1457 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1440 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		$tmp1458 $tmp1440 Offset 	%line{260} %argrw{"wrr"}
	mul		$tmp1459 $tmp1458 ___509_pwr 	%argrw{"wrr"}
	mul		___512_increment $tmp1459 ___509_value 	%argrw{"wrr"}
	mul		$tmp1460 ___509_rmd ___512_increment 	%argrw{"wrr"}
	add		___509_value ___509_value $tmp1460 	%argrw{"wrr"}
	assign		___612_value ___509_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
	error		$const29 	%argrw{"r"}
	assign		___612_value $const1 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:179
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:179
#                 noise_select(p + random_vector3_offset(3.0),
	add		$tmp1472 ___612_p $tmp1462 	%line{179} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	assign		___493_p $tmp1472 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{253} %argrw{"wr"}
	assign		___493_value $const17 	%argrw{"wr"}
	assign		___493_pwr $const17 	%argrw{"wr"}
	for		$tmp1476 3076 3079 3105 3107 	%argrw{"r"}
	assign		___494_i $const18 	%argrw{"wr"}
	assign		$tmp1474 detail 	%argrw{"wr"}
	le		$tmp1475 ___494_i $tmp1474 	%argrw{"wrr"}
	neq		$tmp1476 $tmp1475 $const18 	%argrw{"wrr"}
	functioncall	$const9 3100 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1481 ___493_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1486 ___493_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1491 ___493_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1478 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1494 ___493_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1494 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1477 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	mul		$tmp1495 ___493_pwr $tmp1477 	%line{253} %argrw{"wrr"}
	add		$tmp1496 $tmp1495 $const17 	%argrw{"wrr"}
	mul		___493_value ___493_value $tmp1496 	%argrw{"wrr"}
	mul		___493_pwr ___493_pwr roughness 	%argrw{"wrr"}
	mul		___493_p ___493_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1497 ___494_i 	%argrw{"wr"}
	add		___494_i ___494_i $const19 	%argrw{"wrr"}
	floor		$tmp1498 detail 	%argrw{"wr"}
	sub		___493_rmd detail $tmp1498 	%argrw{"wrr"}
	neq		$tmp1499 ___493_rmd $const1 	%argrw{"wrr"}
	if		$tmp1499 3136 3136 	%argrw{"r"}
	mul		$tmp1500 ___493_rmd ___493_pwr 	%argrw{"wrr"}
	functioncall	$const9 3133 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1505 ___493_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1510 ___493_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1515 ___493_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1502 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1518 ___493_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1518 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1501 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	mul		$tmp1519 $tmp1500 $tmp1501 	%line{253} %argrw{"wrr"}
	add		$tmp1520 $tmp1519 $const17 	%argrw{"wrr"}
	mul		___493_value ___493_value $tmp1520 	%argrw{"wrr"}
	assign		$tmp1461 ___493_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	assign		___475_p $tmp1472 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{246} %argrw{"wr"}
	assign		___475_fscale $const17 	%argrw{"wr"}
	assign		___475_amp $const17 	%argrw{"wr"}
	assign		___475_maxamp $const1 	%argrw{"wr"}
	assign		___475_sum $const1 	%argrw{"wr"}
	...
	le		$tmp1523 ___476_i $tmp1522 	%argrw{"wrr"}
	neq		$tmp1524 $tmp1523 $const18 	%argrw{"wrr"}
	mul		$tmp1525 ___475_fscale ___475_p 	%argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1526 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1542 $tmp1525 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1542 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		___477_t $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	mul		$tmp1543 ___477_t ___475_amp 	%line{246} %argrw{"wrr"}
	add		___475_sum ___475_sum $tmp1543 	%argrw{"wrr"}
	add		___475_maxamp ___475_maxamp ___475_amp 	%argrw{"wrr"}
	mul		___475_amp ___475_amp roughness 	%argrw{"wrr"}
	mul		___475_fscale ___475_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp1544 ___476_i 	%argrw{"wr"}
	add		___476_i ___476_i $const19 	%argrw{"wrr"}
	floor		$tmp1545 detail 	%argrw{"wr"}
	sub		___475_rmd detail $tmp1545 	%argrw{"wrr"}
	neq		$tmp1546 ___475_rmd $const1 	%argrw{"wrr"}
	if		$tmp1546 3219 3225 	%argrw{"r"}
	mul		$tmp1547 ___475_fscale ___475_p 	%argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1548 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1564 $tmp1547 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1564 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		___478_t $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	mul		$tmp1565 ___478_t ___475_amp 	%line{246} %argrw{"wrr"}
	add		___478_sum2 ___475_sum $tmp1565 	%argrw{"wrr"}
	if		use_normalize 3217 3218 	%argrw{"r"}
	mul		$tmp1566 $const10 ___475_sum 	%argrw{"wrr"}
	div		$tmp1567 $tmp1566 ___475_maxamp 	%argrw{"wrr"}
	add		$tmp1568 $tmp1567 $const10 	%argrw{"wrr"}
	mul		$tmp1569 $const10 ___478_sum2 	%argrw{"wrr"}
	add		$tmp1570 ___475_maxamp ___475_amp 	%argrw{"wrr"}
	div		$tmp1571 $tmp1569 $tmp1570 	%argrw{"wrr"}
	add		$tmp1572 $tmp1571 $const10 	%argrw{"wrr"}
	mix		$tmp1461 $tmp1568 $tmp1572 ___475_rmd 	%argrw{"wrrr"}
	mix		$tmp1461 ___475_sum ___478_sum2 ___475_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 3223 3224 	%argrw{"r"}
	mul		$tmp1573 $const10 ___475_sum 	%argrw{"wrr"}
	div		$tmp1574 $tmp1573 ___475_maxamp 	%argrw{"wrr"}
	add		$tmp1461 $tmp1574 $const10 	%argrw{"wrr"}
	assign		$tmp1461 ___475_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1592 ___529_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1597 ___529_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1584 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1600 ___529_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1600 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1583 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:267
# NOISE_HYBRID_MULTI_FRACTAL(vector3)
	add		$tmp1601 $tmp1583 Offset 	%line{267} %argrw{"wrr"}
	mul		___531_signal $tmp1601 ___529_pwr 	%argrw{"wrr"}
	mul		___529_pwr ___529_pwr roughness 	%argrw{"wrr"}
	mul		$tmp1602 ___529_weight ___531_signal 	%argrw{"wrr"}
	add		___529_value ___529_value $tmp1602 	%argrw{"wrr"}
	mul		$tmp1603 Gain ___531_signal 	%argrw{"wrr"}
	mul		___529_weight ___529_weight $tmp1603 	%argrw{"wrr"}
	mul		___529_p ___529_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1604 ___530_i 	%argrw{"wr"}
	add		___530_i ___530_i $const19 	%argrw{"wrr"}
	floor		$tmp1605 detail 	%argrw{"wr"}
	sub		___529_rmd detail $tmp1605 	%argrw{"wrr"}
	neq		$tmp1606 ___529_rmd $const1 	%argrw{"wrr"}
	neq		$tmp1607 $tmp1606 $const18 	%argrw{"wrr"}
	if		$tmp1607 3285 3285 	%argrw{"r"}
	gt		$tmp1608 ___529_weight $const24 	%argrw{"wrr"}
	neq		$tmp1609 $tmp1608 $const18 	%argrw{"wrr"}
	assign		$tmp1607 $tmp1609 	%argrw{"wr"}
	if		$tmp1607 3315 3315 	%argrw{"r"}
	gt		$tmp1610 ___529_weight $const17 	%argrw{"wrr"}
	if		$tmp1610 3289 3289 	%argrw{"r"}
	assign		___529_weight $const17 	%argrw{"wr"}
	functioncall	$const9 3310 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1615 ___529_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1620 ___529_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1625 ___529_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1612 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1628 ___529_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1628 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1611 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:267
# NOISE_HYBRID_MULTI_FRACTAL(vector3)
	add		$tmp1629 $tmp1611 Offset 	%line{267} %argrw{"wrr"}
	mul		___533_signal $tmp1629 ___529_pwr 	%argrw{"wrr"}
	mul		$tmp1630 ___529_rmd ___529_weight 	%argrw{"wrr"}
	mul		$tmp1631 $tmp1630 ___533_signal 	%argrw{"wrr"}
	add		___529_value ___529_value $tmp1631 	%argrw{"wrr"}
	assign		$tmp1461 ___529_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	assign		___547_p $tmp1472 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{274} %argrw{"wr"}
	assign		___547_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 3343 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1638 ___547_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1643 ___547_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1648 ___547_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1635 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1651 ___547_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1651 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1634 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	fabs		$tmp1633 $tmp1634 	%line{274} %argrw{"wr"}
	sub		___547_signal Offset $tmp1633 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_signal 	%argrw{"wrr"}
	assign		___547_value ___547_signal 	%argrw{"wr"}
	assign		___547_weight $const17 	%argrw{"wr"}
	...
	le		$tmp1653 ___548_i $tmp1652 	%argrw{"wrr"}
	neq		$tmp1654 $tmp1653 $const18 	%argrw{"wrr"}
	mul		___547_p ___547_p Lacunarity 	%argrw{"wrr"}
	mul		$tmp1655 ___547_signal Gain 	%argrw{"wrr"}
	functioncall	$const3 3358 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1656 $tmp1655 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___547_weight $tmp1656 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	functioncall	$const9 3379 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{274} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1662 ___547_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1667 ___547_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1672 ___547_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1659 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1675 ___547_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1675 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1658 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	fabs		$tmp1657 $tmp1658 	%line{274} %argrw{"wr"}
	sub		___547_signal Offset $tmp1657 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_signal 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_weight 	%argrw{"wrr"}
	mul		$tmp1676 ___547_signal ___547_pwr 	%argrw{"wrr"}
	add		___547_value ___547_value $tmp1676 	%argrw{"wrr"}
	mul		___547_pwr ___547_pwr roughness 	%argrw{"wrr"}
	assign		$tmp1677 ___548_i 	%argrw{"wr"}
	add		___548_i ___548_i $const19 	%argrw{"wrr"}
	assign		$tmp1461 ___547_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	assign		___509_p $tmp1472 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{260} %argrw{"wr"}
	assign		___509_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 3416 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1683 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1688 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1693 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1680 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1696 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1696 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1679 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		___509_value Offset $tmp1679 	%line{260} %argrw{"wrr"}
	mul		___509_p ___509_p Lacunarity 	%argrw{"wrr"}
	for		$tmp1699 3420 3423 3450 3452 	%argrw{"r"}
	assign		___510_i $const19 	%argrw{"wr"}
	assign		$tmp1697 detail 	%argrw{"wr"}
	le		$tmp1698 ___510_i $tmp1697 	%argrw{"wrr"}
	neq		$tmp1699 $tmp1698 $const18 	%argrw{"wrr"}
	functioncall	$const9 3444 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1704 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1709 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1714 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1701 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1717 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1717 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1700 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		$tmp1718 $tmp1700 Offset 	%line{260} %argrw{"wrr"}
	mul		$tmp1719 $tmp1718 ___509_pwr 	%argrw{"wrr"}
	mul		___511_increment $tmp1719 ___509_value 	%argrw{"wrr"}
	add		___509_value ___509_value ___511_increment 	%argrw{"wrr"}
	mul		___509_pwr ___509_pwr roughness 	%argrw{"wrr"}
	mul		___509_p ___509_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1720 ___510_i 	%argrw{"wr"}
	add		___510_i ___510_i $const19 	%argrw{"wrr"}
	floor		$tmp1721 detail 	%argrw{"wr"}
	sub		___509_rmd detail $tmp1721 	%argrw{"wrr"}
	neq		$tmp1722 ___509_rmd $const1 	%argrw{"wrr"}
	if		$tmp1722 3482 3482 	%argrw{"r"}
	functioncall	$const9 3477 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1727 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1732 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1737 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1724 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1740 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1740 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1723 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		$tmp1741 $tmp1723 Offset 	%line{260} %argrw{"wrr"}
	mul		$tmp1742 $tmp1741 ___509_pwr 	%argrw{"wrr"}
	mul		___512_increment $tmp1742 ___509_value 	%argrw{"wrr"}
	mul		$tmp1743 ___509_rmd ___512_increment 	%argrw{"wrr"}
	add		___509_value ___509_value $tmp1743 	%argrw{"wrr"}
	assign		$tmp1461 ___509_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:187
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:187
#                 noise_select(p + random_vector3_offset(4.0),
	add		$tmp1755 ___612_p $tmp1745 	%line{187} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	assign		___493_p $tmp1755 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{253} %argrw{"wr"}
	assign		___493_value $const17 	%argrw{"wr"}
	assign		___493_pwr $const17 	%argrw{"wr"}
	for		$tmp1759 3508 3511 3537 3539 	%argrw{"r"}
	assign		___494_i $const18 	%argrw{"wr"}
	assign		$tmp1757 detail 	%argrw{"wr"}
	le		$tmp1758 ___494_i $tmp1757 	%argrw{"wrr"}
	neq		$tmp1759 $tmp1758 $const18 	%argrw{"wrr"}
	functioncall	$const9 3532 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1764 ___493_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1769 ___493_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1774 ___493_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1761 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1777 ___493_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1777 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1760 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	mul		$tmp1778 ___493_pwr $tmp1760 	%line{253} %argrw{"wrr"}
	add		$tmp1779 $tmp1778 $const17 	%argrw{"wrr"}
	mul		___493_value ___493_value $tmp1779 	%argrw{"wrr"}
	mul		___493_pwr ___493_pwr roughness 	%argrw{"wrr"}
	mul		___493_p ___493_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1780 ___494_i 	%argrw{"wr"}
	add		___494_i ___494_i $const19 	%argrw{"wrr"}
	floor		$tmp1781 detail 	%argrw{"wr"}
	sub		___493_rmd detail $tmp1781 	%argrw{"wrr"}
	neq		$tmp1782 ___493_rmd $const1 	%argrw{"wrr"}
	if		$tmp1782 3568 3568 	%argrw{"r"}
	mul		$tmp1783 ___493_rmd ___493_pwr 	%argrw{"wrr"}
	functioncall	$const9 3565 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1788 ___493_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1793 ___493_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1798 ___493_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1785 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1801 ___493_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1801 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1784 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:253
# NOISE_MULTI_FRACTAL(vector3)
	mul		$tmp1802 $tmp1783 $tmp1784 	%line{253} %argrw{"wrr"}
	add		$tmp1803 $tmp1802 $const17 	%argrw{"wrr"}
	mul		___493_value ___493_value $tmp1803 	%argrw{"wrr"}
	assign		$tmp1744 ___493_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	assign		___475_p $tmp1755 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{246} %argrw{"wr"}
	assign		___475_fscale $const17 	%argrw{"wr"}
	assign		___475_amp $const17 	%argrw{"wr"}
	assign		___475_maxamp $const1 	%argrw{"wr"}
	assign		___475_sum $const1 	%argrw{"wr"}
	...
	le		$tmp1806 ___476_i $tmp1805 	%argrw{"wrr"}
	neq		$tmp1807 $tmp1806 $const18 	%argrw{"wrr"}
	mul		$tmp1808 ___475_fscale ___475_p 	%argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1809 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1825 $tmp1808 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1825 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		___477_t $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	mul		$tmp1826 ___477_t ___475_amp 	%line{246} %argrw{"wrr"}
	add		___475_sum ___475_sum $tmp1826 	%argrw{"wrr"}
	add		___475_maxamp ___475_maxamp ___475_amp 	%argrw{"wrr"}
	mul		___475_amp ___475_amp roughness 	%argrw{"wrr"}
	mul		___475_fscale ___475_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp1827 ___476_i 	%argrw{"wr"}
	add		___476_i ___476_i $const19 	%argrw{"wrr"}
	floor		$tmp1828 detail 	%argrw{"wr"}
	sub		___475_rmd detail $tmp1828 	%argrw{"wrr"}
	neq		$tmp1829 ___475_rmd $const1 	%argrw{"wrr"}
	if		$tmp1829 3651 3657 	%argrw{"r"}
	mul		$tmp1830 ___475_fscale ___475_p 	%argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1831 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1847 $tmp1830 $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1847 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		___478_t $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:246
# NOISE_FBM(vector3)
	mul		$tmp1848 ___478_t ___475_amp 	%line{246} %argrw{"wrr"}
	add		___478_sum2 ___475_sum $tmp1848 	%argrw{"wrr"}
	if		use_normalize 3649 3650 	%argrw{"r"}
	mul		$tmp1849 $const10 ___475_sum 	%argrw{"wrr"}
	div		$tmp1850 $tmp1849 ___475_maxamp 	%argrw{"wrr"}
	add		$tmp1851 $tmp1850 $const10 	%argrw{"wrr"}
	mul		$tmp1852 $const10 ___478_sum2 	%argrw{"wrr"}
	add		$tmp1853 ___475_maxamp ___475_amp 	%argrw{"wrr"}
	div		$tmp1854 $tmp1852 $tmp1853 	%argrw{"wrr"}
	add		$tmp1855 $tmp1854 $const10 	%argrw{"wrr"}
	mix		$tmp1744 $tmp1851 $tmp1855 ___475_rmd 	%argrw{"wrrr"}
	mix		$tmp1744 ___475_sum ___478_sum2 ___475_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 3655 3656 	%argrw{"r"}
	mul		$tmp1856 $const10 ___475_sum 	%argrw{"wrr"}
	div		$tmp1857 $tmp1856 ___475_maxamp 	%argrw{"wrr"}
	add		$tmp1744 $tmp1857 $const10 	%argrw{"wrr"}
	assign		$tmp1744 ___475_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1875 ___529_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1880 ___529_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1867 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1883 ___529_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1883 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1866 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:267
# NOISE_HYBRID_MULTI_FRACTAL(vector3)
	add		$tmp1884 $tmp1866 Offset 	%line{267} %argrw{"wrr"}
	mul		___531_signal $tmp1884 ___529_pwr 	%argrw{"wrr"}
	mul		___529_pwr ___529_pwr roughness 	%argrw{"wrr"}
	mul		$tmp1885 ___529_weight ___531_signal 	%argrw{"wrr"}
	add		___529_value ___529_value $tmp1885 	%argrw{"wrr"}
	mul		$tmp1886 Gain ___531_signal 	%argrw{"wrr"}
	mul		___529_weight ___529_weight $tmp1886 	%argrw{"wrr"}
	mul		___529_p ___529_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp1887 ___530_i 	%argrw{"wr"}
	add		___530_i ___530_i $const19 	%argrw{"wrr"}
	floor		$tmp1888 detail 	%argrw{"wr"}
	sub		___529_rmd detail $tmp1888 	%argrw{"wrr"}
	neq		$tmp1889 ___529_rmd $const1 	%argrw{"wrr"}
	neq		$tmp1890 $tmp1889 $const18 	%argrw{"wrr"}
	if		$tmp1890 3717 3717 	%argrw{"r"}
	gt		$tmp1891 ___529_weight $const24 	%argrw{"wrr"}
	neq		$tmp1892 $tmp1891 $const18 	%argrw{"wrr"}
	assign		$tmp1890 $tmp1892 	%argrw{"wr"}
	if		$tmp1890 3747 3747 	%argrw{"r"}
	gt		$tmp1893 ___529_weight $const17 	%argrw{"wrr"}
	if		$tmp1893 3721 3721 	%argrw{"r"}
	assign		___529_weight $const17 	%argrw{"wr"}
	functioncall	$const9 3742 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1898 ___529_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1903 ___529_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1908 ___529_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1895 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1911 ___529_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1911 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1894 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:267
# NOISE_HYBRID_MULTI_FRACTAL(vector3)
	add		$tmp1912 $tmp1894 Offset 	%line{267} %argrw{"wrr"}
	mul		___533_signal $tmp1912 ___529_pwr 	%argrw{"wrr"}
	mul		$tmp1913 ___529_rmd ___529_weight 	%argrw{"wrr"}
	mul		$tmp1914 $tmp1913 ___533_signal 	%argrw{"wrr"}
	add		___529_value ___529_value $tmp1914 	%argrw{"wrr"}
	assign		$tmp1744 ___529_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	assign		___547_p $tmp1755 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{274} %argrw{"wr"}
	assign		___547_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 3775 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1921 ___547_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1926 ___547_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1931 ___547_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1918 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1934 ___547_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1934 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1917 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	fabs		$tmp1916 $tmp1917 	%line{274} %argrw{"wr"}
	sub		___547_signal Offset $tmp1916 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_signal 	%argrw{"wrr"}
	assign		___547_value ___547_signal 	%argrw{"wr"}
	assign		___547_weight $const17 	%argrw{"wr"}
	...
	le		$tmp1936 ___548_i $tmp1935 	%argrw{"wrr"}
	neq		$tmp1937 $tmp1936 $const18 	%argrw{"wrr"}
	mul		___547_p ___547_p Lacunarity 	%argrw{"wrr"}
	mul		$tmp1938 ___547_signal Gain 	%argrw{"wrr"}
	functioncall	$const3 3790 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1939 $tmp1938 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___547_weight $tmp1939 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	functioncall	$const9 3811 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{274} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1945 ___547_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1950 ___547_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1955 ___547_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1942 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1958 ___547_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1958 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1941 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:274
# NOISE_RIDGED_MULTI_FRACTAL(vector3)
	fabs		$tmp1940 $tmp1941 	%line{274} %argrw{"wr"}
	sub		___547_signal Offset $tmp1940 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_signal 	%argrw{"wrr"}
	mul		___547_signal ___547_signal ___547_weight 	%argrw{"wrr"}
	mul		$tmp1959 ___547_signal ___547_pwr 	%argrw{"wrr"}
	add		___547_value ___547_value $tmp1959 	%argrw{"wrr"}
	mul		___547_pwr ___547_pwr roughness 	%argrw{"wrr"}
	assign		$tmp1960 ___548_i 	%argrw{"wr"}
	add		___548_i ___548_i $const19 	%argrw{"wrr"}
	assign		$tmp1744 ___547_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	assign		___509_p $tmp1755 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{260} %argrw{"wr"}
	assign		___509_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 3848 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1966 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1971 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1976 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1963 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp1979 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp1979 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1962 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		___509_value Offset $tmp1962 	%line{260} %argrw{"wrr"}
	mul		___509_p ___509_p Lacunarity 	%argrw{"wrr"}
	for		$tmp1982 3852 3855 3882 3884 	%argrw{"r"}
	assign		___510_i $const19 	%argrw{"wr"}
	assign		$tmp1980 detail 	%argrw{"wr"}
	le		$tmp1981 ___510_i $tmp1980 	%argrw{"wrr"}
	neq		$tmp1982 $tmp1981 $const18 	%argrw{"wrr"}
	functioncall	$const9 3876 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp1987 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp1992 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp1997 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp1984 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp2000 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp2000 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp1983 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		$tmp2001 $tmp1983 Offset 	%line{260} %argrw{"wrr"}
	mul		$tmp2002 $tmp2001 ___509_pwr 	%argrw{"wrr"}
	mul		___511_increment $tmp2002 ___509_value 	%argrw{"wrr"}
	add		___509_value ___509_value ___511_increment 	%argrw{"wrr"}
	mul		___509_pwr ___509_pwr roughness 	%argrw{"wrr"}
	mul		___509_p ___509_p Lacunarity 	%argrw{"wrr"}
	assign		$tmp2003 ___510_i 	%argrw{"wr"}
	add		___510_i ___510_i $const19 	%argrw{"wrr"}
	floor		$tmp2004 detail 	%argrw{"wr"}
	sub		___509_rmd detail $tmp2004 	%argrw{"wrr"}
	neq		$tmp2005 ___509_rmd $const1 	%argrw{"wrr"}
	if		$tmp2005 3914 3914 	%argrw{"r"}
	functioncall	$const9 3909 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:83
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	compref		$tmp2010 ___509_p $const18 	%line{83} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:84
#                                                float(fabs(co.y) >= 1000000.0),
	compref		$tmp2015 ___509_p $const19 	%line{84} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:85
#                                                float(fabs(co.z) >= 1000000.0));
	compref		$tmp2020 ___509_p $const39 	%line{85} %argrw{"wrr"}
...
#   vector3 precision_correction = 0.5 * vector3(float(fabs(co.x) >= 1000000.0),
	...
	mul		___463_precision_correction $const10 $tmp2007 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:89
#   vector3 p = fmod(co, 100000.0) + precision_correction;
	fmod		$tmp2023 ___509_p $const12 	%line{89} %argrw{"wrr"}
	add		___463_p $tmp2023 ___463_precision_correction 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:91
#   return noise("snoise", p);
	noise		$tmp2006 $const13 ___463_p 	%line{91} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:260
# NOISE_HETERO_TERRAIN(vector3)
	add		$tmp2024 $tmp2006 Offset 	%line{260} %argrw{"wrr"}
	mul		$tmp2025 $tmp2024 ___509_pwr 	%argrw{"wrr"}
	mul		___512_increment $tmp2025 ___509_value 	%argrw{"wrr"}
	mul		$tmp2026 ___509_rmd ___512_increment 	%argrw{"wrr"}
	add		___509_value ___509_value $tmp2026 	%argrw{"wrr"}
	assign		$tmp1744 ___509_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:81
# NOISE_SELECT(vector3)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{81}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:178
#   Color = color(value,
	color		Color ___612_value $tmp1461 $tmp1744 	%line{178} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:195
#   return value;
	assign		Fac ___612_value 	%line{195} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:285
#   else if (dimensions == "4D") {
	eq		$tmp2027 dimensions $const41 	%line{285} %argrw{"wrr"}
	if		$tmp2027 6482 6483 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:286
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:209
#   vector4 p = co;
	assign		___614_p.x $tmp2028.x 	%line{209} %argrw{"wr"}
	assign		___614_p.y $tmp2028.y 	%argrw{"wr"}
	assign		___614_p.z $tmp2028.z 	%argrw{"wr"}
	assign		___614_p.w $tmp2028.w 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:210
#   if (distortion != 0.0) {
	neq		$tmp2029 Distortion $const1 	%line{210} %argrw{"wrr"}
	if		$tmp2029 4191 4191 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:211
#     p += vector4(safe_snoise(p + random_vector4_offset(0.0)) * distortion,
	functioncall	$const42 3947 	%line{211} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:71
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:72
#                  100.0 + noise("hash", seed, 1.0) * 100.0,
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:73
#                  100.0 + noise("hash", seed, 2.0) * 100.0,
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:74
...
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		$tmp2032.x ___614_p.x $tmp2033.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		$tmp2032.y ___614_p.y $tmp2033.y 	%argrw{"wrr"}
	add		$tmp2032.z ___614_p.z $tmp2033.z 	%argrw{"wrr"}
	add		$tmp2032.w ___614_p.w $tmp2033.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:211
#     p += vector4(safe_snoise(p + random_vector4_offset(0.0)) * distortion,
	functioncall	$const9 3996 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{211} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2043 $tmp2032.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{96} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 3979 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2055.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2055.x $tmp2042.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2055.y $tmp2042.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2055.z $tmp2042.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2055.w $tmp2042.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 3989 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2057.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2056.x $tmp2032.x $tmp2057.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2056.y $tmp2032.y $tmp2057.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2056.z $tmp2032.z $tmp2057.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2056.w $tmp2032.w $tmp2057.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 3994 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2056.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2056.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2056.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2056.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2058 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2031 $const13 $tmp2058 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:211
#     p += vector4(safe_snoise(p + random_vector4_offset(0.0)) * distortion,
	mul		$tmp2030.x $tmp2031 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{211} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:212
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		$tmp2060.x ___614_p.x $tmp2061.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		$tmp2060.y ___614_p.y $tmp2061.y 	%argrw{"wrr"}
	add		$tmp2060.z ___614_p.z $tmp2061.z 	%argrw{"wrr"}
	add		$tmp2060.w ___614_p.w $tmp2061.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:212
#                  safe_snoise(p + random_vector4_offset(1.0)) * distortion,
	functioncall	$const9 4059 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{212} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2071 $tmp2060.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{96} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4042 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2083.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2083.x $tmp2070.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2083.y $tmp2070.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2083.z $tmp2070.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2083.w $tmp2070.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4052 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2085.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4057 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2084.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2084.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2084.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2084.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2086 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2059 $const13 $tmp2086 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:212
#                  safe_snoise(p + random_vector4_offset(1.0)) * distortion,
	mul		$tmp2030.y $tmp2059 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{212} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:213
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		$tmp2088.x ___614_p.x $tmp2089.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		$tmp2088.y ___614_p.y $tmp2089.y 	%argrw{"wrr"}
	add		$tmp2088.z ___614_p.z $tmp2089.z 	%argrw{"wrr"}
	add		$tmp2088.w ___614_p.w $tmp2089.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:213
#                  safe_snoise(p + random_vector4_offset(2.0)) * distortion,
	functioncall	$const9 4122 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{213} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2099 $tmp2088.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{96} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4105 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2111.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2111.x $tmp2098.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2111.y $tmp2098.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2111.z $tmp2098.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2111.w $tmp2098.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4115 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2113.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4120 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2112.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2112.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2112.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2112.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2114 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2087 $const13 $tmp2114 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:213
#                  safe_snoise(p + random_vector4_offset(2.0)) * distortion,
	mul		$tmp2030.z $tmp2087 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{213} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:214
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		$tmp2116.x ___614_p.x $tmp2117.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		$tmp2116.y ___614_p.y $tmp2117.y 	%argrw{"wrr"}
	add		$tmp2116.z ___614_p.z $tmp2117.z 	%argrw{"wrr"}
	add		$tmp2116.w ___614_p.w $tmp2117.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:214
#                  safe_snoise(p + random_vector4_offset(3.0)) * distortion);
	functioncall	$const9 4185 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{214} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2127 $tmp2116.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{96} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4168 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2139.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2139.x $tmp2126.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2139.y $tmp2126.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2139.z $tmp2126.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2139.w $tmp2126.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4178 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2141.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4183 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2140.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2140.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2140.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2140.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2142 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2115 $const13 $tmp2142 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:214
#                  safe_snoise(p + random_vector4_offset(3.0)) * distortion);
	mul		$tmp2030.w $tmp2115 Distortion 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{214} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4191 	%line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___614_p.x ___614_p.x $tmp2030.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___614_p.y ___614_p.y $tmp2030.y 	%argrw{"wrr"}
	add		___614_p.z ___614_p.z $tmp2030.z 	%argrw{"wrr"}
	add		___614_p.w ___614_p.w $tmp2030.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:217
#   float value = noise_select(p, detail, roughness, lacunarity, offset, gain, type, use_normalize);
	functioncall	$const14 4942 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{217} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
...
# NOISE_MULTI_FRACTAL(vector4)
	assign		___497_p.x ___614_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{254} %argrw{"wr"}
	assign		___497_p.y ___614_p.y 	%argrw{"wr"}
	assign		___497_p.z ___614_p.z 	%argrw{"wr"}
	assign		___497_p.w ___614_p.w 	%argrw{"wr"}
	assign		___497_value $const17 	%argrw{"wr"}
	assign		___497_pwr $const17 	%argrw{"wr"}
	for		$tmp2146 4203 4206 4264 4266 	%argrw{"r"}
	assign		___498_i $const18 	%argrw{"wr"}
	assign		$tmp2144 detail 	%argrw{"wr"}
	le		$tmp2145 ___498_i $tmp2144 	%argrw{"wrr"}
	neq		$tmp2146 $tmp2145 $const18 	%argrw{"wrr"}
	functioncall	$const9 4250 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2149 ___497_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2150 $tmp2149 $const11 	%argrw{"wrr"}
	assign		$tmp2151 $tmp2150 	%argrw{"wr"}
	assign		$tmp2148.x $tmp2151 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2152 ___497_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2153 $tmp2152 $const11 	%argrw{"wrr"}
	assign		$tmp2154 $tmp2153 	%argrw{"wr"}
	assign		$tmp2148.y $tmp2154 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2155 ___497_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2156 $tmp2155 $const11 	%argrw{"wrr"}
	assign		$tmp2157 $tmp2156 	%argrw{"wr"}
	assign		$tmp2148.z $tmp2157 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2158 ___497_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2159 $tmp2158 $const11 	%argrw{"wrr"}
	assign		$tmp2160 $tmp2159 	%argrw{"wr"}
	assign		$tmp2148.w $tmp2160 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4233 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2161.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2161.x $tmp2148.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2161.y $tmp2148.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2161.z $tmp2148.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2161.w $tmp2148.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4243 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2163.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2162.x ___497_p.x $tmp2163.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2162.y ___497_p.y $tmp2163.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2162.z ___497_p.z $tmp2163.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2162.w ___497_p.w $tmp2163.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4248 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2162.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2162.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2162.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2162.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2164 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2147 $const13 $tmp2164 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	mul		$tmp2165 ___497_pwr $tmp2147 	%line{254} %argrw{"wrr"}
	add		$tmp2166 $tmp2165 $const17 	%argrw{"wrr"}
	mul		___497_value ___497_value $tmp2166 	%argrw{"wrr"}
	mul		___497_pwr ___497_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4264 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2167.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___497_p.x ___497_p.x $tmp2167.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___497_p.y ___497_p.y $tmp2167.y 	%argrw{"wrr"}
	mul		___497_p.z ___497_p.z $tmp2167.z 	%argrw{"wrr"}
	mul		___497_p.w ___497_p.w $tmp2167.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	assign		$tmp2168 ___498_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{254} %argrw{"wr"}
	add		___498_i ___498_i $const19 	%argrw{"wrr"}
	floor		$tmp2169 detail 	%argrw{"wr"}
	sub		___497_rmd detail $tmp2169 	%argrw{"wrr"}
	neq		$tmp2170 ___497_rmd $const1 	%argrw{"wrr"}
	if		$tmp2170 4318 4318 	%argrw{"r"}
	mul		$tmp2171 ___497_rmd ___497_pwr 	%argrw{"wrr"}
	functioncall	$const9 4315 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2174 ___497_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2175 $tmp2174 $const11 	%argrw{"wrr"}
	assign		$tmp2176 $tmp2175 	%argrw{"wr"}
	assign		$tmp2173.x $tmp2176 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2177 ___497_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2178 $tmp2177 $const11 	%argrw{"wrr"}
	assign		$tmp2179 $tmp2178 	%argrw{"wr"}
	assign		$tmp2173.y $tmp2179 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2180 ___497_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2181 $tmp2180 $const11 	%argrw{"wrr"}
	assign		$tmp2182 $tmp2181 	%argrw{"wr"}
	assign		$tmp2173.z $tmp2182 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2183 ___497_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2184 $tmp2183 $const11 	%argrw{"wrr"}
	assign		$tmp2185 $tmp2184 	%argrw{"wr"}
	assign		$tmp2173.w $tmp2185 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4298 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2186.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2186.x $tmp2173.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2186.y $tmp2173.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2186.z $tmp2173.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2186.w $tmp2173.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4308 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2188.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2187.x ___497_p.x $tmp2188.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2187.y ___497_p.y $tmp2188.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2187.z ___497_p.z $tmp2188.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2187.w ___497_p.w $tmp2188.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4313 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2187.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2187.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2187.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2187.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2189 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2172 $const13 $tmp2189 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	mul		$tmp2190 $tmp2171 $tmp2172 	%line{254} %argrw{"wrr"}
	add		$tmp2191 $tmp2190 $const17 	%argrw{"wrr"}
	mul		___497_value ___497_value $tmp2191 	%argrw{"wrr"}
	assign		___614_value ___497_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
	eq		$tmp2192 type $const20 	%argrw{"wrr"}
	if		$tmp2192 4475 4942 	%argrw{"r"}
	functioncall	$const21 4474 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	assign		___480_p.x ___614_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"wr"}
	assign		___480_p.y ___614_p.y 	%argrw{"wr"}
	assign		___480_p.z ___614_p.z 	%argrw{"wr"}
	assign		___480_p.w ___614_p.w 	%argrw{"wr"}
	assign		___480_fscale $const17 	%argrw{"wr"}
	assign		___480_amp $const17 	%argrw{"wr"}
	assign		___480_maxamp $const1 	%argrw{"wr"}
	assign		___480_sum $const1 	%argrw{"wr"}
	for		$tmp2195 4333 4336 4395 4397 	%argrw{"r"}
	assign		___481_i $const18 	%argrw{"wr"}
	assign		$tmp2193 detail 	%argrw{"wr"}
	le		$tmp2194 ___481_i $tmp2193 	%argrw{"wrr"}
	neq		$tmp2195 $tmp2194 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4346 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2197.x ___480_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
	assign		$tmp2197.y ___480_fscale 	%argrw{"wr"}
	assign		$tmp2197.z ___480_fscale 	%argrw{"wr"}
	assign		$tmp2197.w ___480_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4346 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		$tmp2196.x $tmp2197.x ___480_p.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		$tmp2196.y $tmp2197.y ___480_p.y 	%argrw{"wrr"}
	mul		$tmp2196.z $tmp2197.z ___480_p.z 	%argrw{"wrr"}
	mul		$tmp2196.w $tmp2197.w ___480_p.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	functioncall	$const9 4390 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4373 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2211.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2211.x $tmp2198.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2211.y $tmp2198.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2211.z $tmp2198.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2211.w $tmp2198.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4383 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2213.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4388 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2212.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2212.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2212.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2212.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2214 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		___482_t $const13 $tmp2214 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	mul		$tmp2215 ___482_t ___480_amp 	%line{247} %argrw{"wrr"}
	add		___480_sum ___480_sum $tmp2215 	%argrw{"wrr"}
	add		___480_maxamp ___480_maxamp ___480_amp 	%argrw{"wrr"}
	mul		___480_amp ___480_amp roughness 	%argrw{"wrr"}
	mul		___480_fscale ___480_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp2216 ___481_i 	%argrw{"wr"}
	add		___481_i ___481_i $const19 	%argrw{"wrr"}
	floor		$tmp2217 detail 	%argrw{"wr"}
	sub		___480_rmd detail $tmp2217 	%argrw{"wrr"}
	neq		$tmp2218 ___480_rmd $const1 	%argrw{"wrr"}
	if		$tmp2218 4468 4474 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4411 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2220.x ___480_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
	assign		$tmp2220.y ___480_fscale 	%argrw{"wr"}
	assign		$tmp2220.z ___480_fscale 	%argrw{"wr"}
	assign		$tmp2220.w ___480_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4411 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		$tmp2219.x $tmp2220.x ___480_p.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		$tmp2219.y $tmp2220.y ___480_p.y 	%argrw{"wrr"}
	mul		$tmp2219.z $tmp2220.z ___480_p.z 	%argrw{"wrr"}
	mul		$tmp2219.w $tmp2220.w ___480_p.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	functioncall	$const9 4455 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4438 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2234.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2234.x $tmp2221.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2234.y $tmp2221.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2234.z $tmp2221.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2234.w $tmp2221.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4448 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2236.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4453 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2235.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2235.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2235.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2235.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2237 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		___483_t $const13 $tmp2237 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	mul		$tmp2238 ___483_t ___480_amp 	%line{247} %argrw{"wrr"}
	add		___483_sum2 ___480_sum $tmp2238 	%argrw{"wrr"}
	if		use_normalize 4466 4467 	%argrw{"r"}
	mul		$tmp2239 $const10 ___480_sum 	%argrw{"wrr"}
	div		$tmp2240 $tmp2239 ___480_maxamp 	%argrw{"wrr"}
	add		$tmp2241 $tmp2240 $const10 	%argrw{"wrr"}
	mul		$tmp2242 $const10 ___483_sum2 	%argrw{"wrr"}
	add		$tmp2243 ___480_maxamp ___480_amp 	%argrw{"wrr"}
	div		$tmp2244 $tmp2242 $tmp2243 	%argrw{"wrr"}
	add		$tmp2245 $tmp2244 $const10 	%argrw{"wrr"}
	mix		___614_value $tmp2241 $tmp2245 ___480_rmd 	%argrw{"wrrr"}
	mix		___614_value ___480_sum ___483_sum2 ___480_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 4472 4473 	%argrw{"r"}
	mul		$tmp2246 $const10 ___480_sum 	%argrw{"wrr"}
	div		$tmp2247 $tmp2246 ___480_maxamp 	%argrw{"wrr"}
	add		___614_value $tmp2247 $const10 	%argrw{"wrr"}
	assign		___614_value ___480_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	assign		___535_p.x ___614_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{268} %argrw{"wr"}
	assign		___535_p.y ___614_p.y 	%argrw{"wr"}
	assign		___535_p.z ___614_p.z 	%argrw{"wr"}
	assign		___535_p.w ___614_p.w 	%argrw{"wr"}
	assign		___535_pwr $const17 	%argrw{"wr"}
	assign		___535_value $const1 	%argrw{"wr"}
	assign		___535_weight $const17 	%argrw{"wr"}
	for		$tmp2254 4487 4495 4559 4561 	%argrw{"r"}
	assign		___536_i $const18 	%argrw{"wr"}
	gt		$tmp2249 ___535_weight $const24 	%argrw{"wrr"}
	neq		$tmp2250 $tmp2249 $const18 	%argrw{"wrr"}
	if		$tmp2250 4494 4494 	%argrw{"r"}
	assign		$tmp2251 detail 	%argrw{"wr"}
	le		$tmp2252 ___536_i $tmp2251 	%argrw{"wrr"}
	neq		$tmp2253 $tmp2252 $const18 	%argrw{"wrr"}
	assign		$tmp2250 $tmp2253 	%argrw{"wr"}
	neq		$tmp2254 $tmp2250 $const18 	%argrw{"wrr"}
	gt		$tmp2255 ___535_weight $const17 	%argrw{"wrr"}
	if		$tmp2255 4498 4498 	%argrw{"r"}
	assign		___535_weight $const17 	%argrw{"wr"}
	functioncall	$const9 4542 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2258 ___535_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2259 $tmp2258 $const11 	%argrw{"wrr"}
	assign		$tmp2260 $tmp2259 	%argrw{"wr"}
	assign		$tmp2257.x $tmp2260 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2261 ___535_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2262 $tmp2261 $const11 	%argrw{"wrr"}
	assign		$tmp2263 $tmp2262 	%argrw{"wr"}
	assign		$tmp2257.y $tmp2263 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2264 ___535_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2265 $tmp2264 $const11 	%argrw{"wrr"}
	assign		$tmp2266 $tmp2265 	%argrw{"wr"}
	assign		$tmp2257.z $tmp2266 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2267 ___535_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2268 $tmp2267 $const11 	%argrw{"wrr"}
	assign		$tmp2269 $tmp2268 	%argrw{"wr"}
	assign		$tmp2257.w $tmp2269 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4525 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2270.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2270.x $tmp2257.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2270.y $tmp2257.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2270.z $tmp2257.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2270.w $tmp2257.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4535 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2272.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2271.x ___535_p.x $tmp2272.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2271.y ___535_p.y $tmp2272.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2271.z ___535_p.z $tmp2272.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2271.w ___535_p.w $tmp2272.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4540 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2271.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2271.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2271.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2271.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2273 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2256 $const13 $tmp2273 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	add		$tmp2274 $tmp2256 Offset 	%line{268} %argrw{"wrr"}
	mul		___537_signal $tmp2274 ___535_pwr 	%argrw{"wrr"}
	mul		___535_pwr ___535_pwr roughness 	%argrw{"wrr"}
	mul		$tmp2275 ___535_weight ___537_signal 	%argrw{"wrr"}
	add		___535_value ___535_value $tmp2275 	%argrw{"wrr"}
	mul		$tmp2276 Gain ___537_signal 	%argrw{"wrr"}
	mul		___535_weight ___535_weight $tmp2276 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4559 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2277.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___535_p.x ___535_p.x $tmp2277.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___535_p.y ___535_p.y $tmp2277.y 	%argrw{"wrr"}
	mul		___535_p.z ___535_p.z $tmp2277.z 	%argrw{"wrr"}
	mul		___535_p.w ___535_p.w $tmp2277.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	assign		$tmp2278 ___536_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{268} %argrw{"wr"}
	add		___536_i ___536_i $const19 	%argrw{"wrr"}
	floor		$tmp2279 detail 	%argrw{"wr"}
	sub		___535_rmd detail $tmp2279 	%argrw{"wrr"}
	neq		$tmp2280 ___535_rmd $const1 	%argrw{"wrr"}
	neq		$tmp2281 $tmp2280 $const18 	%argrw{"wrr"}
	if		$tmp2281 4569 4569 	%argrw{"r"}
	gt		$tmp2282 ___535_weight $const24 	%argrw{"wrr"}
	neq		$tmp2283 $tmp2282 $const18 	%argrw{"wrr"}
	assign		$tmp2281 $tmp2283 	%argrw{"wr"}
	if		$tmp2281 4622 4622 	%argrw{"r"}
	gt		$tmp2284 ___535_weight $const17 	%argrw{"wrr"}
	if		$tmp2284 4573 4573 	%argrw{"r"}
	assign		___535_weight $const17 	%argrw{"wr"}
	functioncall	$const9 4617 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2287 ___535_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2288 $tmp2287 $const11 	%argrw{"wrr"}
	assign		$tmp2289 $tmp2288 	%argrw{"wr"}
	assign		$tmp2286.x $tmp2289 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2290 ___535_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2291 $tmp2290 $const11 	%argrw{"wrr"}
	assign		$tmp2292 $tmp2291 	%argrw{"wr"}
	assign		$tmp2286.y $tmp2292 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2293 ___535_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2294 $tmp2293 $const11 	%argrw{"wrr"}
	assign		$tmp2295 $tmp2294 	%argrw{"wr"}
	assign		$tmp2286.z $tmp2295 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2296 ___535_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2297 $tmp2296 $const11 	%argrw{"wrr"}
	assign		$tmp2298 $tmp2297 	%argrw{"wr"}
	assign		$tmp2286.w $tmp2298 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4600 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2299.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2299.x $tmp2286.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2299.y $tmp2286.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2299.z $tmp2286.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2299.w $tmp2286.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4610 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2301.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2300.x ___535_p.x $tmp2301.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2300.y ___535_p.y $tmp2301.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2300.z ___535_p.z $tmp2301.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2300.w ___535_p.w $tmp2301.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4615 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2300.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2300.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2300.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2300.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2302 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2285 $const13 $tmp2302 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	add		$tmp2303 $tmp2285 Offset 	%line{268} %argrw{"wrr"}
	mul		___539_signal $tmp2303 ___535_pwr 	%argrw{"wrr"}
	mul		$tmp2304 ___535_rmd ___535_weight 	%argrw{"wrr"}
	mul		$tmp2305 $tmp2304 ___539_signal 	%argrw{"wrr"}
	add		___535_value ___535_value $tmp2305 	%argrw{"wrr"}
	assign		___614_value ___535_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	assign		___550_p.x ___614_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"wr"}
	assign		___550_p.y ___614_p.y 	%argrw{"wr"}
	assign		___550_p.z ___614_p.z 	%argrw{"wr"}
	assign		___550_p.w ___614_p.w 	%argrw{"wr"}
	assign		___550_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 4676 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2310 ___550_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2311 $tmp2310 $const11 	%argrw{"wrr"}
	assign		$tmp2312 $tmp2311 	%argrw{"wr"}
	assign		$tmp2309.x $tmp2312 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2313 ___550_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2314 $tmp2313 $const11 	%argrw{"wrr"}
	assign		$tmp2315 $tmp2314 	%argrw{"wr"}
	assign		$tmp2309.y $tmp2315 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2316 ___550_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2317 $tmp2316 $const11 	%argrw{"wrr"}
	assign		$tmp2318 $tmp2317 	%argrw{"wr"}
	assign		$tmp2309.z $tmp2318 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2319 ___550_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2320 $tmp2319 $const11 	%argrw{"wrr"}
	assign		$tmp2321 $tmp2320 	%argrw{"wr"}
	assign		$tmp2309.w $tmp2321 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4659 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2322.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2322.x $tmp2309.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2322.y $tmp2309.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2322.z $tmp2309.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2322.w $tmp2309.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4669 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2324.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2323.x ___550_p.x $tmp2324.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2323.y ___550_p.y $tmp2324.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2323.z ___550_p.z $tmp2324.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2323.w ___550_p.w $tmp2324.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4674 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2323.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2323.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2323.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2323.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2325 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2308 $const13 $tmp2325 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	fabs		$tmp2307 $tmp2308 	%line{275} %argrw{"wr"}
	sub		___550_signal Offset $tmp2307 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_signal 	%argrw{"wrr"}
	assign		___550_value ___550_signal 	%argrw{"wr"}
	assign		___550_weight $const17 	%argrw{"wr"}
	for		$tmp2328 4683 4686 4751 4753 	%argrw{"r"}
	assign		___551_i $const19 	%argrw{"wr"}
	assign		$tmp2326 detail 	%argrw{"wr"}
	le		$tmp2327 ___551_i $tmp2326 	%argrw{"wrr"}
	neq		$tmp2328 $tmp2327 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4696 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2329.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___550_p.x ___550_p.x $tmp2329.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___550_p.y ___550_p.y $tmp2329.y 	%argrw{"wrr"}
	mul		___550_p.z ___550_p.z $tmp2329.z 	%argrw{"wrr"}
	mul		___550_p.w ___550_p.w $tmp2329.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	mul		$tmp2330 ___550_signal Gain 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"wrr"}
	functioncall	$const3 4700 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2331 $tmp2330 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___550_weight $tmp2331 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	functioncall	$const9 4744 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2335 ___550_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2336 $tmp2335 $const11 	%argrw{"wrr"}
	assign		$tmp2337 $tmp2336 	%argrw{"wr"}
	assign		$tmp2334.x $tmp2337 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2338 ___550_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2339 $tmp2338 $const11 	%argrw{"wrr"}
	assign		$tmp2340 $tmp2339 	%argrw{"wr"}
	assign		$tmp2334.y $tmp2340 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2341 ___550_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2342 $tmp2341 $const11 	%argrw{"wrr"}
	assign		$tmp2343 $tmp2342 	%argrw{"wr"}
	assign		$tmp2334.z $tmp2343 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2344 ___550_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2345 $tmp2344 $const11 	%argrw{"wrr"}
	assign		$tmp2346 $tmp2345 	%argrw{"wr"}
	assign		$tmp2334.w $tmp2346 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4727 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2347.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2347.x $tmp2334.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2347.y $tmp2334.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2347.z $tmp2334.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2347.w $tmp2334.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4737 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2349.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2348.x ___550_p.x $tmp2349.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2348.y ___550_p.y $tmp2349.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2348.z ___550_p.z $tmp2349.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2348.w ___550_p.w $tmp2349.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4742 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2348.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2348.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2348.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2348.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2350 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2333 $const13 $tmp2350 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	fabs		$tmp2332 $tmp2333 	%line{275} %argrw{"wr"}
	sub		___550_signal Offset $tmp2332 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_signal 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_weight 	%argrw{"wrr"}
	mul		$tmp2351 ___550_signal ___550_pwr 	%argrw{"wrr"}
	add		___550_value ___550_value $tmp2351 	%argrw{"wrr"}
	mul		___550_pwr ___550_pwr roughness 	%argrw{"wrr"}
	assign		$tmp2352 ___551_i 	%argrw{"wr"}
	add		___551_i ___551_i $const19 	%argrw{"wrr"}
	assign		___614_value ___550_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# NOISE_HETERO_TERRAIN(vector4)
	assign		___513_p.x ___614_p.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"wr"}
	assign		___513_p.y ___614_p.y 	%argrw{"wr"}
	assign		___513_p.z ___614_p.z 	%argrw{"wr"}
	assign		___513_p.w ___614_p.w 	%argrw{"wr"}
	assign		___513_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 4807 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2356 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2357 $tmp2356 $const11 	%argrw{"wrr"}
	assign		$tmp2358 $tmp2357 	%argrw{"wr"}
	assign		$tmp2355.x $tmp2358 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2359 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2360 $tmp2359 $const11 	%argrw{"wrr"}
	assign		$tmp2361 $tmp2360 	%argrw{"wr"}
	assign		$tmp2355.y $tmp2361 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2362 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2363 $tmp2362 $const11 	%argrw{"wrr"}
	assign		$tmp2364 $tmp2363 	%argrw{"wr"}
	assign		$tmp2355.z $tmp2364 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2365 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2366 $tmp2365 $const11 	%argrw{"wrr"}
	assign		$tmp2367 $tmp2366 	%argrw{"wr"}
	assign		$tmp2355.w $tmp2367 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4790 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2368.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2368.x $tmp2355.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2368.y $tmp2355.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2368.z $tmp2355.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2368.w $tmp2355.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4800 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2370.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2369.x ___513_p.x $tmp2370.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2369.y ___513_p.y $tmp2370.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2369.z ___513_p.z $tmp2370.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2369.w ___513_p.w $tmp2370.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4805 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2369.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2369.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2369.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2369.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2371 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2354 $const13 $tmp2371 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		___513_value Offset $tmp2354 	%line{261} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4818 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2372.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___513_p.x ___513_p.x $tmp2372.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___513_p.y ___513_p.y $tmp2372.y 	%argrw{"wrr"}
	mul		___513_p.z ___513_p.z $tmp2372.z 	%argrw{"wrr"}
	mul		___513_p.w ___513_p.w $tmp2372.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	for		$tmp2375 4820 4823 4882 4884 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"r"}
	assign		___514_i $const19 	%argrw{"wr"}
	assign		$tmp2373 detail 	%argrw{"wr"}
	le		$tmp2374 ___514_i $tmp2373 	%argrw{"wrr"}
	neq		$tmp2375 $tmp2374 $const18 	%argrw{"wrr"}
	functioncall	$const9 4867 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2378 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2379 $tmp2378 $const11 	%argrw{"wrr"}
	assign		$tmp2380 $tmp2379 	%argrw{"wr"}
	assign		$tmp2377.x $tmp2380 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2381 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2382 $tmp2381 $const11 	%argrw{"wrr"}
	assign		$tmp2383 $tmp2382 	%argrw{"wr"}
	assign		$tmp2377.y $tmp2383 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2384 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2385 $tmp2384 $const11 	%argrw{"wrr"}
	assign		$tmp2386 $tmp2385 	%argrw{"wr"}
	assign		$tmp2377.z $tmp2386 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2387 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2388 $tmp2387 $const11 	%argrw{"wrr"}
	assign		$tmp2389 $tmp2388 	%argrw{"wr"}
	assign		$tmp2377.w $tmp2389 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4850 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2390.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2390.x $tmp2377.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2390.y $tmp2377.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2390.z $tmp2377.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2390.w $tmp2377.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4860 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2392.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2391.x ___513_p.x $tmp2392.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2391.y ___513_p.y $tmp2392.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2391.z ___513_p.z $tmp2392.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2391.w ___513_p.w $tmp2392.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4865 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2391.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2391.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2391.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2391.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2393 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2376 $const13 $tmp2393 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		$tmp2394 $tmp2376 Offset 	%line{261} %argrw{"wrr"}
	mul		$tmp2395 $tmp2394 ___513_pwr 	%argrw{"wrr"}
	mul		___515_increment $tmp2395 ___513_value 	%argrw{"wrr"}
	add		___513_value ___513_value ___515_increment 	%argrw{"wrr"}
	mul		___513_pwr ___513_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4882 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2396.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___513_p.x ___513_p.x $tmp2396.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___513_p.y ___513_p.y $tmp2396.y 	%argrw{"wrr"}
	mul		___513_p.z ___513_p.z $tmp2396.z 	%argrw{"wrr"}
	mul		___513_p.w ___513_p.w $tmp2396.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	assign		$tmp2397 ___514_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"wr"}
	add		___514_i ___514_i $const19 	%argrw{"wrr"}
	floor		$tmp2398 detail 	%argrw{"wr"}
	sub		___513_rmd detail $tmp2398 	%argrw{"wrr"}
	neq		$tmp2399 ___513_rmd $const1 	%argrw{"wrr"}
	if		$tmp2399 4937 4937 	%argrw{"r"}
	functioncall	$const9 4932 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2402 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2403 $tmp2402 $const11 	%argrw{"wrr"}
	assign		$tmp2404 $tmp2403 	%argrw{"wr"}
	assign		$tmp2401.x $tmp2404 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2405 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2406 $tmp2405 $const11 	%argrw{"wrr"}
	assign		$tmp2407 $tmp2406 	%argrw{"wr"}
	assign		$tmp2401.y $tmp2407 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2408 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2409 $tmp2408 $const11 	%argrw{"wrr"}
	assign		$tmp2410 $tmp2409 	%argrw{"wr"}
	assign		$tmp2401.z $tmp2410 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2411 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2412 $tmp2411 $const11 	%argrw{"wrr"}
	assign		$tmp2413 $tmp2412 	%argrw{"wr"}
	assign		$tmp2401.w $tmp2413 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 4915 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2414.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2414.x $tmp2401.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2414.y $tmp2401.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2414.z $tmp2401.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2414.w $tmp2401.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 4925 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2416.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2415.x ___513_p.x $tmp2416.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2415.y ___513_p.y $tmp2416.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2415.z ___513_p.z $tmp2416.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2415.w ___513_p.w $tmp2416.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 4930 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2415.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2415.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2415.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2415.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2417 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2400 $const13 $tmp2417 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		$tmp2418 $tmp2400 Offset 	%line{261} %argrw{"wrr"}
	mul		$tmp2419 $tmp2418 ___513_pwr 	%argrw{"wrr"}
	mul		___516_increment $tmp2419 ___513_value 	%argrw{"wrr"}
	mul		$tmp2420 ___513_rmd ___516_increment 	%argrw{"wrr"}
	add		___513_value ___513_value $tmp2420 	%argrw{"wrr"}
	assign		___614_value ___513_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
	error		$const29 	%argrw{"r"}
	assign		___614_value $const1 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:219
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		$tmp2422.x ___614_p.x $tmp2423.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		$tmp2422.y ___614_p.y $tmp2423.y 	%argrw{"wrr"}
	add		$tmp2422.z ___614_p.z $tmp2423.z 	%argrw{"wrr"}
	add		$tmp2422.w ___614_p.w $tmp2423.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:219
#                 noise_select(p + random_vector4_offset(4.0),
	functioncall	$const14 5711 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{219} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	assign		___497_p.x $tmp2422.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{254} %argrw{"wr"}
	assign		___497_p.y $tmp2422.y 	%argrw{"wr"}
	assign		___497_p.z $tmp2422.z 	%argrw{"wr"}
	assign		___497_p.w $tmp2422.w 	%argrw{"wr"}
	assign		___497_value $const17 	%argrw{"wr"}
	assign		___497_pwr $const17 	%argrw{"wr"}
	for		$tmp2435 4972 4975 5033 5035 	%argrw{"r"}
	assign		___498_i $const18 	%argrw{"wr"}
	assign		$tmp2433 detail 	%argrw{"wr"}
	le		$tmp2434 ___498_i $tmp2433 	%argrw{"wrr"}
	neq		$tmp2435 $tmp2434 $const18 	%argrw{"wrr"}
	functioncall	$const9 5019 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2438 ___497_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2439 $tmp2438 $const11 	%argrw{"wrr"}
	assign		$tmp2440 $tmp2439 	%argrw{"wr"}
	assign		$tmp2437.x $tmp2440 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2441 ___497_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2442 $tmp2441 $const11 	%argrw{"wrr"}
	assign		$tmp2443 $tmp2442 	%argrw{"wr"}
	assign		$tmp2437.y $tmp2443 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2444 ___497_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2445 $tmp2444 $const11 	%argrw{"wrr"}
	assign		$tmp2446 $tmp2445 	%argrw{"wr"}
	assign		$tmp2437.z $tmp2446 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2447 ___497_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2448 $tmp2447 $const11 	%argrw{"wrr"}
	assign		$tmp2449 $tmp2448 	%argrw{"wr"}
	assign		$tmp2437.w $tmp2449 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5002 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2450.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2450.x $tmp2437.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2450.y $tmp2437.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2450.z $tmp2437.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2450.w $tmp2437.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5012 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2452.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2451.x ___497_p.x $tmp2452.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2451.y ___497_p.y $tmp2452.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2451.z ___497_p.z $tmp2452.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2451.w ___497_p.w $tmp2452.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5017 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2451.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2451.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2451.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2451.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2453 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2436 $const13 $tmp2453 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	mul		$tmp2454 ___497_pwr $tmp2436 	%line{254} %argrw{"wrr"}
	add		$tmp2455 $tmp2454 $const17 	%argrw{"wrr"}
	mul		___497_value ___497_value $tmp2455 	%argrw{"wrr"}
	mul		___497_pwr ___497_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5033 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2456.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___497_p.x ___497_p.x $tmp2456.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___497_p.y ___497_p.y $tmp2456.y 	%argrw{"wrr"}
	mul		___497_p.z ___497_p.z $tmp2456.z 	%argrw{"wrr"}
	mul		___497_p.w ___497_p.w $tmp2456.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	assign		$tmp2457 ___498_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{254} %argrw{"wr"}
	add		___498_i ___498_i $const19 	%argrw{"wrr"}
	floor		$tmp2458 detail 	%argrw{"wr"}
	sub		___497_rmd detail $tmp2458 	%argrw{"wrr"}
	neq		$tmp2459 ___497_rmd $const1 	%argrw{"wrr"}
	if		$tmp2459 5087 5087 	%argrw{"r"}
	mul		$tmp2460 ___497_rmd ___497_pwr 	%argrw{"wrr"}
	functioncall	$const9 5084 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2463 ___497_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2464 $tmp2463 $const11 	%argrw{"wrr"}
	assign		$tmp2465 $tmp2464 	%argrw{"wr"}
	assign		$tmp2462.x $tmp2465 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2466 ___497_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2467 $tmp2466 $const11 	%argrw{"wrr"}
	assign		$tmp2468 $tmp2467 	%argrw{"wr"}
	assign		$tmp2462.y $tmp2468 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2469 ___497_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2470 $tmp2469 $const11 	%argrw{"wrr"}
	assign		$tmp2471 $tmp2470 	%argrw{"wr"}
	assign		$tmp2462.z $tmp2471 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2472 ___497_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2473 $tmp2472 $const11 	%argrw{"wrr"}
	assign		$tmp2474 $tmp2473 	%argrw{"wr"}
	assign		$tmp2462.w $tmp2474 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5067 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2475.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2475.x $tmp2462.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2475.y $tmp2462.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2475.z $tmp2462.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2475.w $tmp2462.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5077 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2477.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2476.x ___497_p.x $tmp2477.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2476.y ___497_p.y $tmp2477.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2476.z ___497_p.z $tmp2477.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2476.w ___497_p.w $tmp2477.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5082 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2476.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2476.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2476.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2476.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2478 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2461 $const13 $tmp2478 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	mul		$tmp2479 $tmp2460 $tmp2461 	%line{254} %argrw{"wrr"}
	add		$tmp2480 $tmp2479 $const17 	%argrw{"wrr"}
	mul		___497_value ___497_value $tmp2480 	%argrw{"wrr"}
	assign		$tmp2421 ___497_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	assign		___480_p.x $tmp2422.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"wr"}
	assign		___480_p.y $tmp2422.y 	%argrw{"wr"}
	assign		___480_p.z $tmp2422.z 	%argrw{"wr"}
	assign		___480_p.w $tmp2422.w 	%argrw{"wr"}
	assign		___480_fscale $const17 	%argrw{"wr"}
	assign		___480_amp $const17 	%argrw{"wr"}
	assign		___480_maxamp $const1 	%argrw{"wr"}
	assign		___480_sum $const1 	%argrw{"wr"}
	...
	le		$tmp2483 ___481_i $tmp2482 	%argrw{"wrr"}
	neq		$tmp2484 $tmp2483 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5115 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2486.x ___480_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
	assign		$tmp2486.y ___480_fscale 	%argrw{"wr"}
	assign		$tmp2486.z ___480_fscale 	%argrw{"wr"}
	assign		$tmp2486.w ___480_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5115 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		$tmp2485.x $tmp2486.x ___480_p.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		$tmp2485.y $tmp2486.y ___480_p.y 	%argrw{"wrr"}
	mul		$tmp2485.z $tmp2486.z ___480_p.z 	%argrw{"wrr"}
	mul		$tmp2485.w $tmp2486.w ___480_p.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	functioncall	$const9 5159 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5142 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2500.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2500.x $tmp2487.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2500.y $tmp2487.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2500.z $tmp2487.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2500.w $tmp2487.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5152 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2502.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5157 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2501.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2501.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2501.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2501.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2503 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		___482_t $const13 $tmp2503 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	mul		$tmp2504 ___482_t ___480_amp 	%line{247} %argrw{"wrr"}
	add		___480_sum ___480_sum $tmp2504 	%argrw{"wrr"}
	add		___480_maxamp ___480_maxamp ___480_amp 	%argrw{"wrr"}
	mul		___480_amp ___480_amp roughness 	%argrw{"wrr"}
	mul		___480_fscale ___480_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp2505 ___481_i 	%argrw{"wr"}
	add		___481_i ___481_i $const19 	%argrw{"wrr"}
	floor		$tmp2506 detail 	%argrw{"wr"}
	sub		___480_rmd detail $tmp2506 	%argrw{"wrr"}
	neq		$tmp2507 ___480_rmd $const1 	%argrw{"wrr"}
	if		$tmp2507 5237 5243 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5180 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2509.x ___480_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
	assign		$tmp2509.y ___480_fscale 	%argrw{"wr"}
	assign		$tmp2509.z ___480_fscale 	%argrw{"wr"}
	assign		$tmp2509.w ___480_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5180 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		$tmp2508.x $tmp2509.x ___480_p.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		$tmp2508.y $tmp2509.y ___480_p.y 	%argrw{"wrr"}
	mul		$tmp2508.z $tmp2509.z ___480_p.z 	%argrw{"wrr"}
	mul		$tmp2508.w $tmp2509.w ___480_p.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	functioncall	$const9 5224 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5207 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2523.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2523.x $tmp2510.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2523.y $tmp2510.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2523.z $tmp2510.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2523.w $tmp2510.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5217 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2525.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5222 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2524.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2524.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2524.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2524.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2526 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		___483_t $const13 $tmp2526 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	mul		$tmp2527 ___483_t ___480_amp 	%line{247} %argrw{"wrr"}
	add		___483_sum2 ___480_sum $tmp2527 	%argrw{"wrr"}
	if		use_normalize 5235 5236 	%argrw{"r"}
	mul		$tmp2528 $const10 ___480_sum 	%argrw{"wrr"}
	div		$tmp2529 $tmp2528 ___480_maxamp 	%argrw{"wrr"}
	add		$tmp2530 $tmp2529 $const10 	%argrw{"wrr"}
	mul		$tmp2531 $const10 ___483_sum2 	%argrw{"wrr"}
	add		$tmp2532 ___480_maxamp ___480_amp 	%argrw{"wrr"}
	div		$tmp2533 $tmp2531 $tmp2532 	%argrw{"wrr"}
	add		$tmp2534 $tmp2533 $const10 	%argrw{"wrr"}
	mix		$tmp2421 $tmp2530 $tmp2534 ___480_rmd 	%argrw{"wrrr"}
	mix		$tmp2421 ___480_sum ___483_sum2 ___480_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 5241 5242 	%argrw{"r"}
	mul		$tmp2535 $const10 ___480_sum 	%argrw{"wrr"}
	div		$tmp2536 $tmp2535 ___480_maxamp 	%argrw{"wrr"}
	add		$tmp2421 $tmp2536 $const10 	%argrw{"wrr"}
	assign		$tmp2421 ___480_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	assign		___535_p.x $tmp2422.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{268} %argrw{"wr"}
	assign		___535_p.y $tmp2422.y 	%argrw{"wr"}
	assign		___535_p.z $tmp2422.z 	%argrw{"wr"}
	assign		___535_p.w $tmp2422.w 	%argrw{"wr"}
	assign		___535_pwr $const17 	%argrw{"wr"}
	assign		___535_value $const1 	%argrw{"wr"}
	assign		___535_weight $const17 	%argrw{"wr"}
	for		$tmp2543 5256 5264 5328 5330 	%argrw{"r"}
	assign		___536_i $const18 	%argrw{"wr"}
	gt		$tmp2538 ___535_weight $const24 	%argrw{"wrr"}
	neq		$tmp2539 $tmp2538 $const18 	%argrw{"wrr"}
	if		$tmp2539 5263 5263 	%argrw{"r"}
	assign		$tmp2540 detail 	%argrw{"wr"}
	le		$tmp2541 ___536_i $tmp2540 	%argrw{"wrr"}
	neq		$tmp2542 $tmp2541 $const18 	%argrw{"wrr"}
	assign		$tmp2539 $tmp2542 	%argrw{"wr"}
	neq		$tmp2543 $tmp2539 $const18 	%argrw{"wrr"}
	gt		$tmp2544 ___535_weight $const17 	%argrw{"wrr"}
	if		$tmp2544 5267 5267 	%argrw{"r"}
	assign		___535_weight $const17 	%argrw{"wr"}
	functioncall	$const9 5311 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2547 ___535_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2548 $tmp2547 $const11 	%argrw{"wrr"}
	assign		$tmp2549 $tmp2548 	%argrw{"wr"}
	assign		$tmp2546.x $tmp2549 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2550 ___535_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2551 $tmp2550 $const11 	%argrw{"wrr"}
	assign		$tmp2552 $tmp2551 	%argrw{"wr"}
	assign		$tmp2546.y $tmp2552 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2553 ___535_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2554 $tmp2553 $const11 	%argrw{"wrr"}
	assign		$tmp2555 $tmp2554 	%argrw{"wr"}
	assign		$tmp2546.z $tmp2555 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2556 ___535_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2557 $tmp2556 $const11 	%argrw{"wrr"}
	assign		$tmp2558 $tmp2557 	%argrw{"wr"}
	assign		$tmp2546.w $tmp2558 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5294 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2559.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2559.x $tmp2546.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2559.y $tmp2546.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2559.z $tmp2546.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2559.w $tmp2546.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5304 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2561.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2560.x ___535_p.x $tmp2561.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2560.y ___535_p.y $tmp2561.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2560.z ___535_p.z $tmp2561.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2560.w ___535_p.w $tmp2561.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5309 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2560.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2560.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2560.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2560.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2562 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2545 $const13 $tmp2562 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	add		$tmp2563 $tmp2545 Offset 	%line{268} %argrw{"wrr"}
	mul		___537_signal $tmp2563 ___535_pwr 	%argrw{"wrr"}
	mul		___535_pwr ___535_pwr roughness 	%argrw{"wrr"}
	mul		$tmp2564 ___535_weight ___537_signal 	%argrw{"wrr"}
	add		___535_value ___535_value $tmp2564 	%argrw{"wrr"}
	mul		$tmp2565 Gain ___537_signal 	%argrw{"wrr"}
	mul		___535_weight ___535_weight $tmp2565 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5328 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2566.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___535_p.x ___535_p.x $tmp2566.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___535_p.y ___535_p.y $tmp2566.y 	%argrw{"wrr"}
	mul		___535_p.z ___535_p.z $tmp2566.z 	%argrw{"wrr"}
	mul		___535_p.w ___535_p.w $tmp2566.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	assign		$tmp2567 ___536_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{268} %argrw{"wr"}
	add		___536_i ___536_i $const19 	%argrw{"wrr"}
	floor		$tmp2568 detail 	%argrw{"wr"}
	sub		___535_rmd detail $tmp2568 	%argrw{"wrr"}
	neq		$tmp2569 ___535_rmd $const1 	%argrw{"wrr"}
	neq		$tmp2570 $tmp2569 $const18 	%argrw{"wrr"}
	if		$tmp2570 5338 5338 	%argrw{"r"}
	gt		$tmp2571 ___535_weight $const24 	%argrw{"wrr"}
	neq		$tmp2572 $tmp2571 $const18 	%argrw{"wrr"}
	assign		$tmp2570 $tmp2572 	%argrw{"wr"}
	if		$tmp2570 5391 5391 	%argrw{"r"}
	gt		$tmp2573 ___535_weight $const17 	%argrw{"wrr"}
	if		$tmp2573 5342 5342 	%argrw{"r"}
	assign		___535_weight $const17 	%argrw{"wr"}
	functioncall	$const9 5386 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2576 ___535_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2577 $tmp2576 $const11 	%argrw{"wrr"}
	assign		$tmp2578 $tmp2577 	%argrw{"wr"}
	assign		$tmp2575.x $tmp2578 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2579 ___535_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2580 $tmp2579 $const11 	%argrw{"wrr"}
	assign		$tmp2581 $tmp2580 	%argrw{"wr"}
	assign		$tmp2575.y $tmp2581 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2582 ___535_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2583 $tmp2582 $const11 	%argrw{"wrr"}
	assign		$tmp2584 $tmp2583 	%argrw{"wr"}
	assign		$tmp2575.z $tmp2584 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2585 ___535_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2586 $tmp2585 $const11 	%argrw{"wrr"}
	assign		$tmp2587 $tmp2586 	%argrw{"wr"}
	assign		$tmp2575.w $tmp2587 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5369 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2588.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2588.x $tmp2575.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2588.y $tmp2575.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2588.z $tmp2575.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2588.w $tmp2575.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5379 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2590.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2589.x ___535_p.x $tmp2590.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2589.y ___535_p.y $tmp2590.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2589.z ___535_p.z $tmp2590.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2589.w ___535_p.w $tmp2590.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5384 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2589.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2589.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2589.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2589.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2591 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2574 $const13 $tmp2591 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	add		$tmp2592 $tmp2574 Offset 	%line{268} %argrw{"wrr"}
	mul		___539_signal $tmp2592 ___535_pwr 	%argrw{"wrr"}
	mul		$tmp2593 ___535_rmd ___535_weight 	%argrw{"wrr"}
	mul		$tmp2594 $tmp2593 ___539_signal 	%argrw{"wrr"}
	add		___535_value ___535_value $tmp2594 	%argrw{"wrr"}
	assign		$tmp2421 ___535_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	assign		___550_p.x $tmp2422.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"wr"}
	assign		___550_p.y $tmp2422.y 	%argrw{"wr"}
	assign		___550_p.z $tmp2422.z 	%argrw{"wr"}
	assign		___550_p.w $tmp2422.w 	%argrw{"wr"}
	assign		___550_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 5445 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2599 ___550_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2600 $tmp2599 $const11 	%argrw{"wrr"}
	assign		$tmp2601 $tmp2600 	%argrw{"wr"}
	assign		$tmp2598.x $tmp2601 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2602 ___550_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2603 $tmp2602 $const11 	%argrw{"wrr"}
	assign		$tmp2604 $tmp2603 	%argrw{"wr"}
	assign		$tmp2598.y $tmp2604 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2605 ___550_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2606 $tmp2605 $const11 	%argrw{"wrr"}
	assign		$tmp2607 $tmp2606 	%argrw{"wr"}
	assign		$tmp2598.z $tmp2607 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2608 ___550_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2609 $tmp2608 $const11 	%argrw{"wrr"}
	assign		$tmp2610 $tmp2609 	%argrw{"wr"}
	assign		$tmp2598.w $tmp2610 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5428 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2611.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2611.x $tmp2598.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2611.y $tmp2598.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2611.z $tmp2598.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2611.w $tmp2598.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5438 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2613.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2612.x ___550_p.x $tmp2613.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2612.y ___550_p.y $tmp2613.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2612.z ___550_p.z $tmp2613.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2612.w ___550_p.w $tmp2613.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5443 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2612.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2612.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2612.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2612.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2614 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2597 $const13 $tmp2614 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	fabs		$tmp2596 $tmp2597 	%line{275} %argrw{"wr"}
	sub		___550_signal Offset $tmp2596 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_signal 	%argrw{"wrr"}
	assign		___550_value ___550_signal 	%argrw{"wr"}
	assign		___550_weight $const17 	%argrw{"wr"}
	...
	le		$tmp2616 ___551_i $tmp2615 	%argrw{"wrr"}
	neq		$tmp2617 $tmp2616 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5465 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2618.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___550_p.x ___550_p.x $tmp2618.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___550_p.y ___550_p.y $tmp2618.y 	%argrw{"wrr"}
	mul		___550_p.z ___550_p.z $tmp2618.z 	%argrw{"wrr"}
	mul		___550_p.w ___550_p.w $tmp2618.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	mul		$tmp2619 ___550_signal Gain 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"wrr"}
	functioncall	$const3 5469 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2620 $tmp2619 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___550_weight $tmp2620 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	functioncall	$const9 5513 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2624 ___550_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2625 $tmp2624 $const11 	%argrw{"wrr"}
	assign		$tmp2626 $tmp2625 	%argrw{"wr"}
	assign		$tmp2623.x $tmp2626 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2627 ___550_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2628 $tmp2627 $const11 	%argrw{"wrr"}
	assign		$tmp2629 $tmp2628 	%argrw{"wr"}
	assign		$tmp2623.y $tmp2629 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2630 ___550_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2631 $tmp2630 $const11 	%argrw{"wrr"}
	assign		$tmp2632 $tmp2631 	%argrw{"wr"}
	assign		$tmp2623.z $tmp2632 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2633 ___550_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2634 $tmp2633 $const11 	%argrw{"wrr"}
	assign		$tmp2635 $tmp2634 	%argrw{"wr"}
	assign		$tmp2623.w $tmp2635 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5496 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2636.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2636.x $tmp2623.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2636.y $tmp2623.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2636.z $tmp2623.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2636.w $tmp2623.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5506 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2638.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2637.x ___550_p.x $tmp2638.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2637.y ___550_p.y $tmp2638.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2637.z ___550_p.z $tmp2638.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2637.w ___550_p.w $tmp2638.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5511 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2637.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2637.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2637.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2637.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2639 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2622 $const13 $tmp2639 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	fabs		$tmp2621 $tmp2622 	%line{275} %argrw{"wr"}
	sub		___550_signal Offset $tmp2621 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_signal 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_weight 	%argrw{"wrr"}
	mul		$tmp2640 ___550_signal ___550_pwr 	%argrw{"wrr"}
	add		___550_value ___550_value $tmp2640 	%argrw{"wrr"}
	mul		___550_pwr ___550_pwr roughness 	%argrw{"wrr"}
	assign		$tmp2641 ___551_i 	%argrw{"wr"}
	add		___551_i ___551_i $const19 	%argrw{"wrr"}
	assign		$tmp2421 ___550_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	assign		___513_p.x $tmp2422.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"wr"}
	assign		___513_p.y $tmp2422.y 	%argrw{"wr"}
	assign		___513_p.z $tmp2422.z 	%argrw{"wr"}
	assign		___513_p.w $tmp2422.w 	%argrw{"wr"}
	assign		___513_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 5576 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2645 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2646 $tmp2645 $const11 	%argrw{"wrr"}
	assign		$tmp2647 $tmp2646 	%argrw{"wr"}
	assign		$tmp2644.x $tmp2647 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2648 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2649 $tmp2648 $const11 	%argrw{"wrr"}
	assign		$tmp2650 $tmp2649 	%argrw{"wr"}
	assign		$tmp2644.y $tmp2650 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2651 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2652 $tmp2651 $const11 	%argrw{"wrr"}
	assign		$tmp2653 $tmp2652 	%argrw{"wr"}
	assign		$tmp2644.z $tmp2653 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2654 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2655 $tmp2654 $const11 	%argrw{"wrr"}
	assign		$tmp2656 $tmp2655 	%argrw{"wr"}
	assign		$tmp2644.w $tmp2656 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5559 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2657.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2657.x $tmp2644.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2657.y $tmp2644.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2657.z $tmp2644.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2657.w $tmp2644.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5569 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2659.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2658.x ___513_p.x $tmp2659.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2658.y ___513_p.y $tmp2659.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2658.z ___513_p.z $tmp2659.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2658.w ___513_p.w $tmp2659.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5574 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2658.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2658.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2658.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2658.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2660 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2643 $const13 $tmp2660 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		___513_value Offset $tmp2643 	%line{261} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5587 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2661.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___513_p.x ___513_p.x $tmp2661.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___513_p.y ___513_p.y $tmp2661.y 	%argrw{"wrr"}
	mul		___513_p.z ___513_p.z $tmp2661.z 	%argrw{"wrr"}
	mul		___513_p.w ___513_p.w $tmp2661.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	for		$tmp2664 5589 5592 5651 5653 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"r"}
	assign		___514_i $const19 	%argrw{"wr"}
	assign		$tmp2662 detail 	%argrw{"wr"}
	le		$tmp2663 ___514_i $tmp2662 	%argrw{"wrr"}
	neq		$tmp2664 $tmp2663 $const18 	%argrw{"wrr"}
	functioncall	$const9 5636 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2667 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2668 $tmp2667 $const11 	%argrw{"wrr"}
	assign		$tmp2669 $tmp2668 	%argrw{"wr"}
	assign		$tmp2666.x $tmp2669 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2670 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2671 $tmp2670 $const11 	%argrw{"wrr"}
	assign		$tmp2672 $tmp2671 	%argrw{"wr"}
	assign		$tmp2666.y $tmp2672 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2673 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2674 $tmp2673 $const11 	%argrw{"wrr"}
	assign		$tmp2675 $tmp2674 	%argrw{"wr"}
	assign		$tmp2666.z $tmp2675 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2676 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2677 $tmp2676 $const11 	%argrw{"wrr"}
	assign		$tmp2678 $tmp2677 	%argrw{"wr"}
	assign		$tmp2666.w $tmp2678 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5619 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2679.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2679.x $tmp2666.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2679.y $tmp2666.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2679.z $tmp2666.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2679.w $tmp2666.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5629 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2681.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2680.x ___513_p.x $tmp2681.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2680.y ___513_p.y $tmp2681.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2680.z ___513_p.z $tmp2681.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2680.w ___513_p.w $tmp2681.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5634 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2680.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2680.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2680.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2680.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2682 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2665 $const13 $tmp2682 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		$tmp2683 $tmp2665 Offset 	%line{261} %argrw{"wrr"}
	mul		$tmp2684 $tmp2683 ___513_pwr 	%argrw{"wrr"}
	mul		___515_increment $tmp2684 ___513_value 	%argrw{"wrr"}
	add		___513_value ___513_value ___515_increment 	%argrw{"wrr"}
	mul		___513_pwr ___513_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5651 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2685.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___513_p.x ___513_p.x $tmp2685.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___513_p.y ___513_p.y $tmp2685.y 	%argrw{"wrr"}
	mul		___513_p.z ___513_p.z $tmp2685.z 	%argrw{"wrr"}
	mul		___513_p.w ___513_p.w $tmp2685.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	assign		$tmp2686 ___514_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"wr"}
	add		___514_i ___514_i $const19 	%argrw{"wrr"}
	floor		$tmp2687 detail 	%argrw{"wr"}
	sub		___513_rmd detail $tmp2687 	%argrw{"wrr"}
	neq		$tmp2688 ___513_rmd $const1 	%argrw{"wrr"}
	if		$tmp2688 5706 5706 	%argrw{"r"}
	functioncall	$const9 5701 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2691 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2692 $tmp2691 $const11 	%argrw{"wrr"}
	assign		$tmp2693 $tmp2692 	%argrw{"wr"}
	assign		$tmp2690.x $tmp2693 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2694 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2695 $tmp2694 $const11 	%argrw{"wrr"}
	assign		$tmp2696 $tmp2695 	%argrw{"wr"}
	assign		$tmp2690.y $tmp2696 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2697 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2698 $tmp2697 $const11 	%argrw{"wrr"}
	assign		$tmp2699 $tmp2698 	%argrw{"wr"}
	assign		$tmp2690.z $tmp2699 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2700 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2701 $tmp2700 $const11 	%argrw{"wrr"}
	assign		$tmp2702 $tmp2701 	%argrw{"wr"}
	assign		$tmp2690.w $tmp2702 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5684 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2703.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2703.x $tmp2690.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2703.y $tmp2690.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2703.z $tmp2690.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2703.w $tmp2690.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5694 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2705.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2704.x ___513_p.x $tmp2705.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2704.y ___513_p.y $tmp2705.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2704.z ___513_p.z $tmp2705.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2704.w ___513_p.w $tmp2705.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5699 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2704.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2704.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2704.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2704.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2706 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2689 $const13 $tmp2706 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		$tmp2707 $tmp2689 Offset 	%line{261} %argrw{"wrr"}
	mul		$tmp2708 $tmp2707 ___513_pwr 	%argrw{"wrr"}
	mul		___516_increment $tmp2708 ___513_value 	%argrw{"wrr"}
	mul		$tmp2709 ___513_rmd ___516_increment 	%argrw{"wrr"}
	add		___513_value ___513_value $tmp2709 	%argrw{"wrr"}
	assign		$tmp2421 ___513_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:227
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		$tmp2711.x ___614_p.x $tmp2712.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		$tmp2711.y ___614_p.y $tmp2712.y 	%argrw{"wrr"}
	add		$tmp2711.z ___614_p.z $tmp2712.z 	%argrw{"wrr"}
	add		$tmp2711.w ___614_p.w $tmp2712.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:227
#                 noise_select(p + random_vector4_offset(5.0),
	functioncall	$const14 6480 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{227} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	assign		___497_p.x $tmp2711.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{254} %argrw{"wr"}
	assign		___497_p.y $tmp2711.y 	%argrw{"wr"}
	assign		___497_p.z $tmp2711.z 	%argrw{"wr"}
	assign		___497_p.w $tmp2711.w 	%argrw{"wr"}
	assign		___497_value $const17 	%argrw{"wr"}
	assign		___497_pwr $const17 	%argrw{"wr"}
	for		$tmp2724 5741 5744 5802 5804 	%argrw{"r"}
	assign		___498_i $const18 	%argrw{"wr"}
	assign		$tmp2722 detail 	%argrw{"wr"}
	le		$tmp2723 ___498_i $tmp2722 	%argrw{"wrr"}
	neq		$tmp2724 $tmp2723 $const18 	%argrw{"wrr"}
	functioncall	$const9 5788 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2727 ___497_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2728 $tmp2727 $const11 	%argrw{"wrr"}
	assign		$tmp2729 $tmp2728 	%argrw{"wr"}
	assign		$tmp2726.x $tmp2729 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2730 ___497_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2731 $tmp2730 $const11 	%argrw{"wrr"}
	assign		$tmp2732 $tmp2731 	%argrw{"wr"}
	assign		$tmp2726.y $tmp2732 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2733 ___497_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2734 $tmp2733 $const11 	%argrw{"wrr"}
	assign		$tmp2735 $tmp2734 	%argrw{"wr"}
	assign		$tmp2726.z $tmp2735 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2736 ___497_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2737 $tmp2736 $const11 	%argrw{"wrr"}
	assign		$tmp2738 $tmp2737 	%argrw{"wr"}
	assign		$tmp2726.w $tmp2738 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5771 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2739.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2739.x $tmp2726.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2739.y $tmp2726.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2739.z $tmp2726.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2739.w $tmp2726.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5781 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2741.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2740.x ___497_p.x $tmp2741.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2740.y ___497_p.y $tmp2741.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2740.z ___497_p.z $tmp2741.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2740.w ___497_p.w $tmp2741.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5786 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2740.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2740.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2740.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2740.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2742 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2725 $const13 $tmp2742 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	mul		$tmp2743 ___497_pwr $tmp2725 	%line{254} %argrw{"wrr"}
	add		$tmp2744 $tmp2743 $const17 	%argrw{"wrr"}
	mul		___497_value ___497_value $tmp2744 	%argrw{"wrr"}
	mul		___497_pwr ___497_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5802 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2745.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___497_p.x ___497_p.x $tmp2745.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___497_p.y ___497_p.y $tmp2745.y 	%argrw{"wrr"}
	mul		___497_p.z ___497_p.z $tmp2745.z 	%argrw{"wrr"}
	mul		___497_p.w ___497_p.w $tmp2745.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	assign		$tmp2746 ___498_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{254} %argrw{"wr"}
	add		___498_i ___498_i $const19 	%argrw{"wrr"}
	floor		$tmp2747 detail 	%argrw{"wr"}
	sub		___497_rmd detail $tmp2747 	%argrw{"wrr"}
	neq		$tmp2748 ___497_rmd $const1 	%argrw{"wrr"}
	if		$tmp2748 5856 5856 	%argrw{"r"}
	mul		$tmp2749 ___497_rmd ___497_pwr 	%argrw{"wrr"}
	functioncall	$const9 5853 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2752 ___497_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2753 $tmp2752 $const11 	%argrw{"wrr"}
	assign		$tmp2754 $tmp2753 	%argrw{"wr"}
	assign		$tmp2751.x $tmp2754 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2755 ___497_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2756 $tmp2755 $const11 	%argrw{"wrr"}
	assign		$tmp2757 $tmp2756 	%argrw{"wr"}
	assign		$tmp2751.y $tmp2757 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2758 ___497_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2759 $tmp2758 $const11 	%argrw{"wrr"}
	assign		$tmp2760 $tmp2759 	%argrw{"wr"}
	assign		$tmp2751.z $tmp2760 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2761 ___497_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2762 $tmp2761 $const11 	%argrw{"wrr"}
	assign		$tmp2763 $tmp2762 	%argrw{"wr"}
	assign		$tmp2751.w $tmp2763 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5836 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2764.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2764.x $tmp2751.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2764.y $tmp2751.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2764.z $tmp2751.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2764.w $tmp2751.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5846 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2766.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2765.x ___497_p.x $tmp2766.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2765.y ___497_p.y $tmp2766.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2765.z ___497_p.z $tmp2766.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2765.w ___497_p.w $tmp2766.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5851 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2765.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2765.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2765.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2765.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2767 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2750 $const13 $tmp2767 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:254
# NOISE_MULTI_FRACTAL(vector4)
	mul		$tmp2768 $tmp2749 $tmp2750 	%line{254} %argrw{"wrr"}
	add		$tmp2769 $tmp2768 $const17 	%argrw{"wrr"}
	mul		___497_value ___497_value $tmp2769 	%argrw{"wrr"}
	assign		$tmp2710 ___497_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	assign		___480_p.x $tmp2711.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"wr"}
	assign		___480_p.y $tmp2711.y 	%argrw{"wr"}
	assign		___480_p.z $tmp2711.z 	%argrw{"wr"}
	assign		___480_p.w $tmp2711.w 	%argrw{"wr"}
	assign		___480_fscale $const17 	%argrw{"wr"}
	assign		___480_amp $const17 	%argrw{"wr"}
	assign		___480_maxamp $const1 	%argrw{"wr"}
	assign		___480_sum $const1 	%argrw{"wr"}
	...
	le		$tmp2772 ___481_i $tmp2771 	%argrw{"wrr"}
	neq		$tmp2773 $tmp2772 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5884 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2775.x ___480_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
	assign		$tmp2775.y ___480_fscale 	%argrw{"wr"}
	assign		$tmp2775.z ___480_fscale 	%argrw{"wr"}
	assign		$tmp2775.w ___480_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5884 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		$tmp2774.x $tmp2775.x ___480_p.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		$tmp2774.y $tmp2775.y ___480_p.y 	%argrw{"wrr"}
	mul		$tmp2774.z $tmp2775.z ___480_p.z 	%argrw{"wrr"}
	mul		$tmp2774.w $tmp2775.w ___480_p.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	functioncall	$const9 5928 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5911 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2789.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2789.x $tmp2776.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2789.y $tmp2776.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2789.z $tmp2776.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2789.w $tmp2776.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5921 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2791.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5926 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2790.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2790.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2790.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2790.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2792 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		___482_t $const13 $tmp2792 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	mul		$tmp2793 ___482_t ___480_amp 	%line{247} %argrw{"wrr"}
	add		___480_sum ___480_sum $tmp2793 	%argrw{"wrr"}
	add		___480_maxamp ___480_maxamp ___480_amp 	%argrw{"wrr"}
	mul		___480_amp ___480_amp roughness 	%argrw{"wrr"}
	mul		___480_fscale ___480_fscale Lacunarity 	%argrw{"wrr"}
	assign		$tmp2794 ___481_i 	%argrw{"wr"}
	add		___481_i ___481_i $const19 	%argrw{"wrr"}
	floor		$tmp2795 detail 	%argrw{"wr"}
	sub		___480_rmd detail $tmp2795 	%argrw{"wrr"}
	neq		$tmp2796 ___480_rmd $const1 	%argrw{"wrr"}
	if		$tmp2796 6006 6012 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5949 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2798.x ___480_fscale 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
	assign		$tmp2798.y ___480_fscale 	%argrw{"wr"}
	assign		$tmp2798.z ___480_fscale 	%argrw{"wr"}
	assign		$tmp2798.w ___480_fscale 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5949 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		$tmp2797.x $tmp2798.x ___480_p.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		$tmp2797.y $tmp2798.y ___480_p.y 	%argrw{"wrr"}
	mul		$tmp2797.z $tmp2798.z ___480_p.z 	%argrw{"wrr"}
	mul		$tmp2797.w $tmp2798.w ___480_p.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	functioncall	$const9 5993 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{247} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 5976 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2812.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2812.x $tmp2799.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2812.y $tmp2799.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2812.z $tmp2799.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2812.w $tmp2799.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 5986 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2814.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 5991 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2813.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2813.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2813.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2813.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2815 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		___483_t $const13 $tmp2815 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:247
# NOISE_FBM(vector4)
	mul		$tmp2816 ___483_t ___480_amp 	%line{247} %argrw{"wrr"}
	add		___483_sum2 ___480_sum $tmp2816 	%argrw{"wrr"}
	if		use_normalize 6004 6005 	%argrw{"r"}
	mul		$tmp2817 $const10 ___480_sum 	%argrw{"wrr"}
	div		$tmp2818 $tmp2817 ___480_maxamp 	%argrw{"wrr"}
	add		$tmp2819 $tmp2818 $const10 	%argrw{"wrr"}
	mul		$tmp2820 $const10 ___483_sum2 	%argrw{"wrr"}
	add		$tmp2821 ___480_maxamp ___480_amp 	%argrw{"wrr"}
	div		$tmp2822 $tmp2820 $tmp2821 	%argrw{"wrr"}
	add		$tmp2823 $tmp2822 $const10 	%argrw{"wrr"}
	mix		$tmp2710 $tmp2819 $tmp2823 ___480_rmd 	%argrw{"wrrr"}
	mix		$tmp2710 ___480_sum ___483_sum2 ___480_rmd 	%argrw{"wrrr"}
	return
	if		use_normalize 6010 6011 	%argrw{"r"}
	mul		$tmp2824 $const10 ___480_sum 	%argrw{"wrr"}
	div		$tmp2825 $tmp2824 ___480_maxamp 	%argrw{"wrr"}
	add		$tmp2710 $tmp2825 $const10 	%argrw{"wrr"}
	assign		$tmp2710 ___480_sum 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	assign		___535_p.x $tmp2711.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{268} %argrw{"wr"}
	assign		___535_p.y $tmp2711.y 	%argrw{"wr"}
	assign		___535_p.z $tmp2711.z 	%argrw{"wr"}
	assign		___535_p.w $tmp2711.w 	%argrw{"wr"}
	assign		___535_pwr $const17 	%argrw{"wr"}
	assign		___535_value $const1 	%argrw{"wr"}
	assign		___535_weight $const17 	%argrw{"wr"}
	for		$tmp2832 6025 6033 6097 6099 	%argrw{"r"}
	assign		___536_i $const18 	%argrw{"wr"}
	gt		$tmp2827 ___535_weight $const24 	%argrw{"wrr"}
	neq		$tmp2828 $tmp2827 $const18 	%argrw{"wrr"}
	if		$tmp2828 6032 6032 	%argrw{"r"}
	assign		$tmp2829 detail 	%argrw{"wr"}
	le		$tmp2830 ___536_i $tmp2829 	%argrw{"wrr"}
	neq		$tmp2831 $tmp2830 $const18 	%argrw{"wrr"}
	assign		$tmp2828 $tmp2831 	%argrw{"wr"}
	neq		$tmp2832 $tmp2828 $const18 	%argrw{"wrr"}
	gt		$tmp2833 ___535_weight $const17 	%argrw{"wrr"}
	if		$tmp2833 6036 6036 	%argrw{"r"}
	assign		___535_weight $const17 	%argrw{"wr"}
	functioncall	$const9 6080 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2836 ___535_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2837 $tmp2836 $const11 	%argrw{"wrr"}
	assign		$tmp2838 $tmp2837 	%argrw{"wr"}
	assign		$tmp2835.x $tmp2838 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2839 ___535_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2840 $tmp2839 $const11 	%argrw{"wrr"}
	assign		$tmp2841 $tmp2840 	%argrw{"wr"}
	assign		$tmp2835.y $tmp2841 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2842 ___535_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2843 $tmp2842 $const11 	%argrw{"wrr"}
	assign		$tmp2844 $tmp2843 	%argrw{"wr"}
	assign		$tmp2835.z $tmp2844 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2845 ___535_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2846 $tmp2845 $const11 	%argrw{"wrr"}
	assign		$tmp2847 $tmp2846 	%argrw{"wr"}
	assign		$tmp2835.w $tmp2847 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6063 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2848.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2848.x $tmp2835.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2848.y $tmp2835.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2848.z $tmp2835.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2848.w $tmp2835.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 6073 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2850.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2849.x ___535_p.x $tmp2850.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2849.y ___535_p.y $tmp2850.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2849.z ___535_p.z $tmp2850.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2849.w ___535_p.w $tmp2850.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 6078 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2849.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2849.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2849.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2849.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2851 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2834 $const13 $tmp2851 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	add		$tmp2852 $tmp2834 Offset 	%line{268} %argrw{"wrr"}
	mul		___537_signal $tmp2852 ___535_pwr 	%argrw{"wrr"}
	mul		___535_pwr ___535_pwr roughness 	%argrw{"wrr"}
	mul		$tmp2853 ___535_weight ___537_signal 	%argrw{"wrr"}
	add		___535_value ___535_value $tmp2853 	%argrw{"wrr"}
	mul		$tmp2854 Gain ___537_signal 	%argrw{"wrr"}
	mul		___535_weight ___535_weight $tmp2854 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6097 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2855.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___535_p.x ___535_p.x $tmp2855.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___535_p.y ___535_p.y $tmp2855.y 	%argrw{"wrr"}
	mul		___535_p.z ___535_p.z $tmp2855.z 	%argrw{"wrr"}
	mul		___535_p.w ___535_p.w $tmp2855.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	assign		$tmp2856 ___536_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{268} %argrw{"wr"}
	add		___536_i ___536_i $const19 	%argrw{"wrr"}
	floor		$tmp2857 detail 	%argrw{"wr"}
	sub		___535_rmd detail $tmp2857 	%argrw{"wrr"}
	neq		$tmp2858 ___535_rmd $const1 	%argrw{"wrr"}
	neq		$tmp2859 $tmp2858 $const18 	%argrw{"wrr"}
	if		$tmp2859 6107 6107 	%argrw{"r"}
	gt		$tmp2860 ___535_weight $const24 	%argrw{"wrr"}
	neq		$tmp2861 $tmp2860 $const18 	%argrw{"wrr"}
	assign		$tmp2859 $tmp2861 	%argrw{"wr"}
	if		$tmp2859 6160 6160 	%argrw{"r"}
	gt		$tmp2862 ___535_weight $const17 	%argrw{"wrr"}
	if		$tmp2862 6111 6111 	%argrw{"r"}
	assign		___535_weight $const17 	%argrw{"wr"}
	functioncall	$const9 6155 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2865 ___535_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2866 $tmp2865 $const11 	%argrw{"wrr"}
	assign		$tmp2867 $tmp2866 	%argrw{"wr"}
	assign		$tmp2864.x $tmp2867 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2868 ___535_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2869 $tmp2868 $const11 	%argrw{"wrr"}
	assign		$tmp2870 $tmp2869 	%argrw{"wr"}
	assign		$tmp2864.y $tmp2870 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2871 ___535_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2872 $tmp2871 $const11 	%argrw{"wrr"}
	assign		$tmp2873 $tmp2872 	%argrw{"wr"}
	assign		$tmp2864.z $tmp2873 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2874 ___535_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2875 $tmp2874 $const11 	%argrw{"wrr"}
	assign		$tmp2876 $tmp2875 	%argrw{"wr"}
	assign		$tmp2864.w $tmp2876 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6138 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2877.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2877.x $tmp2864.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2877.y $tmp2864.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2877.z $tmp2864.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2877.w $tmp2864.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 6148 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2879.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2878.x ___535_p.x $tmp2879.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2878.y ___535_p.y $tmp2879.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2878.z ___535_p.z $tmp2879.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2878.w ___535_p.w $tmp2879.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 6153 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2878.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2878.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2878.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2878.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2880 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2863 $const13 $tmp2880 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:268
# NOISE_HYBRID_MULTI_FRACTAL(vector4)
	add		$tmp2881 $tmp2863 Offset 	%line{268} %argrw{"wrr"}
	mul		___539_signal $tmp2881 ___535_pwr 	%argrw{"wrr"}
	mul		$tmp2882 ___535_rmd ___535_weight 	%argrw{"wrr"}
	mul		$tmp2883 $tmp2882 ___539_signal 	%argrw{"wrr"}
	add		___535_value ___535_value $tmp2883 	%argrw{"wrr"}
	assign		$tmp2710 ___535_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	assign		___550_p.x $tmp2711.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"wr"}
	assign		___550_p.y $tmp2711.y 	%argrw{"wr"}
	assign		___550_p.z $tmp2711.z 	%argrw{"wr"}
	assign		___550_p.w $tmp2711.w 	%argrw{"wr"}
	assign		___550_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 6214 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2888 ___550_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2889 $tmp2888 $const11 	%argrw{"wrr"}
	assign		$tmp2890 $tmp2889 	%argrw{"wr"}
	assign		$tmp2887.x $tmp2890 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2891 ___550_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2892 $tmp2891 $const11 	%argrw{"wrr"}
	assign		$tmp2893 $tmp2892 	%argrw{"wr"}
	assign		$tmp2887.y $tmp2893 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2894 ___550_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2895 $tmp2894 $const11 	%argrw{"wrr"}
	assign		$tmp2896 $tmp2895 	%argrw{"wr"}
	assign		$tmp2887.z $tmp2896 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2897 ___550_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2898 $tmp2897 $const11 	%argrw{"wrr"}
	assign		$tmp2899 $tmp2898 	%argrw{"wr"}
	assign		$tmp2887.w $tmp2899 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6197 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2900.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2900.x $tmp2887.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2900.y $tmp2887.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2900.z $tmp2887.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2900.w $tmp2887.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 6207 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2902.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2901.x ___550_p.x $tmp2902.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2901.y ___550_p.y $tmp2902.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2901.z ___550_p.z $tmp2902.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2901.w ___550_p.w $tmp2902.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 6212 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2901.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2901.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2901.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2901.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2903 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2886 $const13 $tmp2903 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	fabs		$tmp2885 $tmp2886 	%line{275} %argrw{"wr"}
	sub		___550_signal Offset $tmp2885 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_signal 	%argrw{"wrr"}
	assign		___550_value ___550_signal 	%argrw{"wr"}
	assign		___550_weight $const17 	%argrw{"wr"}
	...
	le		$tmp2905 ___551_i $tmp2904 	%argrw{"wrr"}
	neq		$tmp2906 $tmp2905 $const18 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6234 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2907.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___550_p.x ___550_p.x $tmp2907.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___550_p.y ___550_p.y $tmp2907.y 	%argrw{"wrr"}
	mul		___550_p.z ___550_p.z $tmp2907.z 	%argrw{"wrr"}
	mul		___550_p.w ___550_p.w $tmp2907.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	mul		$tmp2908 ___550_signal Gain 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"wrr"}
	functioncall	$const3 6238 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2909 $tmp2908 $const17 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___550_weight $tmp2909 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	functioncall	$const9 6282 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{275} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2913 ___550_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2914 $tmp2913 $const11 	%argrw{"wrr"}
	assign		$tmp2915 $tmp2914 	%argrw{"wr"}
	assign		$tmp2912.x $tmp2915 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2916 ___550_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2917 $tmp2916 $const11 	%argrw{"wrr"}
	assign		$tmp2918 $tmp2917 	%argrw{"wr"}
	assign		$tmp2912.y $tmp2918 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2919 ___550_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2920 $tmp2919 $const11 	%argrw{"wrr"}
	assign		$tmp2921 $tmp2920 	%argrw{"wr"}
	assign		$tmp2912.z $tmp2921 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2922 ___550_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2923 $tmp2922 $const11 	%argrw{"wrr"}
	assign		$tmp2924 $tmp2923 	%argrw{"wr"}
	assign		$tmp2912.w $tmp2924 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6265 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2925.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2925.x $tmp2912.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2925.y $tmp2912.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2925.z $tmp2912.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2925.w $tmp2912.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 6275 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2927.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2926.x ___550_p.x $tmp2927.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2926.y ___550_p.y $tmp2927.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2926.z ___550_p.z $tmp2927.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2926.w ___550_p.w $tmp2927.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 6280 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2926.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2926.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2926.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2926.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2928 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2911 $const13 $tmp2928 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:275
# NOISE_RIDGED_MULTI_FRACTAL(vector4)
	fabs		$tmp2910 $tmp2911 	%line{275} %argrw{"wr"}
	sub		___550_signal Offset $tmp2910 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_signal 	%argrw{"wrr"}
	mul		___550_signal ___550_signal ___550_weight 	%argrw{"wrr"}
	mul		$tmp2929 ___550_signal ___550_pwr 	%argrw{"wrr"}
	add		___550_value ___550_value $tmp2929 	%argrw{"wrr"}
	mul		___550_pwr ___550_pwr roughness 	%argrw{"wrr"}
	assign		$tmp2930 ___551_i 	%argrw{"wr"}
	add		___551_i ___551_i $const19 	%argrw{"wrr"}
	assign		$tmp2710 ___550_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	assign		___513_p.x $tmp2711.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"wr"}
	assign		___513_p.y $tmp2711.y 	%argrw{"wr"}
	assign		___513_p.z $tmp2711.z 	%argrw{"wr"}
	assign		___513_p.w $tmp2711.w 	%argrw{"wr"}
	assign		___513_pwr roughness 	%argrw{"wr"}
	functioncall	$const9 6345 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2934 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2935 $tmp2934 $const11 	%argrw{"wrr"}
	assign		$tmp2936 $tmp2935 	%argrw{"wr"}
	assign		$tmp2933.x $tmp2936 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2937 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2938 $tmp2937 $const11 	%argrw{"wrr"}
	assign		$tmp2939 $tmp2938 	%argrw{"wr"}
	assign		$tmp2933.y $tmp2939 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2940 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2941 $tmp2940 $const11 	%argrw{"wrr"}
	assign		$tmp2942 $tmp2941 	%argrw{"wr"}
	assign		$tmp2933.z $tmp2942 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2943 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2944 $tmp2943 $const11 	%argrw{"wrr"}
	assign		$tmp2945 $tmp2944 	%argrw{"wr"}
	assign		$tmp2933.w $tmp2945 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6328 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2946.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2946.x $tmp2933.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2946.y $tmp2933.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2946.z $tmp2933.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2946.w $tmp2933.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 6338 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2948.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2947.x ___513_p.x $tmp2948.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2947.y ___513_p.y $tmp2948.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2947.z ___513_p.z $tmp2948.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2947.w ___513_p.w $tmp2948.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 6343 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2947.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2947.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2947.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2947.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2949 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2932 $const13 $tmp2949 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		___513_value Offset $tmp2932 	%line{261} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6356 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2950.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___513_p.x ___513_p.x $tmp2950.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___513_p.y ___513_p.y $tmp2950.y 	%argrw{"wrr"}
	mul		___513_p.z ___513_p.z $tmp2950.z 	%argrw{"wrr"}
	mul		___513_p.w ___513_p.w $tmp2950.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	for		$tmp2953 6358 6361 6420 6422 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"r"}
	assign		___514_i $const19 	%argrw{"wr"}
	assign		$tmp2951 detail 	%argrw{"wr"}
	le		$tmp2952 ___514_i $tmp2951 	%argrw{"wrr"}
	neq		$tmp2953 $tmp2952 $const18 	%argrw{"wrr"}
	functioncall	$const9 6405 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2956 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2957 $tmp2956 $const11 	%argrw{"wrr"}
	assign		$tmp2958 $tmp2957 	%argrw{"wr"}
	assign		$tmp2955.x $tmp2958 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2959 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2960 $tmp2959 $const11 	%argrw{"wrr"}
	assign		$tmp2961 $tmp2960 	%argrw{"wr"}
	assign		$tmp2955.y $tmp2961 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2962 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2963 $tmp2962 $const11 	%argrw{"wrr"}
	assign		$tmp2964 $tmp2963 	%argrw{"wr"}
	assign		$tmp2955.z $tmp2964 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2965 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2966 $tmp2965 $const11 	%argrw{"wrr"}
	assign		$tmp2967 $tmp2966 	%argrw{"wr"}
	assign		$tmp2955.w $tmp2967 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6388 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2968.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2968.x $tmp2955.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2968.y $tmp2955.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2968.z $tmp2955.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2968.w $tmp2955.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 6398 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2970.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2969.x ___513_p.x $tmp2970.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2969.y ___513_p.y $tmp2970.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2969.z ___513_p.z $tmp2970.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2969.w ___513_p.w $tmp2970.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 6403 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2969.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2969.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2969.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2969.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2971 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2954 $const13 $tmp2971 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		$tmp2972 $tmp2954 Offset 	%line{261} %argrw{"wrr"}
	mul		$tmp2973 $tmp2972 ___513_pwr 	%argrw{"wrr"}
	mul		___515_increment $tmp2973 ___513_value 	%argrw{"wrr"}
	add		___513_value ___513_value ___515_increment 	%argrw{"wrr"}
	mul		___513_pwr ___513_pwr roughness 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6420 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:91
#     return a * vector4(b, b, b, b);
	assign		$tmp2974.x Lacunarity 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{91} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___513_p.x ___513_p.x $tmp2974.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___513_p.y ___513_p.y $tmp2974.y 	%argrw{"wrr"}
	mul		___513_p.z ___513_p.z $tmp2974.z 	%argrw{"wrr"}
	mul		___513_p.w ___513_p.w $tmp2974.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	assign		$tmp2975 ___514_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{261} %argrw{"wr"}
	add		___514_i ___514_i $const19 	%argrw{"wrr"}
	floor		$tmp2976 detail 	%argrw{"wr"}
	sub		___513_rmd detail $tmp2976 	%argrw{"wrr"}
	neq		$tmp2977 ___513_rmd $const1 	%argrw{"wrr"}
	if		$tmp2977 6475 6475 	%argrw{"r"}
	functioncall	$const9 6470 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:96
#   vector4 precision_correction = 0.5 * vector4(float(fabs(co.x) >= 1000000.0),
	fabs		$tmp2980 ___513_p.x 	%line{96} %argrw{"wr"}
	ge		$tmp2981 $tmp2980 $const11 	%argrw{"wrr"}
	assign		$tmp2982 $tmp2981 	%argrw{"wr"}
	assign		$tmp2979.x $tmp2982 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:97
#                                                float(fabs(co.y) >= 1000000.0),
	fabs		$tmp2983 ___513_p.y 	%line{97} %argrw{"wr"}
	ge		$tmp2984 $tmp2983 $const11 	%argrw{"wrr"}
	assign		$tmp2985 $tmp2984 	%argrw{"wr"}
	assign		$tmp2979.y $tmp2985 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:98
#                                                float(fabs(co.z) >= 1000000.0),
	fabs		$tmp2986 ___513_p.z 	%line{98} %argrw{"wr"}
	ge		$tmp2987 $tmp2986 $const11 	%argrw{"wrr"}
	assign		$tmp2988 $tmp2987 	%argrw{"wr"}
	assign		$tmp2979.z $tmp2988 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:99
#                                                float(fabs(co.w) >= 1000000.0));
	fabs		$tmp2989 ___513_p.w 	%line{99} %argrw{"wr"}
	ge		$tmp2990 $tmp2989 $const11 	%argrw{"wrr"}
	assign		$tmp2991 $tmp2990 	%argrw{"wr"}
	assign		$tmp2979.w $tmp2991 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const34 6453 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:101
#     return vector4(a, a, a, a) * b;
	assign		$tmp2992.x $const10 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{101} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:81
#     return vector4(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w);
	mul		___464_precision_correction.x $tmp2992.x $tmp2979.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{81} %argrw{"wrr"}
	mul		___464_precision_correction.y $tmp2992.y $tmp2979.y 	%argrw{"wrr"}
	mul		___464_precision_correction.z $tmp2992.z $tmp2979.z 	%argrw{"wrr"}
	mul		___464_precision_correction.w $tmp2992.w $tmp2979.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:103
#   vector4 p = fmod(co, 100000.0) + precision_correction;
	functioncall	$const35 6463 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{103} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:300
#     return fmod(a, vector4(b, b, b, b));
	assign		$tmp2994.x $const12 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{300} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:292
#     return vector4 (fmod(a.x, b.x),
	fmod		$tmp2993.x ___513_p.x $tmp2994.x 	%line{292} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:293
#                     fmod(a.y, b.y),
	fmod		$tmp2993.y ___513_p.y $tmp2994.y 	%line{293} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:294
#                     fmod(a.z, b.z),
	fmod		$tmp2993.z ___513_p.z $tmp2994.z 	%line{294} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:295
#                     fmod(a.w, b.w));
	fmod		$tmp2993.w ___513_p.w $tmp2994.w 	%line{295} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:301
# 
	functioncall	$const33 6468 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{301} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h:31
#     return vector4(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w);
	add		___464_p.x $tmp2993.x ___464_precision_correction.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector4.h"} %line{31} %argrw{"wrr"}
	add		___464_p.y $tmp2993.y ___464_precision_correction.y 	%argrw{"wrr"}
	add		___464_p.z $tmp2993.z ___464_precision_correction.z 	%argrw{"wrr"}
	add		___464_p.w $tmp2993.w ___464_precision_correction.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:105
#   return noise("snoise", vector3(p.x, p.y, p.z), p.w);
	point		$tmp2995 ___464_p.x ___464_p.y ___464_p.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h"} %line{105} %argrw{"wrrr"}
	noise		$tmp2978 $const13 $tmp2995 ___464_p.w 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_noise.h:261
# NOISE_HETERO_TERRAIN(vector4)
	add		$tmp2996 $tmp2978 Offset 	%line{261} %argrw{"wrr"}
	mul		$tmp2997 $tmp2996 ___513_pwr 	%argrw{"wrr"}
	mul		___516_increment $tmp2997 ___513_value 	%argrw{"wrr"}
	mul		$tmp2998 ___513_rmd ___516_increment 	%argrw{"wrr"}
	add		___513_value ___513_value $tmp2998 	%argrw{"wrr"}
	assign		$tmp2710 ___513_value 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:82
# NOISE_SELECT(vector4)
	return	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl"} %line{82}
	error		$const29 	%argrw{"r"}
	...
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:218
#   Color = color(value,
	color		Color ___614_value $tmp2421 $tmp2710 	%line{218} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:235
#   return value;
	assign		Fac ___614_value 	%line{235} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_noise_texture.osl:298
