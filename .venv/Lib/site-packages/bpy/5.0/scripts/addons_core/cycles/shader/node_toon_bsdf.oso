...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_toon_bsdf.oso
...
code Normal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_toon_bsdf.osl:11
#                       normal Normal = N,
	assign		Normal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_toon_bsdf.osl"} %line{11} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_toon_bsdf.osl:14
#   if (component == "diffuse")
	eq		$tmp1 component $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_toon_bsdf.osl"} %line{14} %argrw{"wrr"}
	if		$tmp1 5 9 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_toon_bsdf.osl:15
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_toon_bsdf.osl:16
#   else if (component == "glossy")
	eq		$tmp3 component $const3 	%line{16} %argrw{"wrr"}
	if		$tmp3 9 9 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_toon_bsdf.osl:17
