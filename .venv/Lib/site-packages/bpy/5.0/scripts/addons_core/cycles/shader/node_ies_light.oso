...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_ies_light.oso
...
code Vector
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:13
#                       point Vector = I,
	assign		Vector I 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl"} %line{13} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:16
#   point p = Vector;
	assign		p Vector 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl"} %line{16} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:18
#   if (use_mapping) {
	if		use_mapping 4 4 	%line{18} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:19
#     p = transform(mapping, p);
	transform	p mapping p 	%line{19} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:22
#   p = normalize((vector)p);
	normalize	p p 	%line{22} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:24
#   float v_angle = acos(-p[2]);
	compref		$tmp1 p $const1 	%line{24} %argrw{"wrr"}
	neg		$tmp2 $tmp1 	%argrw{"wr"}
	acos		v_angle $tmp2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:25
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ies_light.osl:27
