...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_uv_map.oso
shader node_uv_map
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:13
#   if (from_dupli) {
	if		from_dupli 2 6 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl"} %line{13} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:14
#     getattribute("geom:dupli_uv", UV);
	getattribute	$tmp1 $const1 UV 	%line{14} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:17
#     if (attribute == "")
	eq		$tmp2 attribute $const2 	%line{17} %argrw{"wrr"}
	if		$tmp2 5 6 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:18
#       getattribute("geom:uv", UV);
	getattribute	$tmp3 $const3 UV 	%line{18} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:20
#       getattribute(attribute, UV);
	getattribute	$tmp4 attribute UV 	%line{20} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:23
#   if (bump_offset == "dx") {
	eq		$tmp5 bump_offset $const4 	%line{23} %argrw{"wrr"}
	if		$tmp5 13 20 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:24
#     if (!from_dupli) {
	eq		$tmp6 from_dupli $const5 	%line{24} %argrw{"wrr"}
	if		$tmp6 13 13 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:25
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:28
#   else if (bump_offset == "dy") {
	eq		$tmp9 bump_offset $const6 	%line{28} %argrw{"wrr"}
	if		$tmp9 20 20 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:29
#     if (!from_dupli) {
	eq		$tmp10 from_dupli $const5 	%line{29} %argrw{"wrr"}
	if		$tmp10 20 20 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_uv_map.osl:30
