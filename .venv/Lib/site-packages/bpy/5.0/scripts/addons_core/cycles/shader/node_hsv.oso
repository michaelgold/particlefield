...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_hsv.oso
shader node_hsv
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:16
#   color Color = rgb_to_hsv(ColorIn);
	functioncall	$const1 46 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{16} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp1 ColorIn $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:18
#   Color[0] = fract(Color[0] + Hue + 0.5);
	compref		$tmp27 Color $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{18} %argrw{"wrr"}
	add		$tmp28 $tmp27 Hue 	%argrw{"wrr"}
	add		$tmp29 $tmp28 $const10 	%argrw{"wrr"}
	functioncall	$const11 52 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:61
#   return a - floor(a);
	floor		$tmp30 $tmp29 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{61} %argrw{"wr"}
	sub		$tmp26 $tmp29 $tmp30 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:18
#   Color[0] = fract(Color[0] + Hue + 0.5);
	compassign	Color $const2 $tmp26 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{18} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:19
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp34 $tmp33 $const9 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp31 $tmp34 $const5 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:19
#   Color[1] = clamp(Color[1] * Saturation, 0.0, 1.0);
	compassign	Color $const3 $tmp31 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{19} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:20
#   Color[2] *= Value;
	compref		$tmp35 Color $const4 	%line{20} %argrw{"wrr"}
	mul		$tmp36 $tmp35 Value 	%argrw{"wrr"}
	compassign	Color $const4 $tmp36 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:22
#   Color = hsv_to_rgb(Color);
	functioncall	$const13 102 	%line{22} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h Color $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:25
#   Color[0] = max(Color[0], 0.0);
	compref		$tmp51 Color $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl"} %line{25} %argrw{"wrr"}
	max		$tmp50 $tmp51 $const5 	%argrw{"wrr"}
	compassign	Color $const2 $tmp50 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:26
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:27
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hsv.osl:29
