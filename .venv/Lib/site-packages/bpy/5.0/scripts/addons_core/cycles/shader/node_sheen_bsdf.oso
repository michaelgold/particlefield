...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.oso
...
code Normal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl:11
#                        normal Normal = N,
	assign		Normal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl"} %line{11} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl:14
#   color base_color = max(Color, color(0.0));
	max		base_color Color $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl"} %line{14} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl:15
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl:17
#   if (distribution == "ashikhmin")
	eq		$tmp3 distribution $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl"} %line{17} %argrw{"wrr"}
	if		$tmp3 9 13 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl:18
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl:19
#   else if (distribution == "microfiber")
	eq		$tmp5 distribution $const7 	%line{19} %argrw{"wrr"}
	if		$tmp5 13 13 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_sheen_bsdf.osl:20
