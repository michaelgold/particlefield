...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_texture_coordinate.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:24
#   if (is_background) {
	if		is_background 13 54 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl"} %line{24} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:25
#     Generated = P;
	assign		Generated P 	%line{25} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:26
#     UV = point(0.0, 0.0, 0.0);
	assign		UV $const1 	%line{26} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:27
#     if (use_transform) {
	if		use_transform 5 6 	%line{27} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:28
#       Object = transform(object_itfm, P);
	transform	Object object_itfm P 	%line{28} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:31
#       Object = P;
	assign		Object P 	%line{31} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:33
#     point Pcam = transform("camera", "world", point(0, 0, 0));
	transform	___368_Pcam $const2 $const3 $const1 	%line{33} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:34
#     Camera = transform("camera", P + Pcam);
	add		$tmp2 P ___368_Pcam 	%line{34} %argrw{"wrr"}
	functioncall	$const4 10 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:263
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Camera $const5 $const2 $tmp2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:35
#     getattribute("NDC", Window);
	getattribute	$tmp3 $const6 Window 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl"} %line{35} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:36
#     Normal = N;
	assign		Normal N 	%line{36} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:37
#     Reflection = I;
	assign		Reflection I 	%line{37} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:40
#     if (from_dupli) {
	if		from_dupli 16 39 	%line{40} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:41
#       getattribute("geom:dupli_generated", Generated);
	getattribute	$tmp4 $const7 Generated 	%line{41} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:42
#       getattribute("geom:dupli_uv", UV);
	getattribute	$tmp5 $const8 UV 	%line{42} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:44
#     else if (is_volume) {
	if		is_volume 23 39 	%line{44} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:45
#       Generated = transform("object", P);
	functioncall	$const4 19 	%line{45} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:263
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Generated $const5 $const9 P 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:48
#       if (getattribute("geom:generated_transform", tfm))
	getattribute	$tmp6 $const10 ___373_tfm 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl"} %line{48} %argrw{"wrw"}
	if		$tmp6 22 22 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:49
#         Generated = transform(tfm, Generated);
	transform	Generated ___373_tfm Generated 	%line{49} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:51
#       getattribute("geom:uv", UV);
	getattribute	$tmp7 $const11 UV 	%line{51} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:54
#       if (!getattribute("geom:generated", Generated)) {
	getattribute	$tmp8 $const12 Generated 	%line{54} %argrw{"wrw"}
	eq		$tmp9 $tmp8 $const13 	%argrw{"wrr"}
	if		$tmp9 28 28 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:55
#         Generated = transform("object", P);
	functioncall	$const4 28 	%line{55} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:263
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Generated $const5 $const9 P 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:58
#       getattribute("object:is_light", is_light);
	getattribute	$tmp10 $const14 ___374_is_light 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl"} %line{58} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:59
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:60
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:64
#     if (use_transform) {
	if		use_transform 41 43 	%line{64} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:65
#       Object = transform(object_itfm, P);
	transform	Object object_itfm P 	%line{65} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:68
#       Object = transform("object", P);
	functioncall	$const4 43 	%line{68} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:263
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Object $const5 $const9 P 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:70
#     Camera = transform("camera", P);
	functioncall	$const4 45 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl"} %line{70} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:263
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Camera $const5 $const2 P 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:71
#     getattribute("NDC", Window);
	getattribute	$tmp17 $const6 Window 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl"} %line{71} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:72
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:73
...
# vector reflect (vector I, vector N) { return I - 2*dot(N,I)*N; }
	dot		$tmp20 N I 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{212} %argrw{"wrr"}
	mul		$tmp21 $const19 $tmp20 	%argrw{"wrr"}
	mul		$tmp22 $tmp21 N 	%argrw{"wrr"}
	sub		$tmp19 I $tmp22 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:73
#     Reflection = -reflect(I, N);
	neg		Reflection $tmp19 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl"} %line{73} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:76
#   if (bump_offset == "dx") {
	eq		$tmp23 bump_offset $const20 	%line{76} %argrw{"wrr"}
	if		$tmp23 79 104 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:77
#     if (!from_dupli) {
	eq		$tmp24 from_dupli $const13 	%line{77} %argrw{"wrr"}
	if		$tmp24 64 64 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:78
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:79
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:81
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:82
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:83
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:84
#     if (getattribute("geom:bump_map_normal", Normal)) {
	getattribute	$tmp35 $const21 Normal 	%line{84} %argrw{"wrw"}
	if		$tmp35 79 79 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:85
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:88
#   else if (bump_offset == "dy") {
	eq		$tmp39 bump_offset $const22 	%line{88} %argrw{"wrr"}
	if		$tmp39 104 104 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:89
#     if (!from_dupli) {
	eq		$tmp40 from_dupli $const13 	%line{89} %argrw{"wrr"}
	if		$tmp40 89 89 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:90
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:91
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:93
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:94
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:95
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:96
#     if (getattribute("geom:bump_map_normal", Normal)) {
	getattribute	$tmp51 $const21 Normal 	%line{96} %argrw{"wrw"}
	if		$tmp51 104 104 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:97
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_texture_coordinate.osl:101
#   Window[2] = 0.0;
