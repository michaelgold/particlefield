...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_principled_volume.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:22
#   float primitive_density = 1.0;
	assign		primitive_density $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl"} %line{22} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:23
#   float density = max(Density, 0.0);
	max		density Density $const2 	%line{23} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:25
#   if (density > 1e-5) {
	gt		$tmp1 density $const3 	%line{25} %argrw{"wrr"}
	if		$tmp1 8 8 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:26
#     if (getattribute(DensityAttribute, primitive_density)) {
	getattribute	$tmp2 DensityAttribute primitive_density 	%line{26} %argrw{"wrw"}
	if		$tmp2 8 8 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:27
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:31
#   if (density > 1e-5) {
	gt		$tmp4 density $const3 	%line{31} %argrw{"wrr"}
	if		$tmp4 32 32 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:33
#     color scatter_color = Color;
	assign		___370_scatter_color Color 	%line{33} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:35
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:36
#       scatter_color *= primitive_color;
	mul		___370_scatter_color ___370_scatter_color ___370_primitive_color 	%line{36} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:40
#     color scatter_coeff = scatter_color;
	assign		___370_scatter_coeff ___370_scatter_color 	%line{40} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:41
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:42
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:43
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:44
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:48
#   float emission_strength = max(EmissionStrength, 0.0);
	max		emission_strength EmissionStrength $const2 	%line{48} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:49
#   float blackbody_intensity = BlackbodyIntensity;
	assign		blackbody_intensity BlackbodyIntensity 	%line{49} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:51
#   if (emission_strength > 1e-5) {
	gt		$tmp20 emission_strength $const3 	%line{51} %argrw{"wrr"}
	if		$tmp20 40 40 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:52
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:55
#   if (blackbody_intensity > 1e-3) {
	gt		$tmp24 blackbody_intensity $const7 	%line{55} %argrw{"wrr"}
	if		$tmp24 66 66 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:56
#     float T = Temperature;
	assign		___373_T Temperature 	%line{56} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:60
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:61
#       T *= max(temperature, 0.0);
	max		$tmp26 ___373_temperature $const2 	%line{61} %argrw{"wrr"}
	mul		___373_T ___373_T $tmp26 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:64
#     T = max(T, 0.0);
	max		___373_T ___373_T $const2 	%line{64} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:67
#     float T4 = (T * T) * (T * T);
	mul		$tmp27 ___373_T ___373_T 	%line{67} %argrw{"wrr"}
	mul		$tmp28 ___373_T ___373_T 	%argrw{"wrr"}
	mul		___373_T4 $tmp27 $tmp28 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:68
#     float sigma = 5.670373e-8 * 1e-6 / M_PI;
	assign		___373_sigma $const8 	%line{68} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:69
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:71
#     if (intensity > 1e-5) {
	gt		$tmp30 ___373_intensity $const3 	%line{71} %argrw{"wrr"}
	if		$tmp30 66 66 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:72
#       color bb = blackbody(T);
	blackbody	___375_bb ___373_T 	%line{72} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:73
#       float l = luminance(bb);
	luminance	___375_l ___375_bb 	%line{73} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:75
#       if (l != 0.0) {
	neq		$tmp31 ___375_l $const2 	%line{75} %argrw{"wrr"}
	if		$tmp31 66 66 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:76
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_volume.osl:77
#         Volume += bb * emission();
