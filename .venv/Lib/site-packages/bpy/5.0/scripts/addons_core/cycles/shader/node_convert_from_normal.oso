...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_convert_from_normal.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_convert_from_normal.osl:15
#   value_float = (value_normal[0] + value_normal[1] + value_normal[2]) * (1.0 / 3.0);
	compref		$tmp1 value_normal $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_convert_from_normal.osl"} %line{15} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_convert_from_normal.osl:16
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_convert_from_normal.osl:17
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_convert_from_normal.osl:18
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_convert_from_normal.osl:19
