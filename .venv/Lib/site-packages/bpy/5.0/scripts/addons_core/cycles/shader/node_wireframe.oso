...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_wireframe.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_wireframe.osl:14
#   if (bump_offset == "dx") {
	eq		$tmp1 bump_offset $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_wireframe.osl"} %line{14} %argrw{"wrr"}
	if		$tmp1 5 10 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_wireframe.osl:15
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_wireframe.osl:17
#   else if (bump_offset == "dy") {
	eq		$tmp4 bump_offset $const2 	%line{17} %argrw{"wrr"}
	if		$tmp4 10 10 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_wireframe.osl:18
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_wireframe.osl:21
#   Fac = wireframe("triangles", Size, use_pixel_size);
	functioncall	$const4 85 	%line{21} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:16
#    if (raytype("path:diffuse")) return 0.0;
	raytype		$tmp7 $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h"} %line{16} %argrw{"wr"}
	if		$tmp7 15 15 	%argrw{"r"}
	assign		Fac $const6 	%argrw{"wr"}
	return
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:18
#    int np = 0;
	assign		___345_np $const7 	%line{18} %argrw{"wr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:20
#    float pixelWidth = 1;
	assign		___345_pixelWidth $const8 	%line{20} %argrw{"wr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:22
#    if (edge_type == "triangles")
	eq		$tmp8 $const3 $const3 	%line{22} %argrw{"wrr"}
	if		$tmp8 25 43 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:24
#       np = 3;
	assign		___345_np $const9 	%line{24} %argrw{"wr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:25
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:26
#          return 0.0;
	assign		Fac $const6 	%line{26} %argrw{"wr"}
	return
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:28
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:30
#       getattribute("geom:numpolyvertices", np);
	getattribute	$tmp15 $const13 ___345_np 	%line{30} %argrw{"wrw"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:31
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:32
#          return 0.0;
	assign		Fac $const6 	%line{32} %argrw{"wr"}
	return
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:35
#    if (raster)
	if		use_pixel_size 58 58 	%line{35} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:39
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:40
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:42
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:47
#    pixelWidth *= 0.5 * line_width;
	mul		$tmp32 $const17 Size 	%line{47} %argrw{"wrr"}
	mul		___345_pixelWidth ___345_pixelWidth $tmp32 	%argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:48
#    pixelWidth *= pixelWidth;
	mul		___345_pixelWidth ___345_pixelWidth ___345_pixelWidth 	%line{48} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:49
#    for (int i = 0; i < np; i++)
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:51
#       int i2 = i ? i - 1 : np - 1;
	if		___349_i 67 68 	%line{51} %argrw{"r"}
	sub		___350_i2 ___349_i $const8 	%argrw{"wrr"}
	sub		___350_i2 ___345_np $const8 	%argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:52
#       vector dir = P - p[i];
	aref		$tmp35 ___345_p ___349_i 	%line{52} %argrw{"wrr"}
	sub		___350_dir P $tmp35 	%argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:53
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:54
#       vector crs = cross(edge, dir);
	cross		___350_crs ___350_edge ___350_dir 	%line{54} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:58
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:59
#          return 1;
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:61
#    return 0;
