...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_white_noise_texture.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:18
#   if (dimensions == "1D") {
	eq		$tmp1 dimensions $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl"} %line{18} %argrw{"wrr"}
	if		$tmp1 15 84 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:19
#     Value = noise("hash", W);
	noise		Value $const2 W 	%line{19} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:20
...
#   return color(hash_float_to_float(k),
	functioncall	$const4 6 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{116} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:72
#   return hashnoise(k);
	hashnoise	$tmp2 W 	%line{72} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:117
#                hash_vector2_to_float(vector2(k, 1.0)),
	assign		$tmp4.x W 	%line{117} %argrw{"wr"}
	assign		$tmp4.y $const5 	%argrw{"wr"}
	functioncall	$const6 10 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:77
#   return hashnoise(k.x, k.y);
	hashnoise	$tmp3 $tmp4.x $tmp4.y 	%line{77} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:118
#                hash_vector2_to_float(vector2(k, 2.0)));
	assign		$tmp6.x W 	%line{118} %argrw{"wr"}
	assign		$tmp6.y $const7 	%argrw{"wr"}
	functioncall	$const6 14 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:77
#   return hashnoise(k.x, k.y);
	hashnoise	$tmp5 $tmp6.x $tmp6.y 	%line{77} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:116
#   return color(hash_float_to_float(k),
	color		Color $tmp2 $tmp3 $tmp5 	%line{116} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:22
#   else if (dimensions == "2D") {
	eq		$tmp7 dimensions $const8 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl"} %line{22} %argrw{"wrr"}
	if		$tmp7 32 84 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:23
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:24
...
#   return color(hash_vector2_to_float(k),
	functioncall	$const6 25 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{123} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:77
#   return hashnoise(k.x, k.y);
	hashnoise	$tmp11 $tmp10.x $tmp10.y 	%line{77} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:124
#                hash_vector3_to_float(vector3(k.x, k.y, 1.0)),
	point		$tmp13 $tmp10.x $tmp10.y $const5 	%line{124} %argrw{"wrrr"}
	functioncall	$const12 28 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:82
#   return hashnoise(k);
	hashnoise	$tmp12 $tmp13 	%line{82} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:125
#                hash_vector3_to_float(vector3(k.x, k.y, 2.0)));
	point		$tmp15 $tmp10.x $tmp10.y $const7 	%line{125} %argrw{"wrrr"}
	functioncall	$const12 31 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:82
#   return hashnoise(k);
	hashnoise	$tmp14 $tmp15 	%line{82} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:123
#   return color(hash_vector2_to_float(k),
	color		Color $tmp11 $tmp12 $tmp14 	%line{123} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:26
#   else if (dimensions == "3D") {
	eq		$tmp16 dimensions $const13 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl"} %line{26} %argrw{"wrr"}
	if		$tmp16 57 84 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:27
#     Value = noise("hash", Vector);
	noise		Value $const2 Vector 	%line{27} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:28
...
#   return color(hash_vector3_to_float(k),
	functioncall	$const12 42 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{130} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:82
#   return hashnoise(k);
	hashnoise	$tmp21 $tmp17 	%line{82} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:131
#                hash_vector4_to_float(vector4(k[0], k[1], k[2], 1.0)),
	compref		$tmp23.x $tmp17 $const9 	%line{131} %argrw{"wrr"}
...
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
	point		$tmp24 $tmp23.x $tmp23.y $tmp23.z 	%line{87} %argrw{"wrrr"}
	hashnoise	$tmp22 $tmp24 $tmp23.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:132
#                hash_vector4_to_float(vector4(k[0], k[1], k[2], 2.0)));
	compref		$tmp26.x $tmp17 $const9 	%line{132} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:87
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
	point		$tmp27 $tmp26.x $tmp26.y $tmp26.z 	%line{87} %argrw{"wrrr"}
	hashnoise	$tmp25 $tmp27 $tmp26.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:130
#   return color(hash_vector3_to_float(k),
	color		Color $tmp21 $tmp22 $tmp25 	%line{130} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:30
#   else if (dimensions == "4D") {
	eq		$tmp28 dimensions $const17 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl"} %line{30} %argrw{"wrr"}
	if		$tmp28 83 84 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:31
#     Value = noise("hash", Vector, W);
	noise		Value $const2 Vector W 	%line{31} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:32
...
#   return color(hash_vector4_to_float(k),
	functioncall	$const16 68 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{137} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:87
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
	point		$tmp31 $tmp29.x $tmp29.y $tmp29.z 	%line{87} %argrw{"wrrr"}
	hashnoise	$tmp30 $tmp31 $tmp29.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:138
#                hash_vector4_to_float(vector4(k.z, k.x, k.w, k.y)),
	assign		$tmp33.x $tmp29.z 	%line{138} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:87
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
	point		$tmp34 $tmp33.x $tmp33.y $tmp33.z 	%line{87} %argrw{"wrrr"}
	hashnoise	$tmp32 $tmp34 $tmp33.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:139
#                hash_vector4_to_float(vector4(k.w, k.z, k.y, k.x)));
	assign		$tmp36.x $tmp29.w 	%line{139} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:87
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
	point		$tmp37 $tmp36.x $tmp36.y $tmp36.z 	%line{87} %argrw{"wrrr"}
	hashnoise	$tmp35 $tmp37 $tmp36.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:137
#   return color(hash_vector4_to_float(k),
	color		Color $tmp30 $tmp32 $tmp35 	%line{137} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl:35
#     warning("%s", "Unknown dimension!");
	warning		$const19 $const20 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_white_noise_texture.osl"} %line{35} %argrw{"rr"}
	end
