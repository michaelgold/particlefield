...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_checker_texture.oso
...
code Vector
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:32
#     point Vector = P,
	assign		Vector P 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl"} %line{32} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:38
#   point p = Vector;
	assign		p Vector 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl"} %line{38} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:40
#   if (use_mapping)
	if		use_mapping 4 4 	%line{40} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:41
#     p = transform(mapping, p);
	transform	p mapping p 	%line{41} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:43
#   Fac = checker(p * Scale);
	mul		$tmp1 p Scale 	%line{43} %argrw{"wrr"}
	functioncall	$const1 40 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:12
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:13
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:14
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:16
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:17
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:18
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:20
#   if ((xi % 2 == yi % 2) == (zi % 2)) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:21
#     return 1.0;
	assign		Fac $const7 	%line{21} %argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:24
#     return 0.0;
	assign		Fac $const8 	%line{24} %argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:44
#   if (Fac == 1.0) {
	eq		$tmp25 Fac $const7 	%line{44} %argrw{"wrr"}
	if		$tmp25 43 44 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:45
#     Color = Color1;
	assign		Color Color1 	%line{45} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_checker_texture.osl:48
#     Color = Color2;
