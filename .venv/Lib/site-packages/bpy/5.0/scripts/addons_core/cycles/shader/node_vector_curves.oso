...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_vector_curves.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:17
#   vector c = (VectorIn - vector(min_x, min_x, min_x)) / (max_x - min_x);
	vector		$tmp1 min_x min_x min_x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{17} %argrw{"wrrr"}
	sub		$tmp2 VectorIn $tmp1 	%argrw{"wrr"}
	sub		$tmp3 max_x min_x 	%argrw{"wrr"}
	div		c $tmp2 $tmp3 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:19
...
#   float f = at;
	assign		___345_f $tmp4 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{9} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:10
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp21 $tmp4 $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp20 $tmp21 $const4 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:27
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp22 ___345_table_size $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{27} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:20
#   color g = rgb_ramp_lookup(ramp, c[0], 1, extrapolate);
	compref		$tmp35 c $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{20} %argrw{"wrr"}
	functioncall	$const3 128 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:9
#   float f = at;
	assign		___345_f $tmp35 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{9} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:10
#   int table_size = arraylength(ramp);
	arraylength	___345_table_size ramp 	%line{10} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:12
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp52 $tmp35 $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp51 $tmp52 $const4 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:27
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp53 ___345_table_size $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{27} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:21
#   color b = rgb_ramp_lookup(ramp, c[0], 1, extrapolate);
	compref		$tmp66 c $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{21} %argrw{"wrr"}
	functioncall	$const3 190 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:9
#   float f = at;
	assign		___345_f $tmp66 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{9} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:10
#   int table_size = arraylength(ramp);
	arraylength	___345_table_size ramp 	%line{10} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:12
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp83 $tmp66 $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp82 $tmp83 $const4 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:27
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp84 ___345_table_size $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{27} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:23
#   VectorOut[0] = r[0];
	compref		$tmp97 r $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl"} %line{23} %argrw{"wrr"}
	compassign	VectorOut $const1 $tmp97 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:24
#   VectorOut[1] = g[1];
	compref		$tmp98 g $const2 	%line{24} %argrw{"wrr"}
	compassign	VectorOut $const2 $tmp98 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:25
#   VectorOut[2] = b[2];
	compref		$tmp99 b $const6 	%line{25} %argrw{"wrr"}
	compassign	VectorOut $const6 $tmp99 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_curves.osl:27
