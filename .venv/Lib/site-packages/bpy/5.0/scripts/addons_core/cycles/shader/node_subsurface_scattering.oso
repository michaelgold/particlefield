...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.oso
...
code Normal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl:14
#                                   normal Normal = N,
	assign		Normal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl"} %line{14} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl:17
#   color base_color = max(Color, color(0.0));
	max		base_color Color $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl"} %line{17} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl:20
#                                Scale * Radius,
	mul		$tmp3 Scale Radius 	%line{20} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl:27
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp5 Roughness $const6 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp4 $tmp5 $const5 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl:18
#   BSSRDF = base_color * bssrdf(method,
	closure		$tmp2 $const8 method Normal $tmp3 base_color $const2 IOR $const3 Anisotropy $const4 $tmp4 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_subsurface_scattering.osl"} %line{18} %argrw{"wrrrrrrrrrrr"}
