...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_principled_bsdf.oso
...
param	float	ThinFilmThickness	0		%read{145,190} %write{2147483647,-1}
param	float	ThinFilmIOR	1.33000004		%read{152,190} %write{2147483647,-1}
...
local	float	___349_f0	%read{105,174} %write{104,173}
local	float	___350_sqrt_f0	%read{116,117} %write{115,115}
...
local	float	___374_aspect	%read{37,38} %write{36,36}
local	float	___375_eta	%read{102,151} %write{100,121}
local	float	___375_f0	%read{110,149} %write{105,110}
local	vector	___380_radius	%read{135,135} %write{130,130}
local	float	___380_subsurface_ior	%read{135,135} %write{133,134}
local	closure color	___380_SubsurfBSDF	%read{136,136} %write{135,135}
local	color	___381_F0	%read{152,152} %write{149,149}
local	color	___381_F90	%read{152,152} %write{150,150}
local	closure color	TransmissionBSDF	%read{183,183} %write{154,179}
local	float	___382_eta	%read{165,178} %write{162,169}
local	float	___382_thinfilm_ior	%read{179,179} %write{165,166}
local	color	___382_F0	%read{179,179} %write{175,175}
local	color	___382_F90	%read{179,179} %write{176,176}
local	closure color	MetallicBSDF	%read{194,194} %write{185,190}
local	color	___383_F0	%read{190,190} %write{188,188}
local	color	___383_F82	%read{190,190} %write{189,189}
local	float	___385_coat_ior	%read{212,231} %write{209,209}
local	float	___386_coat_neta	%read{214,214} %write{212,212}
local	float	___386_cosNI	%read{215,215} %write{213,213}
local	float	___386_cosNT	%read{220,220} %write{219,219}
local	float	___385_coat_r2	%read{230,231} %write{229,230}
local	closure color	___385_CoatBSDF	%read{232,232} %write{231,231}
local	normal	___387_sheen_normal	%read{244,244} %write{240,240}
local	closure color	___387_SheenBSDF	%read{247,247} %write{244,244}
...
const	string	$const29	"thinfilm_thickness"		%read{152,190} %write{2147483647,-1}
const	string	$const30	"thinfilm_ior"		%read{152,190} %write{2147483647,-1}
...
code Normal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:37
#                             normal Normal = N,
	assign		Normal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{37} %argrw{"wr"}
code CoatNormal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:38
#                             normal CoatNormal = N,
	assign		CoatNormal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{38} %argrw{"wr"}
code Tangent
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:39
#                             normal Tangent = normalize(dPdu),
	normalize	Tangent dPdu 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{39} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:42
#   float CLOSURE_WEIGHT_CUTOFF = 1e-5;
	assign		CLOSURE_WEIGHT_CUTOFF $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{42} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:45
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1 Metallic $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		metallic $tmp1 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:46
#   float transmission = clamp(TransmissionWeight, 0.0, 1.0);
	functioncall	$const4 10 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{46} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2 TransmissionWeight $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		transmission $tmp2 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:47
#   float subsurface_weight = clamp(SubsurfaceWeight, 0.0, 1.0);
	functioncall	$const4 13 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{47} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp3 SubsurfaceWeight $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		subsurface_weight $tmp3 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:48
#   color specular_tint = max(SpecularTint, color(0.0));
	max		specular_tint SpecularTint $const5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{48} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:49
#   float coat_weight = max(CoatWeight, 0.0);
	max		coat_weight CoatWeight $const2 	%line{49} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:50
#   color coat_tint = max(CoatTint, color(0.0));
	max		coat_tint CoatTint $const5 	%line{50} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:51
#   float sheen_weight = max(SheenWeight, 0.0);
	max		sheen_weight SheenWeight $const2 	%line{51} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:52
#   color base_color = max(BaseColor, color(0.0));
	max		base_color BaseColor $const5 	%line{52} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:53
#   color clamped_base_color = min(base_color, color(1.0));
	min		clamped_base_color base_color $const6 	%line{53} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:54
#   float diffuse_roughness = clamp(DiffuseRoughness, 0.0, 1.0);
	functioncall	$const4 22 	%line{54} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp8 DiffuseRoughness $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		diffuse_roughness $tmp8 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:56
#   float r2 = clamp(Roughness, 0.0, 1.0);
	functioncall	$const4 25 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{56} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp9 Roughness $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		r2 $tmp9 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:57
#   r2 = r2 * r2;
	mul		r2 r2 r2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{57} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:59
#   float alpha_x = r2, alpha_y = r2;
	assign		alpha_x r2 	%line{59} %argrw{"wr"}
	assign		alpha_y r2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:62
#   vector T = Tangent;
	assign		T Tangent 	%line{62} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:63
#   if (Anisotropic > 0.0) {
	gt		$tmp10 Anisotropic $const2 	%line{63} %argrw{"wrr"}
	if		$tmp10 93 93 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:64
#     float aspect = sqrt(1.0 - clamp(Anisotropic, 0.0, 1.0) * 0.9);
	functioncall	$const4 34 	%line{64} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp12 Anisotropic $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp11 $tmp12 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:64
#     float aspect = sqrt(1.0 - clamp(Anisotropic, 0.0, 1.0) * 0.9);
	mul		$tmp13 $tmp11 $const7 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{64} %argrw{"wrr"}
	sub		$tmp14 $const3 $tmp13 	%argrw{"wrr"}
	sqrt		___374_aspect $tmp14 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:65
#     alpha_x /= aspect;
	div		alpha_x alpha_x ___374_aspect 	%line{65} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:66
#     alpha_y *= aspect;
	mul		alpha_y alpha_y ___374_aspect 	%line{66} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:67
#     if (AnisotropicRotation != 0.0)
	neq		$tmp15 AnisotropicRotation $const2 	%line{67} %argrw{"wrr"}
	if		$tmp15 93 93 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:68
#       T = rotate(T, AnisotropicRotation * M_2PI, point(0.0, 0.0, 0.0), Normal);
	mul		$tmp16 AnisotropicRotation $const8 	%line{68} %argrw{"wrr"}
	functioncall	$const10 93 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:270
#     vector axis = normalize (b - a);
	sub		$tmp18 Normal $const9 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{270} %argrw{"wrr"}
	normalize	___257_axis $tmp18 	%argrw{"wr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:272
#     sincos (angle, sinang, cosang);
	sincos		$tmp16 ___257_sinang ___257_cosang 	%line{272} %argrw{"rww"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:273
#     float cosang1 = 1.0 - cosang;
	sub		___257_cosang1 $const3 ___257_cosang 	%line{273} %argrw{"wrr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:274
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:275
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:276
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:277
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:279
#                        x * y * cosang1 - z * sinang,
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:280
#                        y * y + (1.0 - y * y) * cosang,
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:281
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:283
#                        x * z * cosang1 + y * sinang,
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:284
#                        y * z * cosang1 - x * sinang,
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:285
#                        z * z + (1.0 - z * z) * cosang,
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:288
#     return transform (M, p-a) + a;
	sub		$tmp59 T $const9 	%line{288} %argrw{"wrr"}
	transformv	$tmp58 ___257_M $tmp59 	%argrw{"wrr"}
	add		T $tmp58 $const9 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:71
#   if (metallic < 1.0 && TransmissionWeight < 1.0) {
	lt		$tmp60 metallic $const3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{71} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:72
#     float eta = max(IOR, 1e-5);
	max		___375_eta IOR $const1 	%line{72} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:73
#     float f0 = F0_from_ior(eta);
	functioncall	$const14 106 	%line{73} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:42
#   float f0 = (eta - 1.0) / (eta + 1.0);
	sub		$tmp64 ___375_eta $const3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h"} %line{42} %argrw{"wrr"}
	add		$tmp65 ___375_eta $const3 	%argrw{"wrr"}
	div		___349_f0 $tmp64 $tmp65 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:43
#   return f0 * f0;
	mul		___375_f0 ___349_f0 ___349_f0 	%line{43} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:74
#     if (SpecularIORLevel != 0.5) {
	neq		$tmp66 SpecularIORLevel $const15 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{74} %argrw{"wrr"}
	if		$tmp66 122 122 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:75
#       f0 *= 2.0 * max(SpecularIORLevel, 0.0);
	max		$tmp67 SpecularIORLevel $const2 	%line{75} %argrw{"wrr"}
	mul		$tmp68 $const16 $tmp67 	%argrw{"wrr"}
	mul		___375_f0 ___375_f0 $tmp68 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:76
#       eta = ior_from_F0(f0);
	functioncall	$const17 119 	%line{76} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:48
#   float sqrt_f0 = sqrt(clamp(f0, 0.0, 0.99));
	functioncall	$const4 115 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h"} %line{48} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp70 ___375_f0 $const18 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp69 $tmp70 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:48
#   float sqrt_f0 = sqrt(clamp(f0, 0.0, 0.99));
	sqrt		___350_sqrt_f0 $tmp69 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h"} %line{48} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:49
#   return (1.0 + sqrt_f0) / (1.0 - sqrt_f0);
	add		$tmp71 $const3 ___350_sqrt_f0 	%line{49} %argrw{"wrr"}
	sub		$tmp72 $const3 ___350_sqrt_f0 	%argrw{"wrr"}
	div		___375_eta $tmp71 $tmp72 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:77
#       if (IOR < 1.0) {
	lt		$tmp73 IOR $const3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{77} %argrw{"wrr"}
	if		$tmp73 122 122 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:78
#         eta = 1.0 / eta;
	div		___375_eta $const3 ___375_eta 	%line{78} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:82
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:83
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:86
#       BSDF = base_color * diffuse(Normal);
	closure		$tmp75 $const20 Normal 	%line{86} %argrw{"wrr"}
	mul		BSDF $tmp75 base_color 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:89
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:90
#       vector radius = max(SubsurfaceScale * SubsurfaceRadius, vector(0.0));
	...
	max		___380_radius $tmp77 $const21 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:91
#       float subsurface_ior = (subsurface_method == "random_walk_skin") ? SubsurfaceIOR : eta;
	...
	assign		___380_subsurface_ior SubsurfaceIOR 	%argrw{"wr"}
	assign		___380_subsurface_ior ___375_eta 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:92
#       closure color SubsurfBSDF = bssrdf(subsurface_method,
	closure		___380_SubsurfBSDF $const26 subsurface_method Normal ___380_radius clamped_base_color $const23 r2 $const24 ___380_subsurface_ior $const25 SubsurfaceAnisotropy 	%line{92} %argrw{"wrrrrrrrrrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:102
#       BSDF = mix(BSDF, clamped_base_color * SubsurfBSDF, subsurface_weight);
	mul		$tmp80 ___380_SubsurfBSDF clamped_base_color 	%line{102} %argrw{"wrr"}
	functioncall	$const27 142 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:164
# closure color mix (closure color x, closure color y, float a) { return x*(1-a) + y*a; }
	sub		$tmp81 $const3 subsurface_weight 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{164} %argrw{"wrr"}
	mul		$tmp82 BSDF $tmp81 	%argrw{"wrr"}
	mul		$tmp83 $tmp80 subsurface_weight 	%argrw{"wrr"}
	add		BSDF $tmp82 $tmp83 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:105
#     if (eta != 1.0 || ThinFilmThickness > 0.1) {
	neq		$tmp84 ___375_eta $const3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{105} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:107
#       color F0 = f0 * specular_tint;
	mul		___381_F0 ___375_f0 specular_tint 	%line{107} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:108
#       color F90 = color(1.0);
	assign		___381_F90 $const6 	%line{108} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:118
#                                             -eta,
	neg		$tmp91 ___375_eta 	%line{118} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:110
#       BSDF = layer(generalized_schlick_bsdf(Normal,
	closure		$tmp88 $const31 Normal T $const6 $const5 alpha_x alpha_y ___381_F0 ___381_F90 $tmp91 distribution $const29 ThinFilmThickness $const30 ThinFilmIOR 	%line{110} %argrw{"wrrrrrrrrrrrrrrr"}
	closure		BSDF $const32 $tmp88 BSDF 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:128
#   closure color TransmissionBSDF = 0;
	assign		TransmissionBSDF $const11 	%line{128} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:129
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:130
#     float eta = max(IOR, 1e-5);
	max		___382_eta IOR $const1 	%line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:131
#     float thinfilm_ior = backfacing() ? ThinFilmIOR / eta : ThinFilmIOR;
	backfacing	$tmp96 	%line{131} %argrw{"w"}
	if		$tmp96 166 167 	%argrw{"r"}
	div		___382_thinfilm_ior ThinFilmIOR ___382_eta 	%argrw{"wrr"}
	assign		___382_thinfilm_ior ThinFilmIOR 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:132
#     eta = backfacing() ? 1.0 / eta : eta;
	backfacing	$tmp97 	%line{132} %argrw{"w"}
	if		$tmp97 170 170 	%argrw{"r"}
	div		___382_eta $const3 ___382_eta 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:134
#     color F0 = F0_from_ior(eta) * specular_tint;
	functioncall	$const14 175 	%line{134} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:42
#   float f0 = (eta - 1.0) / (eta + 1.0);
	sub		$tmp99 ___382_eta $const3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h"} %line{42} %argrw{"wrr"}
	add		$tmp100 ___382_eta $const3 	%argrw{"wrr"}
	div		___349_f0 $tmp99 $tmp100 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_fresnel.h:43
#   return f0 * f0;
	mul		$tmp98 ___349_f0 ___349_f0 	%line{43} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:134
#     color F0 = F0_from_ior(eta) * specular_tint;
	mul		___382_F0 $tmp98 specular_tint 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{134} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:135
#     color F90 = color(1.0);
	assign		___382_F90 $const6 	%line{135} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:140
#                                                 sqrt(clamped_base_color),
	sqrt		$tmp103 clamped_base_color 	%line{140} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:145
#                                                 -eta,
	neg		$tmp104 ___382_eta 	%line{145} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:137
#     TransmissionBSDF = generalized_schlick_bsdf(Normal,
	closure		TransmissionBSDF $const31 Normal $const21 $const6 $tmp103 r2 r2 ___382_F0 ___382_F90 $tmp104 distribution $const29 ThinFilmThickness $const30 ___382_thinfilm_ior 	%line{137} %argrw{"wrrrrrrrrrrrrrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:151
#     BSDF = mix(BSDF, TransmissionBSDF, transmission);
	functioncall	$const27 185 	%line{151} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:164
# closure color mix (closure color x, closure color y, float a) { return x*(1-a) + y*a; }
	sub		$tmp105 $const3 transmission 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{164} %argrw{"wrr"}
	mul		$tmp106 BSDF $tmp105 	%argrw{"wrr"}
	mul		$tmp107 TransmissionBSDF transmission 	%argrw{"wrr"}
	add		BSDF $tmp106 $tmp107 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:154
#   closure color MetallicBSDF = 0;
	assign		MetallicBSDF $const11 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{154} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:155
#   if (metallic > CLOSURE_WEIGHT_CUTOFF) {
	gt		$tmp108 metallic CLOSURE_WEIGHT_CUTOFF 	%line{155} %argrw{"wrr"}
	if		$tmp108 196 196 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:156
#     color F0 = clamped_base_color;
	assign		___383_F0 clamped_base_color 	%line{156} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:157
#     color F82 = min(specular_tint, color(1.0));
	min		___383_F82 specular_tint $const6 	%line{157} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:158
#     MetallicBSDF = microfacet_f82_tint(distribution,
	closure		MetallicBSDF $const33 distribution Normal T alpha_x alpha_y ___383_F0 ___383_F82 $const29 ThinFilmThickness $const30 ThinFilmIOR 	%line{158} %argrw{"wrrrrrrrrrrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:169
#     BSDF = mix(BSDF, MetallicBSDF, metallic);
	functioncall	$const27 196 	%line{169} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:164
# closure color mix (closure color x, closure color y, float a) { return x*(1-a) + y*a; }
	sub		$tmp110 $const3 metallic 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{164} %argrw{"wrr"}
	mul		$tmp111 BSDF $tmp110 	%argrw{"wrr"}
	mul		$tmp112 MetallicBSDF metallic 	%argrw{"wrr"}
	add		BSDF $tmp111 $tmp112 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:172
#   if (EmissionStrength != 0.0 && EmissionColor != color(0.0)) {
	neq		$tmp113 EmissionStrength $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{172} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:173
#     BSDF += EmissionStrength * EmissionColor * emission();
	closure		$tmp118 $const34 	%line{173} %argrw{"wr"}
	mul		$tmp119 EmissionStrength EmissionColor 	%argrw{"wrr"}
	mul		$tmp120 $tmp118 $tmp119 	%argrw{"wrr"}
	add		BSDF BSDF $tmp120 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:176
#   if (coat_weight > CLOSURE_WEIGHT_CUTOFF) {
	gt		$tmp121 coat_weight CLOSURE_WEIGHT_CUTOFF 	%line{176} %argrw{"wrr"}
	if		$tmp121 234 234 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:177
#     float coat_ior = max(CoatIOR, 1.0);
	max		___385_coat_ior CoatIOR $const3 	%line{177} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:178
#     if (CoatTint != color(1.0)) {
	neq		$tmp123 CoatTint $const6 	%line{178} %argrw{"wrr"}
	if		$tmp123 227 227 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:179
#       float coat_neta = 1.0 / coat_ior;
	div		___386_coat_neta $const3 ___385_coat_ior 	%line{179} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:180
#       float cosNI = dot(I, CoatNormal);
	dot		___386_cosNI I CoatNormal 	%line{180} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:181
#       float cosNT = sqrt(1.0 - coat_neta * coat_neta * (1 - cosNI * cosNI));
	mul		$tmp124 ___386_coat_neta ___386_coat_neta 	%line{181} %argrw{"wrr"}
	mul		$tmp125 ___386_cosNI ___386_cosNI 	%argrw{"wrr"}
	sub		$tmp126 $const3 $tmp125 	%argrw{"wrr"}
	mul		$tmp127 $tmp124 $tmp126 	%argrw{"wrr"}
	sub		$tmp128 $const3 $tmp127 	%argrw{"wrr"}
	sqrt		___386_cosNT $tmp128 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:182
#       BSDF *= mix(color(1.0), pow(CoatTint, 1.0 / cosNT), clamp(coat_weight, 0.0, 1.0));
	div		$tmp132 $const3 ___386_cosNT 	%line{182} %argrw{"wrr"}
	pow		$tmp131 CoatTint $tmp132 	%argrw{"wrr"}
	functioncall	$const4 225 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp134 coat_weight $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp133 $tmp134 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:182
#       BSDF *= mix(color(1.0), pow(CoatTint, 1.0 / cosNT), clamp(coat_weight, 0.0, 1.0));
	mix		$tmp129 $const6 $tmp131 $tmp133 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{182} %argrw{"wrrr"}
	mul		BSDF BSDF $tmp129 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:184
#     float coat_r2 = clamp(CoatRoughness, 0.0, 1.0);
	functioncall	$const4 230 	%line{184} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp135 CoatRoughness $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		___385_coat_r2 $tmp135 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:185
#     coat_r2 = coat_r2 * coat_r2;
	mul		___385_coat_r2 ___385_coat_r2 ___385_coat_r2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{185} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:187
#     closure color CoatBSDF = dielectric_bsdf(
	closure		___385_CoatBSDF $const36 CoatNormal $const21 $const6 $const5 ___385_coat_r2 ___385_coat_r2 ___385_coat_ior $const35 	%line{187} %argrw{"wrrrrrrrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:189
#     BSDF = layer(coat_weight * CoatBSDF, BSDF);
	mul		$tmp139 ___385_CoatBSDF coat_weight 	%line{189} %argrw{"wrr"}
	closure		BSDF $const32 $tmp139 BSDF 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:192
#   if (SheenWeight > CLOSURE_WEIGHT_CUTOFF) {
	gt		$tmp140 SheenWeight CLOSURE_WEIGHT_CUTOFF 	%line{192} %argrw{"wrr"}
	if		$tmp140 249 249 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:193
#     normal sheen_normal = normalize(mix(Normal, CoatNormal, clamp(coat_weight, 0.0, 1.0)));
	functioncall	$const4 239 	%line{193} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp143 coat_weight $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp142 $tmp143 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:193
#     normal sheen_normal = normalize(mix(Normal, CoatNormal, clamp(coat_weight, 0.0, 1.0)));
	mix		$tmp141 Normal CoatNormal $tmp142 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{193} %argrw{"wrrr"}
	normalize	___387_sheen_normal $tmp141 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:194
#     closure color SheenBSDF = sheen(sheen_normal, clamp(SheenRoughness, 0.0, 1.0));
	functioncall	$const4 244 	%line{194} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp145 SheenRoughness $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp144 $tmp145 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:194
#     closure color SheenBSDF = sheen(sheen_normal, clamp(SheenRoughness, 0.0, 1.0));
	closure		___387_SheenBSDF $const37 ___387_sheen_normal $tmp144 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{194} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:195
#     BSDF = layer(sheen_weight * max(SheenTint, color(0.0)) * SheenBSDF, BSDF);
	max		$tmp146 SheenTint $const5 	%line{195} %argrw{"wrr"}
	mul		$tmp148 sheen_weight $tmp146 	%argrw{"wrr"}
	mul		$tmp149 ___387_SheenBSDF $tmp148 	%argrw{"wrr"}
	closure		BSDF $const32 $tmp149 BSDF 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:198
#   BSDF = mix(transparent(), BSDF, clamp(Alpha, 0.0, 1.0));
	closure		$tmp150 $const38 	%line{198} %argrw{"wr"}
	functioncall	$const4 253 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp152 Alpha $const3 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp151 $tmp152 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl:198
#   BSDF = mix(transparent(), BSDF, clamp(Alpha, 0.0, 1.0));
	functioncall	$const27 258 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_principled_bsdf.osl"} %line{198} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:164
# closure color mix (closure color x, closure color y, float a) { return x*(1-a) + y*a; }
	sub		$tmp153 $const3 $tmp151 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{164} %argrw{"wrr"}
