...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_vertex_color.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:16
#   if (layer_name == "") {
	eq		$tmp1 layer_name $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl"} %line{16} %argrw{"wrr"}
	if		$tmp1 3 4 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:17
#     vertex_color_layer = "geom:vertex_color";
	assign		vertex_color_layer $const2 	%line{17} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:20
#     vertex_color_layer = layer_name;
	assign		vertex_color_layer layer_name 	%line{20} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:23
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:24
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:25
#     Alpha = vertex_color[3];
	aref		Alpha vertex_color $const6 	%line{25} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:27
#     if (bump_offset == "dx") {
	eq		$tmp6 bump_offset $const7 	%line{27} %argrw{"wrr"}
	if		$tmp6 19 27 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:28
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:29
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:31
#     else if (bump_offset == "dy") {
	eq		$tmp11 bump_offset $const8 	%line{31} %argrw{"wrr"}
	if		$tmp11 27 27 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:32
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:33
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:37
