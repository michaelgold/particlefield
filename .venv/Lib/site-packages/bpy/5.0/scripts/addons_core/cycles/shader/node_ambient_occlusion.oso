...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.oso
...
code Normal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:10
#                               normal Normal = N,
	assign		Normal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl"} %line{10} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:16
#   int global_radius = (Distance == 0.0 && !isconnected(Distance));
	eq		$tmp1 Distance $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl"} %line{16} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:18
#   normal normalized_normal = normalize(Normal);
	normalize	normalized_normal Normal 	%line{18} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:21
#   AO = texture("@ao",
	assign		$tmp6 samples 	%line{21} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:24
#                normalized_normal[0],
	compref		$tmp7 normalized_normal $const2 	%line{24} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:25
#                normalized_normal[1],
	compref		$tmp8 normalized_normal $const4 	%line{25} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:26
#                normalized_normal[2],
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_ambient_occlusion.osl:32
#   ColorOut = ColorIn * AO;
