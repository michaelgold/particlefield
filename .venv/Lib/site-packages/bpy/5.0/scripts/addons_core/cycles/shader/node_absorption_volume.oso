...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_absorption_volume.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_absorption_volume.osl:11
#   Volume = ((color(1.0, 1.0, 1.0) - Color) * max(Density, 0.0)) * absorption();
	closure		$tmp1 $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_absorption_volume.osl"} %line{11} %argrw{"wr"}
