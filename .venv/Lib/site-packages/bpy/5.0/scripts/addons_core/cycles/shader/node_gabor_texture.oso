...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_gabor_texture.oso
...
code Vector
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:289
#                           vector3 Vector = P,
	assign		Vector P 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{289} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:299
#   vector3 coordinates = Vector;
	assign		coordinates Vector 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{299} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:300
#   if (use_mapping) {
	if		use_mapping 4 4 	%line{300} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:301
#     coordinates = transform(mapping, coordinates);
	transform	coordinates mapping coordinates 	%line{301} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:304
#   vector3 scaled_coordinates = coordinates * Scale;
	mul		scaled_coordinates coordinates Scale 	%line{304} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:305
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2 Anisotropy $const1 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp1 $tmp2 $const2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:305
#   float isotropy = 1.0 - clamp(Anisotropy, 0.0, 1.0);
	sub		isotropy $const1 $tmp1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{305} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:306
#   float frequency = max(0.001, Frequency);
	max		frequency $const4 Frequency 	%line{306} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:308
#   vector2 phasor = vector2(0.0, 0.0);
	assign		phasor.x $const2 	%line{308} %argrw{"wr"}
	assign		phasor.y $const2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:309
#   float standard_deviation = 1.0;
	assign		standard_deviation $const1 	%line{309} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:310
#   if (type == "2D") {
	eq		$tmp3 type $const5 	%line{310} %argrw{"wrr"}
	if		$tmp3 156 343 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:312
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:311
#     phasor = compute_2d_gabor_noise(
	functioncall	$const8 150 	%line{311} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:157
...
#     return vector2 (floor(a.x), floor(a.y));
	floor		___535_cell_position.x $tmp4.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %argrw{"wr"}
	floor		___535_cell_position.y $tmp4.y 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const10 24 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:53
#     return vector2(a.x - b.x, a.y - b.y);
	sub		___535_local_position.x $tmp4.x ___535_cell_position.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{53} %argrw{"wrr"}
	sub		___535_local_position.y $tmp4.y ___535_cell_position.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:160
#   vector2 sum = vector2(0.0, 0.0);
	assign		___535_sum.x $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{160} %argrw{"wr"}
	assign		___535_sum.y $const2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:161
#   for (int j = -1; j <= 1; j++) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:162
#     for (int i = -1; i <= 1; i++) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:163
...
#     return vector2(a.x + b.x, a.y + b.y);
	add		___539_current_cell_position.x ___535_cell_position.x ___539_cell_offset.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___539_current_cell_position.y ___535_cell_position.y ___539_cell_offset.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const10 42 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:53
#     return vector2(a.x - b.x, a.y - b.y);
	sub		___539_position_in_cell_space.x ___535_local_position.x ___539_cell_offset.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{53} %argrw{"wrr"}
	sub		___539_position_in_cell_space.y ___535_local_position.y ___539_cell_offset.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:166
#       sum += compute_2d_gabor_noise_cell(
	functioncall	$const13 141 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{166} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:118
#   vector2 noise = vector2(0.0, 0.0);
	assign		___531_noise.x $const2 	%line{118} %argrw{"wr"}
	assign		___531_noise.y $const2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:119
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:121
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:122
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:123
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:129
...
#   return hashnoise(k);
	hashnoise	$tmp20 ___533_seed_for_orientation 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{82} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:129
#     float random_orientation = (hash_vector3_to_float(seed_for_orientation) - 0.5) * M_PI;
	sub		$tmp21 $tmp20 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{129} %argrw{"wrr"}
	mul		___533_random_orientation $tmp21 $const19 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:130
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:132
...
#   return vector2(hash_vector3_to_float(vector3(k.x, k.y, k.z)),
	compref		$tmp24 ___533_seed_for_kernel_center $const6 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{174} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const10 82 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:53
#     return vector2(a.x - b.x, a.y - b.y);
	sub		___533_position_in_kernel_space.x ___539_position_in_cell_space.x ___533_kernel_center.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{53} %argrw{"wrr"}
	sub		___533_position_in_kernel_space.y ___539_position_in_cell_space.y ___533_kernel_center.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:137
#     if (dot(position_in_kernel_space, position_in_kernel_space) >= 1.0) {
	functioncall	$const21 86 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{137} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:187
#     return (a.x * b.x + a.y * b.y);
	mul		$tmp32 ___533_position_in_kernel_space.x ___533_position_in_kernel_space.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{187} %argrw{"wrr"}
	mul		$tmp33 ___533_position_in_kernel_space.y ___533_position_in_kernel_space.y 	%argrw{"wrr"}
	add		$tmp31 $tmp32 $tmp33 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:137
#     if (dot(position_in_kernel_space, position_in_kernel_space) >= 1.0) {
	ge		$tmp34 $tmp31 $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{137} %argrw{"wrr"}
	if		$tmp34 89 89 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:138
#       continue;
	continue	%line{138}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:143
#     float weight = hash_vector3_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	functioncall	$const17 91 	%line{143} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:82
#   return hashnoise(k);
	hashnoise	$tmp35 ___533_seed_for_weight 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{82} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:143
#     float weight = hash_vector3_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	lt		$tmp36 $tmp35 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{143} %argrw{"wrr"}
	if		$tmp36 94 95 	%argrw{"r"}
	assign		___533_weight $const22 	%argrw{"wr"}
	assign		___533_weight $const1 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:145
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:63
#   float distance_squared = dot(position, position);
	functioncall	$const21 100 	%line{63} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:187
#     return (a.x * b.x + a.y * b.y);
	mul		$tmp39 ___533_position_in_kernel_space.x ___533_position_in_kernel_space.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{187} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:64
#   float hann_window = 0.5 + 0.5 * cos(M_PI * distance_squared);
	mul		$tmp42 $const19 ___529_distance_squared 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{64} %argrw{"wrr"}
	cos		$tmp41 $tmp42 	%argrw{"wr"}
	mul		$tmp43 $const18 $tmp41 	%argrw{"wrr"}
	add		___529_hann_window $const18 $tmp43 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:65
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:66
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:68
...
#     return b * vector2(a, a);
	assign		$tmp46.x frequency 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp46.y frequency 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const25 115 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___529_frequency_vector.x $tmp45.x $tmp46.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___529_frequency_vector.y $tmp45.y $tmp46.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:69
#   float angle = 2.0 * M_PI * dot(position, frequency_vector);
	functioncall	$const21 119 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{69} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:187
#     return (a.x * b.x + a.y * b.y);
	mul		$tmp48 ___533_position_in_kernel_space.x ___529_frequency_vector.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{187} %argrw{"wrr"}
	mul		$tmp49 ___533_position_in_kernel_space.y ___529_frequency_vector.y 	%argrw{"wrr"}
	add		$tmp47 $tmp48 $tmp49 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:69
#   float angle = 2.0 * M_PI * dot(position, frequency_vector);
	mul		___529_angle $const26 $tmp47 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{69} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:70
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp50.x ___529_windowed_gaussian_envelope 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp50.y ___529_windowed_gaussian_envelope 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const25 128 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp38.x ___529_phasor.x $tmp50.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp38.y ___529_phasor.y $tmp50.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const25 134 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp51.x ___533_weight 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp37.x $tmp38.x $tmp51.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp37.y $tmp38.y $tmp51.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const12 137 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___531_noise.x ___531_noise.x $tmp37.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___531_noise.y ___531_noise.y $tmp37.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:119
#   for (int i = 0; i < IMPULSES_COUNT; ++i) {
	add		___532_i ___532_i $const7 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{119} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:147
#   return noise;
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___535_sum.x ___535_sum.x $tmp9.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___535_sum.y ___535_sum.y $tmp9.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:162
#     for (int i = -1; i <= 1; i++) {
	assign		$tmp52 ___538_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{162} %argrw{"wr"}
	add		___538_i ___538_i $const7 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:161
#   for (int j = -1; j <= 1; j++) {
	assign		$tmp53 ___536_j 	%line{161} %argrw{"wr"}
	add		___536_j ___536_j $const7 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:171
#   return sum;
	assign		phasor.x ___535_sum.x 	%line{171} %argrw{"wr"}
	assign		phasor.y ___535_sum.y 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:313
#     standard_deviation = compute_2d_gabor_standard_deviation();
	functioncall	$const27 156 	%line{313} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:103
#   float integral_of_gabor_squared = 0.25;
	assign		___530_integral_of_gabor_squared $const28 	%line{103} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:104
#   float second_moment = 0.5;
	assign		___530_second_moment $const18 	%line{104} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:105
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:315
#   else if (type == "3D") {
	eq		$tmp56 type $const30 	%line{315} %argrw{"wrr"}
	if		$tmp56 342 343 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:316
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:317
#     phasor = compute_3d_gabor_noise(scaled_coordinates, frequency, isotropy, orientation);
	functioncall	$const31 336 	%line{317} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:267
#   vector3 cell_position = floor(coordinates);
	floor		___548_cell_position scaled_coordinates 	%line{267} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:268
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:270
#   vector2 sum = vector2(0.0, 0.0);
	assign		___548_sum.x $const2 	%line{270} %argrw{"wr"}
	assign		___548_sum.y $const2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:271
#   for (int k = -1; k <= 1; k++) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:272
#     for (int j = -1; j <= 1; j++) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:273
#       for (int i = -1; i <= 1; i++) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:274
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:275
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:276
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:277
#         sum += compute_3d_gabor_noise_cell(
	functioncall	$const32 325 	%line{277} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:234
#   vector2 noise = vector2(0.0, 0.0);
	assign		___544_noise.x $const2 	%line{234} %argrw{"wr"}
	assign		___544_noise.y $const2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:235
#   for (int i = 0; i < IMPULSES_COUNT; ++i) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:237
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:238
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:239
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:241
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:208
#   if (isotropy == 0.0) {
	eq		$tmp75 isotropy $const2 	%line{208} %argrw{"wrr"}
	if		$tmp75 212 212 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:209
#     return orientation;
	assign		___546_orientation ___557_orientation 	%line{209} %argrw{"wr"}
	return
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:213
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:214
#   float azimuth = sign(orientation.y) *
	compref		$tmp78 ___557_orientation $const7 	%line{214} %argrw{"wrr"}
	sign		$tmp77 $tmp78 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:215
...
#     return hypot (a.x, a.y);
	functioncall	$const35 225 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{192} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:101
# float hypot (float a, float b) { return sqrt (a*a + b*b); }
	mul		$tmp83 $tmp82.x $tmp82.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{101} %argrw{"wrr"}
	mul		$tmp84 $tmp82.y $tmp82.y 	%argrw{"wrr"}
	add		$tmp85 $tmp83 $tmp84 	%argrw{"wrr"}
	sqrt		$tmp81 $tmp85 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:215
#                   acos(orientation.x / length(vector2(orientation.x, orientation.y)));
	div		$tmp86 $tmp80 $tmp81 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{215} %argrw{"wrr"}
	acos		$tmp79 $tmp86 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:214
#   float azimuth = sign(orientation.y) *
	mul		___542_azimuth $tmp77 $tmp79 	%line{214} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:221
...
#   return vector2(hash_vector4_to_float(vector4(k.x, k.y, k.z, k.w)),
	assign		$tmp88.x ___546_seed_for_orientation.x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{180} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const25 249 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:88
#     return a * vector2(b, b);
	assign		$tmp92.x $const19 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{88} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		___542_random_angles.x $tmp87.x $tmp92.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		___542_random_angles.y $tmp87.y $tmp92.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:222
#   inclination += random_angles.x * isotropy;
	mul		$tmp93 ___542_random_angles.x isotropy 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{222} %argrw{"wrr"}
	add		___542_inclination ___542_inclination $tmp93 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:223
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:227
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:226
#   return vector3(
	point		___546_orientation $tmp97 $tmp100 $tmp101 	%line{226} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:243
...
#   return vector3(hash_vector4_to_float(k),
	functioncall	$const37 265 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{160} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:87
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:244
#     vector3 position_in_kernel_space = position - kernel_center;
	sub		___546_position_in_kernel_space ___554_position_in_cell_space ___546_kernel_center 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{244} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:248
#     if (dot(position_in_kernel_space, position_in_kernel_space) >= 1.0) {
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:249
#       continue;
	continue	%line{249}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:254
#     float weight = hash_vector4_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	functioncall	$const37 288 	%line{254} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h:87
#   return hashnoise(vector3(k.x, k.y, k.z), k.w);
	point		$tmp113 ___546_seed_for_weight.x ___546_seed_for_weight.y ___546_seed_for_weight.z 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_hash.h"} %line{87} %argrw{"wrrr"}
	hashnoise	$tmp112 $tmp113 ___546_seed_for_weight.w 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:254
#     float weight = hash_vector4_to_float(seed_for_weight) < 0.5 ? -1.0 : 1.0;
	lt		$tmp114 $tmp112 $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{254} %argrw{"wrr"}
	if		$tmp114 291 292 	%argrw{"r"}
	assign		___546_weight $const22 	%argrw{"wr"}
	assign		___546_weight $const1 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:256
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:180
#   float distance_squared = dot(position, position);
	dot		___540_distance_squared ___546_position_in_kernel_space ___546_position_in_kernel_space 	%line{180} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:181
#   float hann_window = 0.5 + 0.5 * cos(M_PI * distance_squared);
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:182
#   float gaussian_envelop = exp(-M_PI * distance_squared);
	mul		$tmp120 $const24 ___540_distance_squared 	%line{182} %argrw{"wrr"}
	exp		___540_gaussian_envelop $tmp120 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:183
#   float windowed_gaussian_envelope = gaussian_envelop * hann_window;
	mul		___540_windowed_gaussian_envelope ___540_gaussian_envelop ___540_hann_window 	%line{183} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:185
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:186
#   float angle = 2.0 * M_PI * dot(position, frequency_vector);
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:187
#   vector2 phasor = vector2(cos(angle), sin(angle));
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp122.x ___540_windowed_gaussian_envelope 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
	assign		$tmp122.y ___540_windowed_gaussian_envelope 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const25 312 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp116.x ___540_phasor.x $tmp122.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp116.y ___540_phasor.y $tmp122.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const25 318 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:98
#     return b * vector2(a, a);
	assign		$tmp123.x ___546_weight 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{98} %argrw{"wr"}
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:78
#     return vector2(a.x * b.x, a.y * b.y);
	mul		$tmp115.x $tmp116.x $tmp123.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{78} %argrw{"wrr"}
	mul		$tmp115.y $tmp116.y $tmp123.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:339
# 
	functioncall	$const12 321 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{339} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___544_noise.x ___544_noise.x $tmp115.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___544_noise.y ___544_noise.y $tmp115.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:235
#   for (int i = 0; i < IMPULSES_COUNT; ++i) {
	add		___545_i ___545_i $const7 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{235} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:258
#   return noise;
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:28
#     return vector2(a.x + b.x, a.y + b.y);
	add		___548_sum.x ___548_sum.x $tmp67.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{28} %argrw{"wrr"}
	add		___548_sum.y ___548_sum.y $tmp67.y 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:273
#       for (int i = -1; i <= 1; i++) {
	assign		$tmp124 ___553_i 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{273} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:283
#   return sum;
	assign		phasor.x ___548_sum.x 	%line{283} %argrw{"wr"}
	assign		phasor.y ___548_sum.y 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:318
#     standard_deviation = compute_3d_gabor_standard_deviation();
	functioncall	$const40 342 	%line{318} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:197
#   float integral_of_gabor_squared = 1.0 / (4.0 * M_SQRT2);
	assign		___541_integral_of_gabor_squared $const41 	%line{197} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:198
#   float second_moment = 0.5;
	assign		___541_second_moment $const18 	%line{198} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:199
#   return sqrt(IMPULSES_COUNT * second_moment * integral_of_gabor_squared);
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:321
#     error("Unknown type!");
	error		$const42 	%line{321} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:326
#   float normalization_factor = 6.0 * standard_deviation;
	mul		normalization_factor $const43 standard_deviation 	%line{326} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:330
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:334
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:337
#   Intensity = length(phasor) / normalization_factor;
	functioncall	$const34 356 	%line{337} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h:192
#     return hypot (a.x, a.y);
	functioncall	$const35 356 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders\\vector2.h"} %line{192} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:101
# float hypot (float a, float b) { return sqrt (a*a + b*b); }
	mul		$tmp134 phasor.x phasor.x 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{101} %argrw{"wrr"}
	mul		$tmp135 phasor.y phasor.y 	%argrw{"wrr"}
	add		$tmp136 $tmp134 $tmp135 	%argrw{"wrr"}
	sqrt		$tmp133 $tmp136 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl:337
#   Intensity = length(phasor) / normalization_factor;
	div		Intensity $tmp133 normalization_factor 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gabor_texture.osl"} %line{337} %argrw{"wrr"}
	end
