...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_float_curve.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl:17
#   float c = (ValueIn - min_x) / (max_x - min_x);
	sub		$tmp1 ValueIn min_x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl"} %line{17} %argrw{"wrr"}
	sub		$tmp2 max_x min_x 	%argrw{"wrr"}
	div		c $tmp1 $tmp2 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl:19
...
#   float f = at;
	assign		___352_f c 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{50} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:51
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp19 c $const5 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp18 $tmp19 $const3 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h:68
#   f = clamp(at, 0.0, 1.0) * (table_size - 1);
	sub		$tmp20 ___352_table_size $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_ramp_util.h"} %line{68} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl:21
#   ValueOut = mix(ValueIn, ValueOut, Factor);
	mix		ValueOut ValueIn ValueOut Factor 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_float_curve.osl"} %line{21} %argrw{"wrrr"}
	end
