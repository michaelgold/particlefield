...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_hair_info.oso
...
code TangentNormal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl:11
#                       output normal TangentNormal = N,
	assign		TangentNormal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl"} %line{11} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl:14
#   getattribute("geom:is_curve", IsStrand);
	getattribute	$tmp1 $const1 IsStrand 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl"} %line{14} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl:15
#   getattribute("geom:curve_intercept", Intercept);
	getattribute	$tmp2 $const2 Intercept 	%line{15} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl:16
#   getattribute("geom:curve_length", Length);
	getattribute	$tmp3 $const3 Length 	%line{16} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl:17
#   getattribute("geom:curve_thickness", Thickness);
	getattribute	$tmp4 $const4 Thickness 	%line{17} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl:18
#   getattribute("geom:curve_tangent_normal", TangentNormal);
	getattribute	$tmp5 $const5 TangentNormal 	%line{18} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_hair_info.osl:19
