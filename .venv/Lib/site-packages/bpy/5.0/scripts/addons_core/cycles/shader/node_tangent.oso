...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_tangent.oso
shader node_tangent
...
code Tangent
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:10
#                     output normal Tangent = normalize(dPdu))
	normalize	Tangent dPdu 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl"} %line{10} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:12
#   vector T = vector(0.0, 0.0, 0.0);
	assign		T $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl"} %line{12} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:14
#   if (direction_type == "uv_map") {
	eq		$tmp1 direction_type $const2 	%line{14} %argrw{"wrr"}
	if		$tmp1 5 33 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:15
#     getattribute(attr_name, T);
	getattribute	$tmp2 attr_name T 	%line{15} %argrw{"wrw"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:17
#   else if (direction_type == "radial") {
	eq		$tmp3 direction_type $const3 	%line{17} %argrw{"wrr"}
	if		$tmp3 33 33 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:20
#     if (!getattribute("geom:generated", generated))
	getattribute	$tmp4 $const4 ___369_generated 	%line{20} %argrw{"wrw"}
	eq		$tmp5 $tmp4 $const5 	%argrw{"wrr"}
	if		$tmp5 11 11 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:21
#       generated = P;
	assign		___369_generated P 	%line{21} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:23
#     if (axis == "x")
	eq		$tmp6 axis $const6 	%line{23} %argrw{"wrr"}
	if		$tmp6 19 33 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:24
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:25
#     else if (axis == "y")
	eq		$tmp12 axis $const11 	%line{25} %argrw{"wrr"}
	if		$tmp12 27 33 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:26
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:28
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:31
#   T = transform("object", "world", T);
	transformv	T $const12 $const13 T 	%line{31} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_tangent.osl:32
