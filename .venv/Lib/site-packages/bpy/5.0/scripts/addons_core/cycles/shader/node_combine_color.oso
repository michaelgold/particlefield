...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_combine_color.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl:13
#   if (color_type == "rgb" || color_type == "hsv" || color_type == "hsl")
	eq		$tmp1 color_type $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl"} %line{13} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl:14
#     Color = color(color_type, Red, Green, Blue);
	color		Color color_type Red Green Blue 	%line{14} %argrw{"wrrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_combine_color.osl:16
