...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_gradient_texture.oso
...
code Vector
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:54
#     point Vector = P,
	assign		Vector P 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl"} %line{54} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:58
#   point p = Vector;
	assign		p Vector 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl"} %line{58} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:60
#   if (use_mapping)
	if		use_mapping 4 4 	%line{60} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:61
#     p = transform(mapping, p);
	transform	p mapping p 	%line{61} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:63
#   Fac = gradient(p, gradient_type);
	functioncall	$const1 51 	%line{63} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:13
#   x = p[0];
	compref		___368_x p $const2 	%line{13} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:14
#   y = p[1];
	compref		___368_y p $const3 	%line{14} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:15
#   z = p[2];
	compref		___368_z p $const4 	%line{15} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:17
#   float result = 0.0;
	assign		___368_result $const5 	%line{17} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:19
#   if (type == "linear") {
	eq		$tmp1 gradient_type $const6 	%line{19} %argrw{"wrr"}
	if		$tmp1 12 48 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:20
#     result = x;
	assign		___368_result ___368_x 	%line{20} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:22
#   else if (type == "quadratic") {
	eq		$tmp2 gradient_type $const7 	%line{22} %argrw{"wrr"}
	if		$tmp2 16 48 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:23
#     float r = max(x, 0.0);
	max		___370_r ___368_x $const5 	%line{23} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:24
#     result = r * r;
	mul		___368_result ___370_r ___370_r 	%line{24} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:26
#   else if (type == "easing") {
	eq		$tmp3 gradient_type $const8 	%line{26} %argrw{"wrr"}
	if		$tmp3 25 48 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:27
#     float r = min(max(x, 0.0), 1.0);
	max		$tmp4 ___368_x $const5 	%line{27} %argrw{"wrr"}
	min		___371_r $tmp4 $const9 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:28
#     float t = r * r;
	mul		___371_t ___371_r ___371_r 	%line{28} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:30
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:32
#   else if (type == "diagonal") {
	eq		$tmp8 gradient_type $const12 	%line{32} %argrw{"wrr"}
	if		$tmp8 29 48 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:33
#     result = (x + y) * 0.5;
	add		$tmp9 ___368_x ___368_y 	%line{33} %argrw{"wrr"}
	mul		___368_result $tmp9 $const13 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:35
#   else if (type == "radial") {
	eq		$tmp10 gradient_type $const14 	%line{35} %argrw{"wrr"}
	if		$tmp10 34 48 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:36
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:39
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:41
#     if (type == "quadratic_sphere")
	eq		$tmp20 gradient_type $const16 	%line{41} %argrw{"wrr"}
	if		$tmp20 45 48 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:42
#       result = r * r;
	mul		___368_result ___374_r ___374_r 	%line{42} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:43
#     else if (type == "spherical")
	eq		$tmp21 gradient_type $const17 	%line{43} %argrw{"wrr"}
	if		$tmp21 48 48 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:44
#       result = r;
	assign		___368_result ___374_r 	%line{44} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:47
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp22 ___368_result $const9 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		Fac $tmp22 $const5 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:64
#   Color = color(Fac, Fac, Fac);
	color		Color Fac Fac Fac 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl"} %line{64} %argrw{"wrrr"}
	end
