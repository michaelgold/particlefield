...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_mix_color.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:17
#   float t = (use_clamp) ? clamp(Factor, 0.0, 1.0) : Factor;
	if		use_clamp 4 5 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{17} %argrw{"r"}
	functioncall	$const3 4 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1 Factor $const2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		t $tmp1 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:17
#   float t = (use_clamp) ? clamp(Factor, 0.0, 1.0) : Factor;
	assign		t Factor 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{17} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:19
#   if (blend_type == "mix")
	eq		$tmp2 blend_type $const4 	%line{19} %argrw{"wrr"}
	if		$tmp2 8 8 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:20
#     Result = mix(A, B, t);
	mix		Result A B t 	%line{20} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:21
#   if (blend_type == "add")
	eq		$tmp3 blend_type $const5 	%line{21} %argrw{"wrr"}
	if		$tmp3 13 13 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:22
...
#   return mix(col1, col1 + col2, t);
	add		$tmp4 A B 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{12} %argrw{"wrr"}
	mix		Result A $tmp4 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:23
#   if (blend_type == "multiply")
	eq		$tmp5 blend_type $const7 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{23} %argrw{"wrr"}
	if		$tmp5 18 18 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:24
#     Result = node_mix_mul(t, A, B);
	functioncall	$const8 18 	%line{24} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:17
#   return mix(col1, col1 * col2, t);
	mul		$tmp6 A B 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{17} %argrw{"wrr"}
	mix		Result A $tmp6 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:25
#   if (blend_type == "screen")
	eq		$tmp7 blend_type $const9 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{25} %argrw{"wrr"}
	if		$tmp7 29 29 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:26
#     Result = node_mix_screen(t, A, B);
	functioncall	$const10 29 	%line{26} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:22
#   float tm = 1.0 - t;
	sub		___390_tm $const2 t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{22} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:27
#   if (blend_type == "overlay")
	eq		$tmp17 blend_type $const12 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{27} %argrw{"wrr"}
	if		$tmp17 95 95 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:28
#     Result = node_mix_overlay(t, A, B);
	functioncall	$const13 95 	%line{28} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:29
#   float tm = 1.0 - t;
	sub		___391_tm $const2 t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{29} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:29
#   if (blend_type == "subtract")
	eq		$tmp69 blend_type $const19 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{29} %argrw{"wrr"}
	if		$tmp69 100 100 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:30
#     Result = node_mix_sub(t, A, B);
	functioncall	$const20 100 	%line{30} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:59
#   return mix(col1, col1 - col2, t);
	sub		$tmp70 A B 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{59} %argrw{"wrr"}
	mix		Result A $tmp70 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:31
#   if (blend_type == "divide")
	eq		$tmp71 blend_type $const21 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{31} %argrw{"wrr"}
	if		$tmp71 139 139 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:32
#     Result = node_mix_div(t, A, B);
	functioncall	$const22 139 	%line{32} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:64
#   float tm = 1.0 - t;
	sub		___399_tm $const2 t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{64} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:33
#   if (blend_type == "difference")
	eq		$tmp99 blend_type $const23 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{33} %argrw{"wrr"}
	if		$tmp99 145 145 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:34
#     Result = node_mix_diff(t, A, B);
	functioncall	$const24 145 	%line{34} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:83
#   return mix(col1, abs(col1 - col2), t);
	sub		$tmp101 A B 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{83} %argrw{"wrr"}
	abs		$tmp100 $tmp101 	%argrw{"wr"}
	mix		Result A $tmp100 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:35
#   if (blend_type == "exclusion")
	eq		$tmp102 blend_type $const25 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{35} %argrw{"wrr"}
	if		$tmp102 155 155 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:36
...
#   return max(mix(col1, col1 + col2 - 2.0 * col1 * col2, t), 0.0);
	add		$tmp104 A B 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{88} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:37
#   if (blend_type == "darken")
	eq		$tmp109 blend_type $const27 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{37} %argrw{"wrr"}
	if		$tmp109 160 160 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:38
#     Result = node_mix_dark(t, A, B);
	functioncall	$const28 160 	%line{38} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:93
#   return mix(col1, min(col1, col2), t);
	min		$tmp110 A B 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{93} %argrw{"wrr"}
	mix		Result A $tmp110 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:39
#   if (blend_type == "lighten")
	eq		$tmp111 blend_type $const29 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{39} %argrw{"wrr"}
	if		$tmp111 165 165 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:40
#     Result = node_mix_light(t, A, B);
	functioncall	$const30 165 	%line{40} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:98
#   return mix(col1, max(col1, col2), t);
	max		$tmp112 A B 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{98} %argrw{"wrr"}
	mix		Result A $tmp112 t 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:41
#   if (blend_type == "dodge")
	eq		$tmp113 blend_type $const31 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{41} %argrw{"wrr"}
	if		$tmp113 215 215 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:42
#     Result = node_mix_dodge(t, A, B);
	functioncall	$const32 215 	%line{42} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:103
#   color outcol = col1;
	assign		___407_outcol A 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{103} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:43
#   if (blend_type == "burn")
	eq		$tmp135 blend_type $const33 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{43} %argrw{"wrr"}
	if		$tmp135 272 272 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:44
#     Result = node_mix_burn(t, A, B);
	functioncall	$const34 272 	%line{44} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:147
#   float tmp, tm = 1.0 - t;
	sub		___420_tm $const2 t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{147} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:45
#   if (blend_type == "hue")
	eq		$tmp160 blend_type $const35 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{45} %argrw{"wrr"}
	if		$tmp160 415 415 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:46
#     Result = node_mix_hue(t, A, B);
	functioncall	$const36 415 	%line{46} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:198
#   color outcol = col1;
	assign		___433_outcol A 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{198} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:199
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const37 322 	%line{199} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp161 B $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#   if (hsv2[1] != 0.0) {
	compref		$tmp186 ___433_hsv2 $const17 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{201} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp188 ___433_outcol $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#     hsv[0] = hsv2[0];
	compref		$tmp213 ___433_hsv2 $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{203} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___434_hsv $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
#     outcol = mix(outcol, tmp, t);
	mix		___433_outcol ___433_outcol ___434_tmp t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{206} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:209
#   return outcol;
	assign		Result ___433_outcol 	%line{209} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:47
#   if (blend_type == "saturation")
	eq		$tmp227 blend_type $const42 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{47} %argrw{"wrr"}
	if		$tmp227 562 562 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:48
#     Result = node_mix_sat(t, A, B);
	functioncall	$const43 562 	%line{48} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:214
#   float tm = 1.0 - t;
	sub		___435_tm $const2 t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{214} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp228 ___435_outcol $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#   if (hsv[1] != 0.0) {
	compref		$tmp253 ___435_hsv $const17 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{220} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp255 B $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#     hsv[1] = tm * hsv[1] + t * hsv2[1];
	compref		$tmp280 ___435_hsv $const17 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{223} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___435_hsv $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
#   return outcol;
	assign		Result ___435_outcol 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{227} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:49
#   if (blend_type == "value")
	eq		$tmp298 blend_type $const44 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{49} %argrw{"wrr"}
	if		$tmp298 704 704 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:50
#     Result = node_mix_val(t, A, B);
	functioncall	$const45 704 	%line{50} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:232
#   float tm = 1.0 - t;
	sub		___437_tm $const2 t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{232} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:234
#   color hsv = rgb_to_hsv(col1);
	functioncall	$const37 612 	%line{234} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp299 A $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const37 658 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{235} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp324 B $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#   hsv[2] = tm * hsv[2] + t * hsv2[2];
	compref		$tmp349 ___437_hsv $const18 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{237} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___437_hsv $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:51
#   if (blend_type == "color")
	eq		$tmp367 blend_type $const46 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{51} %argrw{"wrr"}
	if		$tmp367 849 849 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:52
#     Result = node_mix_color(t, A, B);
	functioncall	$const47 849 	%line{52} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:244
#   color outcol = col1;
	assign		___438_outcol A 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{244} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:245
#   color hsv2 = rgb_to_hsv(col2);
	functioncall	$const37 754 	%line{245} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp368 B $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#   if (hsv2[1] != 0.0) {
	compref		$tmp393 ___438_hsv2 $const17 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{247} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:85
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp395 ___438_outcol $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
#     hsv[0] = hsv2[0];
	compref		$tmp420 ___438_hsv2 $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{249} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:130
#   h = hsv[0];
	compref		___370_h ___439_hsv $const14 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{130} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color.h:131
#   s = hsv[1];
...
#     outcol = mix(outcol, tmp, t);
	mix		___438_outcol ___438_outcol ___439_tmp t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{253} %argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:256
#   return outcol;
	assign		Result ___438_outcol 	%line{256} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:53
#   if (blend_type == "soft_light")
	eq		$tmp435 blend_type $const48 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{53} %argrw{"wrr"}
	if		$tmp435 866 866 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:54
#     Result = node_mix_soft(t, A, B);
	functioncall	$const49 866 	%line{54} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:261
#   float tm = 1.0 - t;
	sub		___440_tm $const2 t 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{261} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:55
#   if (blend_type == "linear_light")
	eq		$tmp446 blend_type $const50 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{55} %argrw{"wrr"}
	if		$tmp446 922 922 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:56
#     Result = node_mix_linear(t, A, B);
	functioncall	$const51 922 	%line{56} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h:271
#   color outcol = col1;
	assign		___441_outcol A 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_color_blend.h"} %line{271} %argrw{"wr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:58
#   if (use_clamp_result)
	if		use_clamp_result 928 928 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl"} %line{58} %argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_mix_color.osl:59
#     Result = clamp(Result, 0.0, 1.0);
	assign		$tmp489 $const1 	%line{59} %argrw{"wr"}
	assign		$tmp490 $const2 	%argrw{"wr"}
	functioncall	$const3 928 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:140
# color  clamp (color x, color minval, color maxval) { return max(min(x,maxval),minval); }
	min		$tmp491 Result $tmp490 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{140} %argrw{"wrr"}
