...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_vector_rotate.oso
...
local	float	___476_cx	%read{25,91} %write{5,51}
local	float	___476_cy	%read{17,91} %write{7,53}
local	float	___476_cz	%read{17,88} %write{9,55}
local	float	___476_sx	%read{23,88} %write{11,57}
local	float	___476_sy	%read{21,86} %write{13,59}
local	float	___476_sz	%read{19,87} %write{15,61}
local	matrix	___476_mat	%read{47,93} %write{16,92}
local	matrix	___501_rmat	%read{95,95} %write{48,93}
local	float	___502_a	%read{106,272} %write{98,99}
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:17
#   if (rotate_type == "euler_xyz") {
	eq		$tmp1 rotate_type $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl"} %line{17} %argrw{"wrr"}
	if		$tmp1 97 322 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:18
...
#   float cx = cos(euler[0]);
	compref		$tmp3 Rotation $const3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{125} %argrw{"wrr"}
	cos		___476_cx $tmp3 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:126
#   float cy = cos(euler[1]);
	compref		$tmp4 Rotation $const4 	%line{126} %argrw{"wrr"}
	cos		___476_cy $tmp4 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:127
#   float cz = cos(euler[2]);
	compref		$tmp5 Rotation $const5 	%line{127} %argrw{"wrr"}
	cos		___476_cz $tmp5 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:128
#   float sx = sin(euler[0]);
	compref		$tmp6 Rotation $const3 	%line{128} %argrw{"wrr"}
	sin		___476_sx $tmp6 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:129
#   float sy = sin(euler[1]);
	compref		$tmp7 Rotation $const4 	%line{129} %argrw{"wrr"}
	sin		___476_sy $tmp7 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:130
#   float sz = sin(euler[2]);
	compref		$tmp8 Rotation $const5 	%line{130} %argrw{"wrr"}
	sin		___476_sz $tmp8 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:131
#   matrix mat = matrix(1.0);
	assign		___476_mat $const6 	%line{131} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:132
#   mat[0][0] = cy * cz;
	mul		$tmp9 ___476_cy ___476_cz 	%line{132} %argrw{"wrr"}
	mxcompassign	___476_mat $const3 $const3 $tmp9 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:133
#   mat[0][1] = cy * sz;
	mul		$tmp10 ___476_cy ___476_sz 	%line{133} %argrw{"wrr"}
	mxcompassign	___476_mat $const3 $const4 $tmp10 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:134
#   mat[0][2] = -sy;
	neg		$tmp11 ___476_sy 	%line{134} %argrw{"wr"}
	mxcompassign	___476_mat $const3 $const5 $tmp11 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:135
#   mat[1][0] = sy * sx * cz - cx * sz;
	mul		$tmp12 ___476_sy ___476_sx 	%line{135} %argrw{"wrr"}
	mul		$tmp13 $tmp12 ___476_cz 	%argrw{"wrr"}
	mul		$tmp14 ___476_cx ___476_sz 	%argrw{"wrr"}
	sub		$tmp15 $tmp13 $tmp14 	%argrw{"wrr"}
	mxcompassign	___476_mat $const4 $const3 $tmp15 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:136
#   mat[1][1] = sy * sx * sz + cx * cz;
	mul		$tmp16 ___476_sy ___476_sx 	%line{136} %argrw{"wrr"}
	mul		$tmp17 $tmp16 ___476_sz 	%argrw{"wrr"}
	mul		$tmp18 ___476_cx ___476_cz 	%argrw{"wrr"}
	add		$tmp19 $tmp17 $tmp18 	%argrw{"wrr"}
	mxcompassign	___476_mat $const4 $const4 $tmp19 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:137
#   mat[1][2] = cy * sx;
	mul		$tmp20 ___476_cy ___476_sx 	%line{137} %argrw{"wrr"}
	mxcompassign	___476_mat $const4 $const5 $tmp20 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:138
#   +mat[2][0] = sy * cx * cz + sx * sz;
	mul		$tmp21 ___476_sy ___476_cx 	%line{138} %argrw{"wrr"}
	mul		$tmp22 $tmp21 ___476_cz 	%argrw{"wrr"}
	mul		$tmp23 ___476_sx ___476_sz 	%argrw{"wrr"}
	add		$tmp24 $tmp22 $tmp23 	%argrw{"wrr"}
	mxcompassign	___476_mat $const5 $const3 $tmp24 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:139
#   mat[2][1] = sy * cx * sz - sx * cz;
	mul		$tmp25 ___476_sy ___476_cx 	%line{139} %argrw{"wrr"}
	mul		$tmp26 $tmp25 ___476_sz 	%argrw{"wrr"}
	mul		$tmp27 ___476_sx ___476_cz 	%argrw{"wrr"}
	sub		$tmp28 $tmp26 $tmp27 	%argrw{"wrr"}
	mxcompassign	___476_mat $const5 $const4 $tmp28 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:140
#   mat[2][2] = cy * cx;
	mul		$tmp29 ___476_cy ___476_cx 	%line{140} %argrw{"wrr"}
	mxcompassign	___476_mat $const5 $const5 $tmp29 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:141
#   return mat;
	assign		$tmp2 ___476_mat 	%line{141} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:18
#     matrix rmat = (invert) ? transpose(euler_to_mat(Rotation)) : euler_to_mat(Rotation);
	transpose	___501_rmat $tmp2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl"} %line{18} %argrw{"wr"}
	functioncall	$const2 94 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:125
#   float cx = cos(euler[0]);
	compref		$tmp30 Rotation $const3 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{125} %argrw{"wrr"}
	cos		___476_cx $tmp30 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:126
#   float cy = cos(euler[1]);
	compref		$tmp31 Rotation $const4 	%line{126} %argrw{"wrr"}
	cos		___476_cy $tmp31 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:127
#   float cz = cos(euler[2]);
	compref		$tmp32 Rotation $const5 	%line{127} %argrw{"wrr"}
	cos		___476_cz $tmp32 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:128
#   float sx = sin(euler[0]);
	compref		$tmp33 Rotation $const3 	%line{128} %argrw{"wrr"}
	sin		___476_sx $tmp33 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:129
#   float sy = sin(euler[1]);
	compref		$tmp34 Rotation $const4 	%line{129} %argrw{"wrr"}
	sin		___476_sy $tmp34 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:130
#   float sz = sin(euler[2]);
	compref		$tmp35 Rotation $const5 	%line{130} %argrw{"wrr"}
	sin		___476_sz $tmp35 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:131
#   matrix mat = matrix(1.0);
	assign		___476_mat $const6 	%line{131} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:132
#   mat[0][0] = cy * cz;
	mul		$tmp36 ___476_cy ___476_cz 	%line{132} %argrw{"wrr"}
	mxcompassign	___476_mat $const3 $const3 $tmp36 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:133
#   mat[0][1] = cy * sz;
	mul		$tmp37 ___476_cy ___476_sz 	%line{133} %argrw{"wrr"}
	mxcompassign	___476_mat $const3 $const4 $tmp37 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:134
#   mat[0][2] = -sy;
	neg		$tmp38 ___476_sy 	%line{134} %argrw{"wr"}
	mxcompassign	___476_mat $const3 $const5 $tmp38 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:135
#   mat[1][0] = sy * sx * cz - cx * sz;
	mul		$tmp39 ___476_sy ___476_sx 	%line{135} %argrw{"wrr"}
	mul		$tmp40 $tmp39 ___476_cz 	%argrw{"wrr"}
	mul		$tmp41 ___476_cx ___476_sz 	%argrw{"wrr"}
	sub		$tmp42 $tmp40 $tmp41 	%argrw{"wrr"}
	mxcompassign	___476_mat $const4 $const3 $tmp42 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:136
#   mat[1][1] = sy * sx * sz + cx * cz;
	mul		$tmp43 ___476_sy ___476_sx 	%line{136} %argrw{"wrr"}
	mul		$tmp44 $tmp43 ___476_sz 	%argrw{"wrr"}
	mul		$tmp45 ___476_cx ___476_cz 	%argrw{"wrr"}
	add		$tmp46 $tmp44 $tmp45 	%argrw{"wrr"}
	mxcompassign	___476_mat $const4 $const4 $tmp46 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:137
#   mat[1][2] = cy * sx;
	mul		$tmp47 ___476_cy ___476_sx 	%line{137} %argrw{"wrr"}
	mxcompassign	___476_mat $const4 $const5 $tmp47 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:138
#   +mat[2][0] = sy * cx * cz + sx * sz;
	mul		$tmp48 ___476_sy ___476_cx 	%line{138} %argrw{"wrr"}
	mul		$tmp49 $tmp48 ___476_cz 	%argrw{"wrr"}
	mul		$tmp50 ___476_sx ___476_sz 	%argrw{"wrr"}
	add		$tmp51 $tmp49 $tmp50 	%argrw{"wrr"}
	mxcompassign	___476_mat $const5 $const3 $tmp51 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:139
#   mat[2][1] = sy * cx * sz - sx * cz;
	mul		$tmp52 ___476_sy ___476_cx 	%line{139} %argrw{"wrr"}
	mul		$tmp53 $tmp52 ___476_sz 	%argrw{"wrr"}
	mul		$tmp54 ___476_sx ___476_cz 	%argrw{"wrr"}
	sub		$tmp55 $tmp53 $tmp54 	%argrw{"wrr"}
	mxcompassign	___476_mat $const5 $const4 $tmp55 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:140
#   mat[2][2] = cy * cx;
	mul		$tmp56 ___476_cy ___476_cx 	%line{140} %argrw{"wrr"}
	mxcompassign	___476_mat $const5 $const5 $tmp56 	%argrw{"wrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders\\node_math.h:141
#   return mat;
	assign		___501_rmat ___476_mat 	%line{141} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:19
#     VectorOut = transform(rmat, VectorIn - Center) + Center;
	sub		$tmp58 VectorIn Center 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl"} %line{19} %argrw{"wrr"}
	transform	$tmp57 ___501_rmat $tmp58 	%argrw{"wrr"}
	add		VectorOut $tmp57 Center 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:22
#     float a = (invert) ? -Angle : Angle;
	if		invert 99 100 	%line{22} %argrw{"r"}
	neg		___502_a Angle 	%argrw{"wr"}
	assign		___502_a Angle 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:23
#     if (rotate_type == "x_axis") {
	eq		$tmp59 rotate_type $const7 	%line{23} %argrw{"wrr"}
	if		$tmp59 155 322 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:24
...
#     vector axis = normalize (b - a);
	sub		$tmp64 $const9 $const8 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{270} %argrw{"wrr"}
	normalize	___257_axis $tmp64 	%argrw{"wr"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:272
#     sincos (angle, sinang, cosang);
	sincos		___502_a ___257_sinang ___257_cosang 	%line{272} %argrw{"rww"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:24
#       VectorOut = rotate(VectorIn - Center, a, point(0.0), vector(1.0, 0.0, 0.0)) + Center;
	add		VectorOut $tmp60 Center 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl"} %line{24} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:26
#     else if (rotate_type == "y_axis") {
	eq		$tmp106 rotate_type $const12 	%line{26} %argrw{"wrr"}
	if		$tmp106 210 322 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:27
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:270
#     vector axis = normalize (b - a);
	sub		$tmp111 $const13 $const8 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{270} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:27
#       VectorOut = rotate(VectorIn - Center, a, point(0.0), vector(0.0, 1.0, 0.0)) + Center;
	add		VectorOut $tmp107 Center 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl"} %line{27} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:29
#     else if (rotate_type == "z_axis") {
	eq		$tmp153 rotate_type $const14 	%line{29} %argrw{"wrr"}
	if		$tmp153 265 322 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:30
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:270
#     vector axis = normalize (b - a);
	sub		$tmp158 $const15 $const8 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{270} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:30
#       VectorOut = rotate(VectorIn - Center, a, point(0.0), vector(0.0, 0.0, 1.0)) + Center;
	add		VectorOut $tmp154 Center 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl"} %line{30} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:33
...
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:270
#     vector axis = normalize (b - a);
	sub		$tmp205 Axis $const8 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{270} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl:33
#       VectorOut = (length(Axis) != 0.0) ? rotate(VectorIn - Center, a, point(0.0), Axis) + Center :
	add		VectorOut $tmp202 Center 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_rotate.osl"} %line{33} %argrw{"wrr"}
