...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.oso
...
param	float	ThinFilmThickness	0		%read{80,85} %write{2147483647,-1}
param	float	ThinFilmIOR	1.33000004		%read{80,85} %write{2147483647,-1}
...
const	string	$const14	"thinfilm_thickness"		%read{80,85} %write{2147483647,-1}
const	string	$const15	"thinfilm_ior"		%read{80,85} %write{2147483647,-1}
const	string	$const16	"microfacet_f82_tint"		%read{80,80} %write{2147483647,-1}
...
const	string	$const17	"conductor_bsdf"		%read{85,85} %write{2147483647,-1}
code Normal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:19
#                           normal Normal = N,
	assign		Normal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl"} %line{19} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:23
#   float r2 = clamp(Roughness, 0.0, 1.0);
	functioncall	$const3 4 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl"} %line{23} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1 Roughness $const2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		r2 $tmp1 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:24
#   r2 *= r2;
	mul		r2 r2 r2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl"} %line{24} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:25
#   float alpha_x = r2, alpha_y = r2;
	assign		alpha_x r2 	%line{25} %argrw{"wr"}
	assign		alpha_y r2 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:28
#   vector T = Tangent;
	assign		T Tangent 	%line{28} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:29
#   if (Anisotropy > 0.0) {
	gt		$tmp2 Anisotropy $const1 	%line{29} %argrw{"wrr"}
	if		$tmp2 72 72 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:30
#     float aspect = sqrt(1.0 - clamp(Anisotropy, 0.0, 1.0) * 0.9);
	functioncall	$const3 13 	%line{30} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp4 Anisotropy $const2 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp3 $tmp4 $const1 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:30
#     float aspect = sqrt(1.0 - clamp(Anisotropy, 0.0, 1.0) * 0.9);
	mul		$tmp5 $tmp3 $const4 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl"} %line{30} %argrw{"wrr"}
	sub		$tmp6 $const2 $tmp5 	%argrw{"wrr"}
	sqrt		___374_aspect $tmp6 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:31
#     alpha_x /= aspect;
	div		alpha_x alpha_x ___374_aspect 	%line{31} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:32
#     alpha_y *= aspect;
	mul		alpha_y alpha_y ___374_aspect 	%line{32} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:33
#     if (Rotation != 0.0)
	neq		$tmp7 Rotation $const1 	%line{33} %argrw{"wrr"}
	if		$tmp7 72 72 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:34
#       T = rotate(T, Rotation * M_2PI, point(0.0, 0.0, 0.0), Normal);
	mul		$tmp8 Rotation $const5 	%line{34} %argrw{"wrr"}
	functioncall	$const7 72 	%argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:270
#     vector axis = normalize (b - a);
	sub		$tmp10 Normal $const6 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{270} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:37
#   if (fresnel_type == "f82") {
	eq		$tmp52 fresnel_type $const11 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl"} %line{37} %argrw{"wrr"}
	if		$tmp52 81 86 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:38
#     color F0 = clamp(BaseColor, color(0.0), color(1.0));
	functioncall	$const3 77 	%line{38} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:140
# color  clamp (color x, color minval, color maxval) { return max(min(x,maxval),minval); }
	min		$tmp55 BaseColor $const13 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{140} %argrw{"wrr"}
	max		___375_F0 $tmp55 $const12 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:39
#     color F82 = clamp(EdgeTint, color(0.0), color(1.0));
	functioncall	$const3 80 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl"} %line{39} %argrw{"r"}
# D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:140
# color  clamp (color x, color minval, color maxval) { return max(min(x,maxval),minval); }
	min		$tmp58 EdgeTint $const13 	%filename{"D:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{140} %argrw{"wrr"}
	max		___375_F82 $tmp58 $const12 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:40
#     BSDF = microfacet_f82_tint(distribution,
	closure		BSDF $const16 distribution Normal T alpha_x alpha_y ___375_F0 ___375_F82 $const14 ThinFilmThickness $const15 ThinFilmIOR 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl"} %line{40} %argrw{"wrrrrrrrrrrrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:57
#                           max(IOR, 0.0),
	assign		$tmp60 $const1 	%line{57} %argrw{"wr"}
	max		$tmp59 IOR $tmp60 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:58
#                           max(Extinction, 0.0),
	assign		$tmp62 $const1 	%line{58} %argrw{"wr"}
	max		$tmp61 Extinction $tmp62 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_metallic_bsdf.osl:53
#     BSDF = conductor_bsdf(Normal,
	closure		BSDF $const17 Normal T alpha_x alpha_y $tmp59 $tmp61 distribution $const14 ThinFilmThickness $const15 ThinFilmIOR 	%line{53} %argrw{"wrrrrrrrrrrrr"}
	end
