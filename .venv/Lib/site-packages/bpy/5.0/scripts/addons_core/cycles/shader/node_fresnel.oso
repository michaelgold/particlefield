...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_fresnel.oso
shader node_fresnel
...
code Normal
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:8
# shader node_fresnel(float IOR = 1.45, normal Normal = N, output float Fac = 0.0)
	assign		Normal N 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl"} %line{8} %argrw{"wr"}
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:10
#   float f = max(IOR, 1e-5);
	max		f IOR $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl"} %line{10} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:11
#   float eta = backfacing() ? 1.0 / f : f;
	backfacing	$tmp1 	%line{11} %argrw{"w"}
	if		$tmp1 5 6 	%argrw{"r"}
	div		eta $const2 f 	%argrw{"wrr"}
	assign		eta f 	%argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:12
#   float cosi = dot(I, Normal);
	dot		cosi I Normal 	%line{12} %argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_fresnel.osl:13
