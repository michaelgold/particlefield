...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_rgb_curves.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:17
#   color c = (ColorIn - color(min_x, min_x, min_x)) / (max_x - min_x);
	color		$tmp1 min_x min_x min_x 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl"} %line{17} %argrw{"wrrr"}
	sub		$tmp2 ColorIn $tmp1 	%argrw{"wrr"}
	sub		$tmp3 max_x min_x 	%argrw{"wrr"}
	div		c $tmp2 $tmp3 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:19
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:20
#   color g = rgb_ramp_lookup(ramp, c[1], 1, extrapolate);
	compref		$tmp35 c $const2 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl"} %line{20} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:21
#   color b = rgb_ramp_lookup(ramp, c[2], 1, extrapolate);
	compref		$tmp66 c $const6 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl"} %line{21} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:23
#   ColorOut[0] = r[0];
	compref		$tmp97 r $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl"} %line{23} %argrw{"wrr"}
	compassign	ColorOut $const1 $tmp97 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:24
#   ColorOut[1] = g[1];
	compref		$tmp98 g $const2 	%line{24} %argrw{"wrr"}
	compassign	ColorOut $const2 $tmp98 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:25
#   ColorOut[2] = b[2];
	compref		$tmp99 b $const6 	%line{25} %argrw{"wrr"}
	compassign	ColorOut $const6 $tmp99 	%argrw{"wrr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_rgb_curves.osl:27
