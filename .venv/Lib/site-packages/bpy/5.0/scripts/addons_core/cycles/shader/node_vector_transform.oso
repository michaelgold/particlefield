...
# options: -q -O2 -ID:/.buildbpy/blender/intern/cycles/kernel/osl/shaders -ID:/.buildbpy/blender/lib/windows_x64/osl/share/OSL/shaders -o D:/.buildbpy/build_windows_Bpy_x64_vc16_Release/intern/cycles/kernel/osl/shaders/node_vector_transform.oso
...
code ___main___
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl:13
#   if (transform_type == "vector" || transform_type == "normal") {
	eq		$tmp1 transform_type $const1 	%filename{"D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl"} %line{13} %argrw{"wrr"}
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl:14
...
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl:15
#     if (transform_type == "normal")
	eq		$tmp5 transform_type $const3 	%line{15} %argrw{"wrr"}
	if		$tmp5 11 11 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl:16
#       VectorOut = normalize(VectorOut);
	normalize	VectorOut VectorOut 	%line{16} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl:18
#   else if (transform_type == "point") {
	eq		$tmp6 transform_type $const4 	%line{18} %argrw{"wrr"}
	if		$tmp6 15 15 	%argrw{"r"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl:19
#     point Point = (point)VectorIn;
	assign		___369_Point VectorIn 	%line{19} %argrw{"wr"}
# D:/.buildbpy/blender/intern/cycles/kernel/osl/shaders/node_vector_transform.osl:20
